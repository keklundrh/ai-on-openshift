...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/%40apidevtools/openapi-schemas/schemas/v3.1/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>OpenAPI 3.1.X JSON Schema - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="OpenAPI 3.1.X JSON Schema - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/@apidevtools/openapi-schemas/schemas/v3.1/README.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/%40apidevtools/openapi-schemas/schemas/v3.1/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="OpenAPI 3.1.X JSON Schema - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/@apidevtools/openapi-schemas/schemas/v3.1/README.png" >
    ...
    <div data-md-component="skip">
        ...
        <a href="#openapi-31x-json-schema" class="md-skip">
          Skip to content
        </a>
...
<h1 id="openapi-31x-json-schema">OpenAPI 3.1.X JSON Schema</h1>
<p>Here you can find the JSON Schema for validating OpenAPI definitions of versions
3.1.X.</p>
<p>As a reminder, the JSON Schema is not the source of truth for the Specification.
...
<p>The iteration version of the JSON Schema can be found in the <code>$id</code> field. For
example, the value of <code>$id: https://spec.openapis.org/oas/3.1/schema/2021-03-02</code>
means this iteration was created on March 2nd, 2021.</p>
<p>The <code>schema.yaml</code> schema doesn't validate the JSON Schemas in your OpenAPI
document because 3.1 allows you to use any JSON Schema dialect you choose. We
have also included <code>schema-base.yaml</code> that extends the main schema to validate
that all schemas use the default OAS base vocabulary.</p>
<h2 id="contributing">Contributing</h2>
<p>To submit improvements to the schema, modify the schema.yaml file only.</p>
<p>The TSC will then:
- Run tests on the updated schema
- Update the iteration version
- Convert the schema.yaml to schema.json
- Publish the new version</p>
<h2 id="tests">Tests</h2>
<p>The test suite is included as a git submodule of https://github.com/Mermade/openapi3-examples.</p>
<div class="highlight"><pre><span></span><code>npx<span class="w"> </span>mocha<span class="w"> </span>--recursive<span class="w"> </span>tests
</code></pre></div>
<p>You can also validate a document individually.</p>
<div class="highlight"><pre><span></span><code>scripts/validate.js<span class="w"> </span>path/to/document/to/validate.yaml
</code></pre></div>
