...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/babel-plugin-jest-hoist/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>babel-plugin-jest-hoist - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="babel-plugin-jest-hoist - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/babel-plugin-jest-hoist/README.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/babel-plugin-jest-hoist/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="babel-plugin-jest-hoist - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/babel-plugin-jest-hoist/README.png" >
    ...
    <div data-md-component="skip">
        ...
        <a href="#babel-plugin-jest-hoist" class="md-skip">
          Skip to content
        </a>
  ...
  <a href="#usage" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Usage">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#via-babelconfigjs-recommended" class="md-nav__link">
    <span class="md-ellipsis">
  ...
  <a href="#via-cli" class="md-nav__link">
    <span class="md-ellipsis">
      Via CLI
          ...
          <li class="md-nav__item">
  <a href="#via-node-api" class="md-nav__link">
    <span class="md-ellipsis">
      Via Node API
    </span>
  </a>
...
<h1 id="babel-plugin-jest-hoist">babel-plugin-jest-hoist</h1>
<p>Babel plugin to hoist <code>jest.disableAutomock</code>, <code>jest.enableAutomock</code>, <code>jest.unmock</code>, <code>jest.mock</code>, calls above <code>import</code> statements. This plugin is automatically included when using <a href="https://github.com/jestjs/jest/tree/main/packages/babel-jest">babel-jest</a>.</p>
<h2 id="installation">Installation</h2>
<div class="highlight"><pre><span></span><code>$<span class="w"> </span>yarn<span class="w"> </span>add<span class="w"> </span>--dev<span class="w"> </span>babel-plugin-jest-hoist
</code></pre></div>
<h2 id="usage">Usage</h2>
<h3 id="via-babelconfigjs-recommended">Via <code>babel.config.js</code> (Recommended)</h3>
...
<span class="w">  </span><span class="nx">plugins</span><span class="o">:</span><span class="w"> </span><span class="p">[</span><span class="s1">&#39;jest-hoist&#39;</span><span class="p">],</span>
<span class="p">};</span>
</code></pre></div>
<h3 id="via-cli">Via CLI</h3>
<div class="highlight"><pre><span></span><code>$<span class="w"> </span>babel<span class="w"> </span>--plugins<span class="w"> </span>jest-hoist<span class="w"> </span>script.js
</code></pre></div>
<h3 id="via-node-api">Via Node API</h3>
<div class="highlight"><pre><span></span><code><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;@babel/core&#39;</span><span class="p">).</span><span class="nx">transform</span><span class="p">(</span><span class="s1">&#39;code&#39;</span><span class="p">,</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="nx">plugins</span><span class="o">:</span><span class="w"> </span><span class="p">[</span><span class="s1">&#39;jest-hoist&#39;</span><span class="p">],</span>
<span class="p">});</span>
</code></pre></div>
