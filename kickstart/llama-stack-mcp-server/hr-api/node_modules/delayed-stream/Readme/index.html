...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/delayed-stream/Readme/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>delayed-stream - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="delayed-stream - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/delayed-stream/Readme.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/delayed-stream/Readme/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="delayed-stream - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/delayed-stream/Readme.png" >
    ...
    <div data-md-component="skip">
        ...
        <a href="#delayed-stream" class="md-skip">
          Skip to content
        </a>
  ...
  <a href="#implementation" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Implementation">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#event-buffering-proxying" class="md-nav__link">
    <span class="md-ellipsis">
  ...
  <a href="#error-handling" class="md-nav__link">
    <span class="md-ellipsis">
      Error handling
          ...
          <li class="md-nav__item">
  <a href="#buffer-limits" class="md-nav__link">
    <span class="md-ellipsis">
      Buffer limits
    </span>
  </a>
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#delayedstreamcreatesource-options" class="md-nav__link">
    <span class="md-ellipsis">
      DelayedStream.create(source, [options])
          ...
          <li class="md-nav__item">
  <a href="#delayedstreamsource" class="md-nav__link">
    <span class="md-ellipsis">
      delayedStream.source
          ...
          <li class="md-nav__item">
  <a href="#delayedstreampausestream-true" class="md-nav__link">
    <span class="md-ellipsis">
      delayedStream.pauseStream = true
          ...
          <li class="md-nav__item">
  <a href="#delayedstreammaxdatasize-1024-1024" class="md-nav__link">
    <span class="md-ellipsis">
      delayedStream.maxDataSize = 1024 * 1024
          ...
          <li class="md-nav__item">
  <a href="#delayedstreamdatasize-0" class="md-nav__link">
    <span class="md-ellipsis">
      delayedStream.dataSize = 0
          ...
          <li class="md-nav__item">
  <a href="#delayedstreamreadable" class="md-nav__link">
    <span class="md-ellipsis">
      delayedStream.readable
          ...
          <li class="md-nav__item">
  <a href="#delayedstreamresume" class="md-nav__link">
    <span class="md-ellipsis">
      delayedStream.resume()
          ...
          <li class="md-nav__item">
  <a href="#delayedstreampause" class="md-nav__link">
    <span class="md-ellipsis">
      delayedStream.pause()
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#delayedstreampipedest" class="md-nav__link">
    <span class="md-ellipsis">
      delayedStream.pipe(dest)
          ...
          <li class="md-nav__item">
  <a href="#delayedstreamrelease" class="md-nav__link">
    <span class="md-ellipsis">
...
<div class="highlight"><pre><span></span><code>npm<span class="w"> </span>install<span class="w"> </span>delayed-stream
</code></pre></div>
<h2 id="usage">Usage</h2>
<p>The following example shows how to write a http echo server that delays its
response by 1000 ms.</p>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">DelayedStream</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;delayed-stream&#39;</span><span class="p">);</span>
...
<span class="w">  </span><span class="kd">var</span><span class="w"> </span><span class="nx">delayed</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">DelayedStream</span><span class="p">.</span><span class="nx">create</span><span class="p">(</span><span class="nx">req</span><span class="p">);</span>
...
<span class="w">    </span><span class="nx">delayed</span><span class="p">.</span><span class="nx">pipe</span><span class="p">(</span><span class="nx">res</span><span class="p">);</span>
...
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">delayed</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">DelayedStream</span><span class="p">.</span><span class="nx">create</span><span class="p">(</span><span class="nx">req</span><span class="p">);</span>
...
<span class="w">  </span><span class="c1">// Emit all buffered events and resume underlaying source</span>
<span class="w">  </span><span class="nx">delayed</span><span class="p">.</span><span class="nx">resume</span><span class="p">();</span>
