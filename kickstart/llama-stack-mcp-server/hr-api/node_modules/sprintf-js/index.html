...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/sprintf-js/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>sprintf.js - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="sprintf.js - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/sprintf-js/README.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/sprintf-js/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="sprintf.js - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/sprintf-js/README.png" >
    ...
    <div data-md-component="skip">
        ...
        <a href="#sprintfjs" class="md-skip">
          Skip to content
        </a>
...
<nav class="md-nav md-nav--secondary" aria-label="Table of contents">
    ...
    <ul class="md-nav__list" data-md-component="toc" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#javascript-vsprintf" class="md-nav__link">
    <span class="md-ellipsis">
      JavaScript vsprintf
    </span>
  </a>
        ...
        <li class="md-nav__item">
  <a href="#argument-swapping" class="md-nav__link">
    <span class="md-ellipsis">
      Argument swapping
    </span>
  </a>
  ...
  <a href="#named-arguments" class="md-nav__link">
    <span class="md-ellipsis">
      Named arguments
        ...
        <li class="md-nav__item">
  <a href="#computed-values" class="md-nav__link">
    <span class="md-ellipsis">
      Computed values
    </span>
  </a>
...
<pre class="codehilite"><code>string sprintf(string format , [mixed arg1 [, mixed arg2 [ ,...]]])
</code></pre>
...
<h2 id="javascript-vsprintf">JavaScript <code>vsprintf</code></h2>
...
<pre class="codehilite"><code>vsprintf(&quot;The first 4 letters of the english alphabet are: %s, %s, %s and %s&quot;, [&quot;a&quot;, &quot;b&quot;, &quot;c&quot;, &quot;d&quot;])
</code></pre>
...
<pre class="codehilite"><code>sprintf(&quot;%2$s %3$s a %1$s&quot;, &quot;cracker&quot;, &quot;Polly&quot;, &quot;wants&quot;)
</code></pre>
...
<pre class="codehilite"><code>var user = {
    name: &quot;Dolly&quot;
}
...
<pre class="codehilite"><code>var users = [
    {name: &quot;Dolly&quot;},
    {name: &quot;Molly&quot;},
    {name: &quot;Polly&quot;}
]
...
<pre class="codehilite"><code>sprintf(&quot;Current timestamp: %d&quot;, Date.now) // Current timestamp: 1398005382890
...
<pre class="codehilite"><code>bower install sprintf
</code></pre>

<h2 id="or-as-a-nodejs-module">Or as a node.js module</h2>
<pre class="codehilite"><code>npm install sprintf-js
</code></pre>

<h3 id="usage">Usage</h3>
<pre class="codehilite"><code>var sprintf = require(&quot;sprintf-js&quot;).sprintf,
