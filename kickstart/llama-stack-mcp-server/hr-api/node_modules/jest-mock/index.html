...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/jest-mock/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>jest-mock - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="jest-mock - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/jest-mock/README.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/jest-mock/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="jest-mock - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/jest-mock/README.png" >
    ...
    <div data-md-component="skip">
        ...
        <a href="#jest-mock" class="md-skip">
          Skip to content
        </a>
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#constructorglobal" class="md-nav__link">
    <span class="md-ellipsis">
      constructor(global)
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#generatefrommetadatametadata" class="md-nav__link">
    <span class="md-ellipsis">
      generateFromMetadata(metadata)
          ...
          <li class="md-nav__item">
  <a href="#getmetadatacomponent" class="md-nav__link">
    <span class="md-ellipsis">
      getMetadata(component)
          ...
          <li class="md-nav__item">
  <a href="#fnimplementation" class="md-nav__link">
    <span class="md-ellipsis">
      fn(implementation?)
    </span>
  </a>
  
    <nav class="md-nav" aria-label="fn(implementation?)">
      <ul class="md-nav__list">
  ...
  <a href="#mock" class="md-nav__link">
    <span class="md-ellipsis">
      .mock
          ...
          <li class="md-nav__item">
  <a href="#mockreturnvalueoncevalue" class="md-nav__link">
    <span class="md-ellipsis">
      .mockReturnValueOnce(value)
          ...
          <li class="md-nav__item">
  <a href="#mockreturnvaluevalue" class="md-nav__link">
    <span class="md-ellipsis">
      .mockReturnValue(value)
          ...
          <li class="md-nav__item">
  <a href="#mockimplementationoncefunction" class="md-nav__link">
    <span class="md-ellipsis">
      .mockImplementationOnce(function)
          ...
          <li class="md-nav__item">
  <a href="#mockimplementationfunction" class="md-nav__link">
    <span class="md-ellipsis">
      .mockImplementation(function)
          ...
          <li class="md-nav__item">
  <a href="#mockreturnthis" class="md-nav__link">
    <span class="md-ellipsis">
      .mockReturnThis()
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#withimplementationfunction-callback" class="md-nav__link">
    <span class="md-ellipsis">
...
<p><strong>Note:</strong> More details on user side API can be found in <a href="https://jestjs.io/docs/mock-function-api">Jest documentation</a>.</p>
<h2 id="api">API</h2>
<div class="highlight"><pre><span></span><code><span class="k">import</span><span class="w"> </span><span class="p">{</span><span class="nx">ModuleMocker</span><span class="p">}</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s1">&#39;jest-mock&#39;</span><span class="p">;</span>
</code></pre></div>
<h3 id="constructorglobal"><code>constructor(global)</code></h3>
...
<h3 id="generatefrommetadatametadata"><code>generateFromMetadata(metadata)</code></h3>
<p>Generates a mock based on the given metadata (Metadata for the mock in the schema returned by the <code>getMetadata()</code> method of this module). Mocks treat functions specially, and all mock functions have additional members, described in the documentation for <code>fn()</code> in this module.</p>
...
<h3 id="getmetadatacomponent"><code>getMetadata(component)</code></h3>
...
<span class="w">    </span><span class="nx">staticMethod</span><span class="o">:</span><span class="w"> </span><span class="p">{</span><span class="nx">type</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;function&#39;</span><span class="p">},</span>
<span class="w">    </span><span class="nx">prototype</span><span class="o">:</span><span class="w"> </span><span class="p">{</span>
...
<span class="w">      </span><span class="nx">members</span><span class="o">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">        </span><span class="nx">instanceMethod</span><span class="o">:</span><span class="w"> </span><span class="p">{</span><span class="nx">type</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;function&#39;</span><span class="p">},</span>
<span class="w">      </span><span class="p">},</span>
<span class="w">    </span><span class="p">},</span>
<span class="w">  </span><span class="p">},</span>
<span class="p">};</span>
</code></pre></div>
<p>Metadata may also contain references to other objects defined within the same metadata object. The metadata for the referent must be marked with <code>refID</code> key and an arbitrary value. The referrer must be marked with a <code>ref</code> key that has the same value as object with refID that it refers to. For instance, this metadata blob:</p>
<div class="highlight"><pre><span></span><code><span class="kd">const</span><span class="w"> </span><span class="nx">refID</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="nx">type</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;object&#39;</span><span class="p">,</span>
<span class="w">  </span><span class="nx">refID</span><span class="o">:</span><span class="w"> </span><span class="mf">1</span><span class="p">,</span>
<span class="w">  </span><span class="nx">members</span><span class="o">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="nx">self</span><span class="o">:</span><span class="w"> </span><span class="p">{</span><span class="nx">ref</span><span class="o">:</span><span class="w"> </span><span class="mf">1</span><span class="p">},</span>
<span class="w">  </span><span class="p">},</span>
<span class="p">};</span>
</code></pre></div>
<p>Defines an object with a slot named <code>self</code> that refers back to the object.</p>
<h3 id="fnimplementation"><code>fn(implementation?)</code></h3>
...
<h5 id="mockreturnvalueoncevalue"><code>.mockReturnValueOnce(value)</code></h5>
<p>Pushes the given value onto a FIFO queue of return values for the function.</p>
<h5 id="mockreturnvaluevalue"><code>.mockReturnValue(value)</code></h5>
<p>Sets the default return value for the function.</p>
<h5 id="mockimplementationoncefunction"><code>.mockImplementationOnce(function)</code></h5>
<p>Pushes the given mock implementation onto a FIFO queue of mock implementations for the function.</p>
<h5 id="mockimplementationfunction"><code>.mockImplementation(function)</code></h5>
<p>Sets the default mock implementation for the function.</p>
<h5 id="mockreturnthis"><code>.mockReturnThis()</code></h5>
<p>Syntactic sugar for:</p>
<div class="highlight"><pre><span></span><code><span class="nx">mockFn</span><span class="p">.</span><span class="nx">mockImplementation</span><span class="p">(</span><span class="kd">function</span><span class="w"> </span><span class="p">()</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="k">return</span><span class="w"> </span><span class="k">this</span><span class="p">;</span>
<span class="p">});</span>
</code></pre></div>
<p>In case both <code>.mockImplementationOnce()</code> / <code>.mockImplementation()</code> and <code>.mockReturnValueOnce()</code> / <code>.mockReturnValue()</code> are called. The priority of which to use is based on what is the last call:</p>
<ul>
<li>if the last call is <code>.mockReturnValueOnce()</code> or <code>.mockReturnValue()</code>, use the specific return value or default return value. If specific return values are used up or no default return value is set, fall back to try <code>.mockImplementation()</code>;</li>
<li>if the last call is <code>.mockImplementationOnce()</code> or <code>.mockImplementation()</code>, run the specific implementation and return the result or run default implementation and return the result.</li>
</ul>
<h5 id="withimplementationfunction-callback"><code>.withImplementation(function, callback)</code></h5>
<p>Temporarily overrides the default mock implementation within the callback, then restores it's previous implementation.</p>
<p>If the callback is async or returns a <code>thenable</code>, <code>withImplementation</code> will return a promise. Awaiting the promise will await the callback and reset the implementation.</p>
