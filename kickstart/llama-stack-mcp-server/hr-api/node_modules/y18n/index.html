...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/y18n/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>y18n - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="y18n - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/y18n/README.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/y18n/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="y18n - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/y18n/README.png" >
  ...
  <a href="#deno-example" class="md-nav__link">
    <span class="md-ellipsis">
      Deno Example
        ...
        <li class="md-nav__item">
  <a href="#json-language-files" class="md-nav__link">
    <span class="md-ellipsis">
      JSON Language Files
    </span>
  </a>
  ...
  <a href="#methods" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Methods">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#requirey18nconfig" class="md-nav__link">
    <span class="md-ellipsis">
      require('y18n')(config)
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#y18n__str-arg-arg-arg" class="md-nav__link">
    <span class="md-ellipsis">
      y18n.__(str, arg, arg, arg)
          ...
          <li class="md-nav__item">
  <a href="#y18n__nsingularstring-pluralstring-count-arg-arg-arg" class="md-nav__link">
    <span class="md-ellipsis">
      y18n.__n(singularString, pluralString, count, arg, arg, arg)
          ...
          <li class="md-nav__item">
  <a href="#y18nsetlocalestr" class="md-nav__link">
    <span class="md-ellipsis">
      y18n.setLocale(str)
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#y18ngetlocale" class="md-nav__link">
    <span class="md-ellipsis">
      y18n.getLocale()
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#y18nupdatelocaleobj" class="md-nav__link">
    <span class="md-ellipsis">
...
<h1 id="y18n">y18n</h1>
<p><a href="https://npmjs.org/package/y18n"><img alt="NPM version" src="https://img.shields.io/npm/v/y18n.svg" /></a>
<a href="https://github.com/feross/standard"><img alt="js-standard-style" src="https://img.shields.io/badge/code%20style-standard-brightgreen.svg" /></a>
<a href="https://conventionalcommits.org"><img alt="Conventional Commits" src="https://img.shields.io/badge/Conventional%20Commits-1.0.0-yellow.svg" /></a></p>
...
<div class="highlight"><pre><span></span><code><span class="kd">const</span><span class="w"> </span><span class="nx">__</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;y18n&#39;</span><span class="p">)().</span><span class="nx">__</span><span class="p">;</span>
...
<span class="kd">const</span><span class="w"> </span><span class="nx">str</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="s1">&#39;foo&#39;</span><span class="p">;</span>

<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">__</span><span class="sb">`my awesome string </span><span class="si">${</span><span class="nx">str</span><span class="si">}</span><span class="sb">`</span><span class="p">);</span>
</code></pre></div>
<p>output:</p>
<p><code>my awesome string foo</code></p>
<p><em>pluralization support:</em></p>
<div class="highlight"><pre><span></span><code><span class="kd">const</span><span class="w"> </span><span class="nx">__n</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;y18n&#39;</span><span class="p">)().</span><span class="nx">__n</span><span class="p">;</span>
...
<div class="highlight"><pre><span></span><code><span class="k">import</span><span class="w"> </span><span class="nx">y18n</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s2">&quot;https://deno.land/x/y18n/deno.ts&quot;</span><span class="p">;</span>

<span class="kd">const</span><span class="w"> </span><span class="nx">__</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">y18n</span><span class="p">({</span>
<span class="w">  </span><span class="nx">locale</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;pirate&#39;</span><span class="p">,</span>
<span class="w">  </span><span class="nx">directory</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;./test/locales&#39;</span>
<span class="p">}).</span><span class="nx">__</span>

<span class="nx">console</span><span class="p">.</span><span class="nx">info</span><span class="p">(</span><span class="nx">__</span><span class="sb">`Hi, </span><span class="si">${</span><span class="s1">&#39;Ben&#39;</span><span class="si">}</span><span class="sb"> </span><span class="si">${</span><span class="s1">&#39;Coe&#39;</span><span class="si">}</span><span class="sb">!`</span><span class="p">)</span>
</code></pre></div>
