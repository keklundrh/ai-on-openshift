...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/yaml/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>YAML - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="YAML - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/yaml/README.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/yaml/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="YAML - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/yaml/README.png" >
  ...
  <a href="#parse-stringify" class="md-nav__link">
    <span class="md-ellipsis">
      Parse &amp; Stringify
          ...
          <li class="md-nav__item">
  <a href="#yaml-documents" class="md-nav__link">
    <span class="md-ellipsis">
      YAML Documents
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#cst-parser" class="md-nav__link">
    <span class="md-ellipsis">
      CST Parser
    </span>
  </a>
...
<p>To install:</p>
<div class="highlight"><pre><span></span><code>npm<span class="w"> </span>install<span class="w"> </span>yaml@next
</code></pre></div>
...
<p>The API provided by <code>yaml</code> has three layers, depending on how deep you need to go: <a href="https://eemeli.org/yaml/#parse-amp-stringify">Parse &amp; Stringify</a>, <a href="https://eemeli.org/yaml/#documents">Documents</a>, and the <a href="https://eemeli.org/yaml/#cst-parser">CST Parser</a>. The first has the simplest API and "just works", the second gets you all the bells and whistles supported by the library along with a decent <a href="https://eemeli.org/yaml/#content-nodes">AST</a>, and the third is the closest to YAML source, making it fast, raw, and crude.</p>
<div class="highlight"><pre><span></span><code><span class="k">import</span><span class="w"> </span><span class="nx">YAML</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s1">&#39;yaml&#39;</span>
...
<ul>
<li><a href="https://eemeli.org/yaml/#yaml-parse"><code>YAML.parse(str, reviver?, options?): value</code></a></li>
<li><a href="https://eemeli.org/yaml/#yaml-stringify"><code>YAML.stringify(value, replacer?, options?): string</code></a></li>
</ul>
<h3 id="yaml-documents">YAML Documents</h3>
<ul>
<li><a href="https://eemeli.org/yaml/#options"><code>YAML.defaultOptions</code></a></li>
<li><a href="https://eemeli.org/yaml/#yaml-documents"><code>YAML.Document</code></a></li>
<li><a href="https://eemeli.org/yaml/#creating-documents"><code>constructor(value, replacer?, options?)</code></a></li>
<li><a href="https://eemeli.org/yaml/#options"><code>defaults</code></a></li>
<li><a href="https://eemeli.org/yaml/#creating-nodes"><code>#createNode(value, options?): Node</code></a></li>
<li><a href="https://eemeli.org/yaml/#working-with-anchors"><code>#anchors</code></a></li>
...
<li><a href="https://eemeli.org/yaml/#parsing-documents"><code>YAML.parseAllDocuments(str, options?): YAML.Document[]</code></a></li>
<li><a href="https://eemeli.org/yaml/#parsing-documents"><code>YAML.parseDocument(str, options?): YAML.Document</code></a></li>
</ul>
<div class="highlight"><pre><span></span><code><span class="k">import</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">Pair</span><span class="p">,</span><span class="w"> </span><span class="nx">YAMLMap</span><span class="p">,</span><span class="w"> </span><span class="nx">YAMLSeq</span><span class="w"> </span><span class="p">}</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s1">&#39;yaml/types&#39;</span>
</code></pre></div>
<ul>
<li><a href="https://eemeli.org/yaml/#creating-nodes"><code>new Pair(key, value)</code></a></li>
<li><a href="https://eemeli.org/yaml/#creating-nodes"><code>new YAMLMap()</code></a></li>
<li><a href="https://eemeli.org/yaml/#creating-nodes"><code>new YAMLSeq()</code></a></li>
</ul>
<h3 id="cst-parser">CST Parser</h3>
<div class="highlight"><pre><span></span><code><span class="k">import</span><span class="w"> </span><span class="nx">parseCST</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s1">&#39;yaml/parse-cst&#39;</span>
</code></pre></div>
<ul>
<li><a href="https://eemeli.org/yaml/#parsecst"><code>parseCST(str): CSTDocument[]</code></a></li>
<li><a href="https://eemeli.org/yaml/#parsecst"><code>YAML.parseCST(str): CSTDocument[]</code></a></li>
</ul>
<h2 id="yamlparse">YAML.parse</h2>
<div class="highlight"><pre><span></span><code><span class="c1"># file.yml</span>
<span class="nt">YAML</span><span class="p">:</span>
<span class="w">  </span><span class="p p-Indicator">-</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">A human-readable data serialization language</span>
<span class="w">  </span><span class="p p-Indicator">-</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">https://en.wikipedia.org/wiki/YAML</span>
<span class="nt">yaml</span><span class="p">:</span>
<span class="w">  </span><span class="p p-Indicator">-</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">A complete JavaScript implementation</span>
<span class="w">  </span><span class="p p-Indicator">-</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">https://www.npmjs.com/package/yaml</span>
</code></pre></div>
...
<span class="k">import</span><span class="w"> </span><span class="nx">YAML</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s1">&#39;yaml&#39;</span>
...
<span class="kd">const</span><span class="w"> </span><span class="nx">file</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">fs</span><span class="p">.</span><span class="nx">readFileSync</span><span class="p">(</span><span class="s1">&#39;./file.yml&#39;</span><span class="p">,</span><span class="w"> </span><span class="s1">&#39;utf8&#39;</span><span class="p">)</span>
...
<span class="nx">YAML</span><span class="p">.</span><span class="nx">stringify</span><span class="p">(</span><span class="mf">3.14159</span><span class="p">)</span>
<span class="c1">// &#39;3.14159\n&#39;</span>

<span class="nx">YAML</span><span class="p">.</span><span class="nx">stringify</span><span class="p">([</span><span class="kc">true</span><span class="p">,</span><span class="w"> </span><span class="kc">false</span><span class="p">,</span><span class="w"> </span><span class="s1">&#39;maybe&#39;</span><span class="p">,</span><span class="w"> </span><span class="kc">null</span><span class="p">])</span>
...
<span class="nx">YAML</span><span class="p">.</span><span class="nx">stringify</span><span class="p">({</span><span class="w"> </span><span class="nx">number</span><span class="o">:</span><span class="w"> </span><span class="mf">3</span><span class="p">,</span><span class="w"> </span><span class="nx">plain</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;string&#39;</span><span class="p">,</span><span class="w"> </span><span class="nx">block</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;two\nlines\n&#39;</span><span class="w"> </span><span class="p">})</span>
