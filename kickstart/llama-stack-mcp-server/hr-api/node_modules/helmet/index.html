...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/helmet/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>Helmet - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="Helmet - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/helmet/README.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/helmet/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="Helmet - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/helmet/README.png" >
...
<div class="highlight"><pre><span></span><code><span class="k">import</span><span class="w"> </span><span class="nx">helmet</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s2">&quot;helmet&quot;</span><span class="p">;</span>
...
<ul>
<li><a href="#content-security-policy"><code>Content-Security-Policy</code></a>: A powerful allow-list of what can happen on your page which mitigates many attacks</li>
<li><a href="#cross-origin-opener-policy"><code>Cross-Origin-Opener-Policy</code></a>: Helps process-isolate your page</li>
<li><a href="#cross-origin-resource-policy"><code>Cross-Origin-Resource-Policy</code></a>: Blocks others from loading your resources cross-origin</li>
<li><a href="#origin-agent-cluster"><code>Origin-Agent-Cluster</code></a>: Changes process isolation to be origin-based</li>
<li><a href="#referrer-policy"><code>Referrer-Policy</code></a>: Controls the <a href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Referer"><code>Referer</code></a> header</li>
<li><a href="#strict-transport-security"><code>Strict-Transport-Security</code></a>: Tells browsers to prefer HTTPS</li>
<li><a href="#x-content-type-options"><code>X-Content-Type-Options</code></a>: Avoids <a href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Basics_of_HTTP/MIME_types#mime_sniffing">MIME sniffing</a></li>
<li><a href="#x-dns-prefetch-control"><code>X-DNS-Prefetch-Control</code></a>: Controls DNS prefetching</li>
<li><a href="#x-download-options"><code>X-Download-Options</code></a>: Forces downloads to be saved (Internet Explorer only)</li>
<li><a href="#x-frame-options"><code>X-Frame-Options</code></a>: Legacy header that mitigates <a href="https://en.wikipedia.org/wiki/Clickjacking">clickjacking</a> attacks</li>
<li><a href="#x-permitted-cross-domain-policies"><code>X-Permitted-Cross-Domain-Policies</code></a>: Controls cross-domain behavior for Adobe products, like Acrobat</li>
<li><a href="#x-powered-by"><code>X-Powered-By</code></a>: Info about the web server. Removed because it could be used in simple attacks</li>
<li><a href="#x-xss-protection"><code>X-XSS-Protection</code></a>: Legacy header that tries to mitigate <a href="https://developer.mozilla.org/en-US/docs/Glossary/Cross-site_scripting">XSS attacks</a>, but makes things worse, so Helmet disables it</li>
</ul>
<p>Each header can be configured. For example, here's how you configure the <code>Content-Security-Policy</code> header:</p>
<div class="highlight"><pre><span></span><code><span class="c1">// Configure the Content-Security-Policy header.</span>
<span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span>
<span class="w">  </span><span class="nx">helmet</span><span class="p">({</span>
<span class="w">    </span><span class="nx">contentSecurityPolicy</span><span class="o">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">      </span><span class="nx">directives</span><span class="o">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">        </span><span class="s2">&quot;script-src&quot;</span><span class="o">:</span><span class="w"> </span><span class="p">[</span><span class="s2">&quot;&#39;self&#39;&quot;</span><span class="p">,</span><span class="w"> </span><span class="s2">&quot;example.com&quot;</span><span class="p">],</span>
<span class="w">      </span><span class="p">},</span>
<span class="w">    </span><span class="p">},</span>
<span class="w">  </span><span class="p">}),</span>
<span class="p">);</span>
</code></pre></div>
<p>Headers can also be disabled. For example, here's how you disable the <code>Content-Security-Policy</code> and <code>X-Download-Options</code> headers:</p>
<div class="highlight"><pre><span></span><code><span class="c1">// Disable the Content-Security-Policy and X-Download-Options headers</span>
<span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span>
<span class="w">  </span><span class="nx">helmet</span><span class="p">({</span>
<span class="w">    </span><span class="nx">contentSecurityPolicy</span><span class="o">:</span><span class="w"> </span><span class="kc">false</span><span class="p">,</span>
<span class="w">    </span><span class="nx">xDownloadOptions</span><span class="o">:</span><span class="w"> </span><span class="kc">false</span><span class="p">,</span>
<span class="w">  </span><span class="p">}),</span>
<span class="p">);</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="err">Content-Security-Policy: default-src &#39;self&#39;;base-uri &#39;self&#39;;font-src &#39;self&#39; https: data:;form-action &#39;self&#39;;frame-ancestors &#39;self&#39;;img-src &#39;self&#39; data:;object-src &#39;none&#39;;script-src &#39;self&#39;;script-src-attr &#39;none&#39;;style-src &#39;self&#39; https: &#39;unsafe-inline&#39;;upgrade-insecure-requests</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="c1">// Sets all of the defaults, but overrides `script-src`</span>
<span class="c1">// and disables the default `style-src`.</span>
<span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span>
<span class="w">  </span><span class="nx">helmet</span><span class="p">({</span>
<span class="w">    </span><span class="nx">contentSecurityPolicy</span><span class="o">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">      </span><span class="nx">directives</span><span class="o">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">        </span><span class="s2">&quot;script-src&quot;</span><span class="o">:</span><span class="w"> </span><span class="p">[</span><span class="s2">&quot;&#39;self&#39;&quot;</span><span class="p">,</span><span class="w"> </span><span class="s2">&quot;example.com&quot;</span><span class="p">],</span>
<span class="w">        </span><span class="s2">&quot;style-src&quot;</span><span class="o">:</span><span class="w"> </span><span class="kc">null</span><span class="p">,</span>
<span class="w">      </span><span class="p">},</span>
<span class="w">    </span><span class="p">},</span>
<span class="w">  </span><span class="p">}),</span>
<span class="p">);</span>
...
<div class="highlight"><pre><span></span><code><span class="c1">// Sets the `script-src` directive to</span>
<span class="c1">// &quot;&#39;self&#39; &#39;nonce-e33cc...&#39;&quot;</span>
...
<span class="w">  </span><span class="nx">res</span><span class="p">.</span><span class="nx">locals</span><span class="p">.</span><span class="nx">cspNonce</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">crypto</span><span class="p">.</span><span class="nx">randomBytes</span><span class="p">(</span><span class="mf">32</span><span class="p">).</span><span class="nx">toString</span><span class="p">(</span><span class="s2">&quot;hex&quot;</span><span class="p">);</span>
...
<span class="w">    </span><span class="nx">contentSecurityPolicy</span><span class="o">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">      </span><span class="nx">directives</span><span class="o">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">        </span><span class="nx">scriptSrc</span><span class="o">:</span><span class="w"> </span><span class="p">[</span><span class="s2">&quot;&#39;self&#39;&quot;</span><span class="p">,</span><span class="w"> </span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="nx">res</span><span class="p">)</span><span class="w"> </span><span class="p">=&gt;</span><span class="w"> </span><span class="sb">`&#39;nonce-</span><span class="si">${</span><span class="nx">res</span><span class="p">.</span><span class="nx">locals</span><span class="p">.</span><span class="nx">cspNonce</span><span class="si">}</span><span class="sb">&#39;`</span><span class="p">],</span>
<span class="w">      </span><span class="p">},</span>
<span class="w">    </span><span class="p">},</span>
<span class="w">  </span><span class="p">}),</span>
<span class="p">);</span>
...
<div class="highlight"><pre><span></span><code><span class="c1">// Sets &quot;Content-Security-Policy: default-src &#39;self&#39;;</span>
<span class="c1">// script-src &#39;self&#39; example.com;object-src &#39;none&#39;;</span>
...
<span class="w">        </span><span class="nx">scriptSrc</span><span class="o">:</span><span class="w"> </span><span class="p">[</span><span class="s2">&quot;&#39;self&#39;&quot;</span><span class="p">,</span><span class="w"> </span><span class="s2">&quot;example.com&quot;</span><span class="p">],</span>
<span class="w">        </span><span class="nx">objectSrc</span><span class="o">:</span><span class="w"> </span><span class="p">[</span><span class="s2">&quot;&#39;none&#39;&quot;</span><span class="p">],</span>
<span class="w">        </span><span class="nx">upgradeInsecureRequests</span><span class="o">:</span><span class="w"> </span><span class="p">[],</span>
<span class="w">      </span><span class="p">},</span>
<span class="w">    </span><span class="p">},</span>
<span class="w">  </span><span class="p">}),</span>
<span class="p">);</span>
...
<div class="highlight"><pre><span></span><code><span class="c1">// Sets the Content-Security-Policy-Report-Only header</span>
<span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span>
<span class="w">  </span><span class="nx">helmet</span><span class="p">({</span>
<span class="w">    </span><span class="nx">contentSecurityPolicy</span><span class="o">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">      </span><span class="nx">directives</span><span class="o">:</span><span class="w"> </span><span class="p">{</span>
...
<span class="w">      </span><span class="p">},</span>
<span class="w">      </span><span class="nx">reportOnly</span><span class="o">:</span><span class="w"> </span><span class="kc">true</span><span class="p">,</span>
<span class="w">    </span><span class="p">},</span>
<span class="w">  </span><span class="p">}),</span>
<span class="p">);</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="c1">// Helmet does not set Cross-Origin-Embedder-Policy</span>
<span class="c1">// by default.</span>
<span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span><span class="nx">helmet</span><span class="p">());</span>

<span class="c1">// Sets &quot;Cross-Origin-Embedder-Policy: require-corp&quot;</span>
<span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span><span class="nx">helmet</span><span class="p">({</span><span class="w"> </span><span class="nx">crossOriginEmbedderPolicy</span><span class="o">:</span><span class="w"> </span><span class="kc">true</span><span class="w"> </span><span class="p">}));</span>

<span class="c1">// Sets &quot;Cross-Origin-Embedder-Policy: credentialless&quot;</span>
<span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span><span class="nx">helmet</span><span class="p">({</span><span class="w"> </span><span class="nx">crossOriginEmbedderPolicy</span><span class="o">:</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">policy</span><span class="o">:</span><span class="w"> </span><span class="s2">&quot;credentialless&quot;</span><span class="w"> </span><span class="p">}</span><span class="w"> </span><span class="p">}));</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="err">Cross-Origin-Opener-Policy: same-origin</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="c1">// Sets &quot;Cross-Origin-Opener-Policy: same-origin&quot;</span>
<span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span><span class="nx">helmet</span><span class="p">());</span>

<span class="c1">// Sets &quot;Cross-Origin-Opener-Policy: same-origin-allow-popups&quot;</span>
<span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span>
<span class="w">  </span><span class="nx">helmet</span><span class="p">({</span>
<span class="w">    </span><span class="nx">crossOriginOpenerPolicy</span><span class="o">:</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">policy</span><span class="o">:</span><span class="w"> </span><span class="s2">&quot;same-origin-allow-popups&quot;</span><span class="w"> </span><span class="p">},</span>
<span class="w">  </span><span class="p">}),</span>
<span class="p">);</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span>
<span class="w">  </span><span class="nx">helmet</span><span class="p">({</span>
<span class="w">    </span><span class="nx">crossOriginOpenerPolicy</span><span class="o">:</span><span class="w"> </span><span class="kc">false</span><span class="p">,</span>
<span class="w">  </span><span class="p">}),</span>
<span class="p">);</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="err">Cross-Origin-Resource-Policy: same-origin</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="c1">// Sets &quot;Cross-Origin-Resource-Policy: same-origin&quot;</span>
<span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span><span class="nx">helmet</span><span class="p">());</span>

<span class="c1">// Sets &quot;Cross-Origin-Resource-Policy: same-site&quot;</span>
<span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span><span class="nx">helmet</span><span class="p">({</span><span class="w"> </span><span class="nx">crossOriginResourcePolicy</span><span class="o">:</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">policy</span><span class="o">:</span><span class="w"> </span><span class="s2">&quot;same-site&quot;</span><span class="w"> </span><span class="p">}</span><span class="w"> </span><span class="p">}));</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span>
<span class="w">  </span><span class="nx">helmet</span><span class="p">({</span>
<span class="w">    </span><span class="nx">crossOriginResourcePolicy</span><span class="o">:</span><span class="w"> </span><span class="kc">false</span><span class="p">,</span>
<span class="w">  </span><span class="p">}),</span>
<span class="p">);</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="err">Origin-Agent-Cluster: ?1</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="c1">// Sets &quot;Origin-Agent-Cluster: ?1&quot;</span>
<span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span><span class="nx">helmet</span><span class="p">());</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span>
<span class="w">  </span><span class="nx">helmet</span><span class="p">({</span>
<span class="w">    </span><span class="nx">originAgentCluster</span><span class="o">:</span><span class="w"> </span><span class="kc">false</span><span class="p">,</span>
<span class="w">  </span><span class="p">}),</span>
<span class="p">);</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="err">Referrer-Policy: no-referrer</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="c1">// Sets &quot;Referrer-Policy: no-referrer&quot;</span>
<span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span><span class="nx">helmet</span><span class="p">());</span>
</code></pre></div>
...
<span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span>
<span class="w">  </span><span class="nx">helmet</span><span class="p">({</span>
<span class="w">    </span><span class="nx">referrerPolicy</span><span class="o">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">      </span><span class="nx">policy</span><span class="o">:</span><span class="w"> </span><span class="s2">&quot;no-referrer&quot;</span><span class="p">,</span>
<span class="w">    </span><span class="p">},</span>
<span class="w">  </span><span class="p">}),</span>
<span class="p">);</span>
...
<span class="w">  </span><span class="nx">helmet</span><span class="p">({</span>
<span class="w">    </span><span class="nx">referrerPolicy</span><span class="o">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">      </span><span class="nx">policy</span><span class="o">:</span><span class="w"> </span><span class="p">[</span><span class="s2">&quot;origin&quot;</span><span class="p">,</span><span class="w"> </span><span class="s2">&quot;unsafe-url&quot;</span><span class="p">],</span>
<span class="w">    </span><span class="p">},</span>
<span class="w">  </span><span class="p">}),</span>
<span class="p">);</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span>
<span class="w">  </span><span class="nx">helmet</span><span class="p">({</span>
<span class="w">    </span><span class="nx">referrerPolicy</span><span class="o">:</span><span class="w"> </span><span class="kc">false</span><span class="p">,</span>
<span class="w">  </span><span class="p">}),</span>
<span class="p">);</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="err">Strict-Transport-Security: max-age=15552000; includeSubDomains</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="c1">// Sets &quot;Strict-Transport-Security: max-age=15552000; includeSubDomains&quot;</span>
<span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span><span class="nx">helmet</span><span class="p">());</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="c1">// Sets &quot;Strict-Transport-Security: max-age=123456; includeSubDomains&quot;</span>
<span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span>
<span class="w">  </span><span class="nx">helmet</span><span class="p">({</span>
<span class="w">    </span><span class="nx">strictTransportSecurity</span><span class="o">:</span><span class="w"> </span><span class="p">{</span>
...
<span class="w">  </span><span class="nx">helmet</span><span class="p">({</span>
<span class="w">    </span><span class="nx">strictTransportSecurity</span><span class="o">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">      </span><span class="nx">maxAge</span><span class="o">:</span><span class="w"> </span><span class="mf">63072000</span><span class="p">,</span>
<span class="w">      </span><span class="nx">preload</span><span class="o">:</span><span class="w"> </span><span class="kc">true</span><span class="p">,</span>
<span class="w">    </span><span class="p">},</span>
<span class="w">  </span><span class="p">}),</span>
<span class="p">);</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span>
<span class="w">  </span><span class="nx">helmet</span><span class="p">({</span>
<span class="w">    </span><span class="nx">strictTransportSecurity</span><span class="o">:</span><span class="w"> </span><span class="kc">false</span><span class="p">,</span>
<span class="w">  </span><span class="p">}),</span>
<span class="p">);</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="err">X-Content-Type-Options: nosniff</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="c1">// Sets &quot;X-Content-Type-Options: nosniff&quot;</span>
<span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span><span class="nx">helmet</span><span class="p">());</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span>
<span class="w">  </span><span class="nx">helmet</span><span class="p">({</span>
<span class="w">    </span><span class="nx">xContentTypeOptions</span><span class="o">:</span><span class="w"> </span><span class="kc">false</span><span class="p">,</span>
<span class="w">  </span><span class="p">}),</span>
<span class="p">);</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="err">X-DNS-Prefetch-Control: off</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="c1">// Sets &quot;X-DNS-Prefetch-Control: off&quot;</span>
<span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span><span class="nx">helmet</span><span class="p">());</span>
</code></pre></div>
...
<span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span>
<span class="w">  </span><span class="nx">helmet</span><span class="p">({</span>
<span class="w">    </span><span class="nx">xDnsPrefetchControl</span><span class="o">:</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">allow</span><span class="o">:</span><span class="w"> </span><span class="kc">false</span><span class="w"> </span><span class="p">},</span>
<span class="w">  </span><span class="p">}),</span>
<span class="p">);</span>
...
<span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span>
<span class="w">  </span><span class="nx">helmet</span><span class="p">({</span>
<span class="w">    </span><span class="nx">xDnsPrefetchControl</span><span class="o">:</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">allow</span><span class="o">:</span><span class="w"> </span><span class="kc">true</span><span class="w"> </span><span class="p">},</span>
<span class="w">  </span><span class="p">}),</span>
<span class="p">);</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span>
<span class="w">  </span><span class="nx">helmet</span><span class="p">({</span>
<span class="w">    </span><span class="nx">xDnsPrefetchControl</span><span class="o">:</span><span class="w"> </span><span class="kc">false</span><span class="p">,</span>
<span class="w">  </span><span class="p">}),</span>
<span class="p">);</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="err">X-Download-Options: noopen</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="c1">// Sets &quot;X-Download-Options: noopen&quot;</span>
<span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span><span class="nx">helmet</span><span class="p">());</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="err">X-Frame-Options: SAMEORIGIN</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="c1">// Sets &quot;X-Frame-Options: SAMEORIGIN&quot;</span>
<span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span><span class="nx">helmet</span><span class="p">());</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="c1">// Sets &quot;X-Frame-Options: DENY&quot;</span>
<span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span>
<span class="w">  </span><span class="nx">helmet</span><span class="p">({</span>
<span class="w">    </span><span class="nx">xFrameOptions</span><span class="o">:</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">action</span><span class="o">:</span><span class="w"> </span><span class="s2">&quot;deny&quot;</span><span class="w"> </span><span class="p">},</span>
<span class="w">  </span><span class="p">}),</span>
<span class="p">);</span>
...
<span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span>
<span class="w">  </span><span class="nx">helmet</span><span class="p">({</span>
<span class="w">    </span><span class="nx">xFrameOptions</span><span class="o">:</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">action</span><span class="o">:</span><span class="w"> </span><span class="s2">&quot;sameorigin&quot;</span><span class="w"> </span><span class="p">},</span>
<span class="w">  </span><span class="p">}),</span>
<span class="p">);</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span>
<span class="w">  </span><span class="nx">helmet</span><span class="p">({</span>
<span class="w">    </span><span class="nx">xFrameOptions</span><span class="o">:</span><span class="w"> </span><span class="kc">false</span><span class="p">,</span>
<span class="w">  </span><span class="p">}),</span>
<span class="p">);</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="err">X-Permitted-Cross-Domain-Policies: none</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="c1">// Sets &quot;X-Permitted-Cross-Domain-Policies: none&quot;</span>
<span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span><span class="nx">helmet</span><span class="p">());</span>
</code></pre></div>
...
<span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span>
<span class="w">  </span><span class="nx">helmet</span><span class="p">({</span>
<span class="w">    </span><span class="nx">xPermittedCrossDomainPolicies</span><span class="o">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">      </span><span class="nx">permittedPolicies</span><span class="o">:</span><span class="w"> </span><span class="s2">&quot;none&quot;</span><span class="p">,</span>
<span class="w">    </span><span class="p">},</span>
<span class="w">  </span><span class="p">}),</span>
<span class="p">);</span>
...
<span class="w">  </span><span class="nx">helmet</span><span class="p">({</span>
<span class="w">    </span><span class="nx">xPermittedCrossDomainPolicies</span><span class="o">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">      </span><span class="nx">permittedPolicies</span><span class="o">:</span><span class="w"> </span><span class="s2">&quot;by-content-type&quot;</span><span class="p">,</span>
<span class="w">    </span><span class="p">},</span>
<span class="w">  </span><span class="p">}),</span>
<span class="p">);</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span>
<span class="w">  </span><span class="nx">helmet</span><span class="p">({</span>
<span class="w">    </span><span class="nx">xPermittedCrossDomainPolicies</span><span class="o">:</span><span class="w"> </span><span class="kc">false</span><span class="p">,</span>
<span class="w">  </span><span class="p">}),</span>
<span class="p">);</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="c1">// Not required, but recommended for Express users:</span>
...
<span class="c1">// Ask Helmet to ignore the X-Powered-By header.</span>
<span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span>
<span class="w">  </span><span class="nx">helmet</span><span class="p">({</span>
<span class="w">    </span><span class="nx">xPoweredBy</span><span class="o">:</span><span class="w"> </span><span class="kc">false</span><span class="p">,</span>
<span class="w">  </span><span class="p">}),</span>
<span class="p">);</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="err">X-XSS-Protection: 0</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="c1">// This is not recommended.</span>
<span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span>
<span class="w">  </span><span class="nx">helmet</span><span class="p">({</span>
<span class="w">    </span><span class="nx">xXssProtection</span><span class="o">:</span><span class="w"> </span><span class="kc">false</span><span class="p">,</span>
<span class="w">  </span><span class="p">}),</span>
<span class="p">);</span>
</code></pre></div>
