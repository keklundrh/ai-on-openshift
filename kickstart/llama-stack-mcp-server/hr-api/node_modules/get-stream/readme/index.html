...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/get-stream/readme/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>get-stream - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="get-stream - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/get-stream/readme.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/get-stream/readme/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="get-stream - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/get-stream/readme.png" >
    ...
    <div data-md-component="skip">
        ...
        <a href="#get-stream" class="md-skip">
          Skip to content
        </a>
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#getstreamstream-options" class="md-nav__link">
    <span class="md-ellipsis">
      getStream(stream, options?)
    </span>
  </a>
  
    <nav class="md-nav" aria-label="getStream(stream, options?)">
      <ul class="md-nav__list">
  ...
  <a href="#maxbuffer" class="md-nav__link">
    <span class="md-ellipsis">
      maxBuffer
          ...
          <li class="md-nav__item">
  <a href="#getstreambufferstream-options" class="md-nav__link">
    <span class="md-ellipsis">
      getStream.buffer(stream, options?)
          ...
          <li class="md-nav__item">
  <a href="#getstreamarraystream-options" class="md-nav__link">
    <span class="md-ellipsis">
  ...
  <a href="#faq" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="FAQ">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#how-is-this-different-from-concat-stream" class="md-nav__link">
    <span class="md-ellipsis">
...
<h1 id="get-stream">get-stream</h1>
<blockquote>
<p>Get a stream as a string, buffer, or array</p>
</blockquote>
<h2 id="install">Install</h2>
<div class="highlight"><pre><span></span><code>$ npm install get-stream
</code></pre></div>
...
<span class="kd">const</span><span class="w"> </span><span class="nx">getStream</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;get-stream&#39;</span><span class="p">);</span>
...
<span class="w">    </span><span class="kd">const</span><span class="w"> </span><span class="nx">stream</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">fs</span><span class="p">.</span><span class="nx">createReadStream</span><span class="p">(</span><span class="s1">&#39;unicorn.txt&#39;</span><span class="p">);</span>

<span class="w">    </span><span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="k">await</span><span class="w"> </span><span class="nx">getStream</span><span class="p">(</span><span class="nx">stream</span><span class="p">));</span>
...
<h3 id="getstreamstream-options">getStream(stream, options?)</h3>
...
<h3 id="getstreambufferstream-options">getStream.buffer(stream, options?)</h3>
...
<h3 id="getstreamarraystream-options">getStream.array(stream, options?)</h3>
...
<span class="w">        </span><span class="k">await</span><span class="w"> </span><span class="nx">getStream</span><span class="p">(</span><span class="nx">streamThatErrorsAtTheEnd</span><span class="p">(</span><span class="s1">&#39;unicorn&#39;</span><span class="p">));</span>
<span class="w">    </span><span class="p">}</span><span class="w"> </span><span class="k">catch</span><span class="w"> </span><span class="p">(</span><span class="nx">error</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">        </span><span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">error</span><span class="p">.</span><span class="nx">bufferedData</span><span class="p">);</span>
<span class="w">        </span><span class="c1">//=&gt; &#39;unicorn&#39;</span>
<span class="w">    </span><span class="p">}</span>
<span class="p">})()</span>
</code></pre></div>
<h2 id="faq">FAQ</h2>
<h3 id="how-is-this-different-from-concat-stream">How is this different from <a href="https://github.com/maxogden/concat-stream"><code>concat-stream</code></a>?</h3>
