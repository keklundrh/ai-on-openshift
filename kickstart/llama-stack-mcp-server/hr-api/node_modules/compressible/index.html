...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/compressible/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>compressible - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="compressible - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/compressible/README.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/compressible/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="compressible - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/compressible/README.png" >
    ...
    <div data-md-component="skip">
        ...
        <a href="#compressible" class="md-skip">
          Skip to content
        </a>
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#compressibletype" class="md-nav__link">
    <span class="md-ellipsis">
      compressible(type)
    </span>
  </a>
...
<h1 id="compressible">compressible</h1>
<p><a href="https://npmjs.org/package/compressible"><img alt="NPM Version" src="https://badgen.net/npm/v/compressible" /></a>
<a href="https://npmjs.org/package/compressible"><img alt="NPM Downloads" src="https://badgen.net/npm/dm/compressible" /></a>
<a href="https://nodejs.org/en/download"><img alt="Node.js Version" src="https://badgen.net/npm/node/compressible" /></a>
<a href="https://travis-ci.org/jshttp/compressible"><img alt="Build Status" src="https://badgen.net/travis/jshttp/compressible/master" /></a>
<a href="https://coveralls.io/r/jshttp/compressible?branch=master"><img alt="Test Coverage" src="https://badgen.net/coveralls/c/github/jshttp/compressible/master" /></a></p>
<p>Compressible <code>Content-Type</code> / <code>mime</code> checking.</p>
<h2 id="installation">Installation</h2>
<div class="highlight"><pre><span></span><code>$<span class="w"> </span>npm<span class="w"> </span>install<span class="w"> </span>compressible
</code></pre></div>
<h2 id="api">API</h2>
<!-- eslint-disable no-unused-vars -->

<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">compressible</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;compressible&#39;</span><span class="p">)</span>
</code></pre></div>
<h3 id="compressibletype">compressible(type)</h3>
<p>Checks if the given <code>Content-Type</code> is compressible. The <code>type</code> argument is expected
to be a value MIME type or <code>Content-Type</code> string, though no validation is performed.</p>
<p>The MIME is looked up in the <a href="https://www.npmjs.com/package/mime-db"><code>mime-db</code></a> and
if there is compressible information in the database entry, that is returned. Otherwise,
this module will fallback to <code>true</code> for the following types:</p>
<ul>
...
<p>If this module is not sure if a type is specifically compressible or specifically
uncompressible, <code>undefined</code> is returned.</p>
<!-- eslint-disable no-undef -->

<div class="highlight"><pre><span></span><code><span class="nx">compressible</span><span class="p">(</span><span class="s1">&#39;text/html&#39;</span><span class="p">)</span><span class="w"> </span><span class="c1">// =&gt; true</span>
<span class="nx">compressible</span><span class="p">(</span><span class="s1">&#39;image/png&#39;</span><span class="p">)</span><span class="w"> </span><span class="c1">// =&gt; false</span>
</code></pre></div>
