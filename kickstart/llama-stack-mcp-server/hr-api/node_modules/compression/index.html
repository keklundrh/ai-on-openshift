...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/compression/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>compression - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="compression - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/compression/README.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/compression/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="compression - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/compression/README.png" >
    ...
    <div data-md-component="skip">
        ...
        <a href="#compression" class="md-skip">
          Skip to content
        </a>
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#compressionoptions" class="md-nav__link">
    <span class="md-ellipsis">
      compression([options])
    </span>
  </a>
  
    <nav class="md-nav" aria-label="compression([options])">
      <ul class="md-nav__list">
  ...
  <a href="#options" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Options">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#chunksize" class="md-nav__link">
    <span class="md-ellipsis">
      chunkSize
    </span>
  </a>
  ...
  <a href="#level" class="md-nav__link">
    <span class="md-ellipsis">
      level
          ...
          <li class="md-nav__item">
  <a href="#memlevel" class="md-nav__link">
    <span class="md-ellipsis">
      memLevel
    </span>
  </a>
  ...
  <a href="#threshold" class="md-nav__link">
    <span class="md-ellipsis">
      threshold
          ...
          <li class="md-nav__item">
  <a href="#windowbits" class="md-nav__link">
    <span class="md-ellipsis">
      windowBits
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#enforceencoding" class="md-nav__link">
    <span class="md-ellipsis">
      enforceEncoding
    </span>
  </a>
  ...
  <a href="#filter_1" class="md-nav__link">
    <span class="md-ellipsis">
      .filter
          ...
          <li class="md-nav__item">
  <a href="#resflush" class="md-nav__link">
    <span class="md-ellipsis">
      res.flush
    </span>
  </a>
  ...
  <a href="#express" class="md-nav__link">
    <span class="md-ellipsis">
      express
          ...
          <li class="md-nav__item">
  <a href="#nodejs-http-server" class="md-nav__link">
    <span class="md-ellipsis">
      Node.js HTTP server
    </span>
  </a>
...
<p><a href="https://npmjs.org/package/compression"><img alt="NPM Version" src="https://badgen.net/npm/v/compression" /></a>
<a href="https://npmcharts.com/compare/compression?minimal=true"><img alt="NPM Downloads" src="https://badgen.net/npm/dm/compression" /></a>
<a href="https://github.com/expressjs/compression/actions?query=workflow%3Aci"><img alt="Build Status" src="https://badgen.net/github/checks/expressjs/compression/master?label=CI" /></a>
<a href="https://ossf.github.io/scorecard-visualizer/#/projects/github.com/expressjs/compression"><img alt="OpenSSF Scorecard Badge" src="https://api.scorecard.dev/projects/github.com/expressjs/compression/badge" /></a>
<a href="https://opencollective.com/express"><img alt="Funding" src="https://badgen.net/badge/icon/sponsor/pink?icon=github&amp;label=Open%20Collective" /></a></p>
...
<p><strong>Note</strong> Brotli is supported only since Node.js versions v11.7.0 and v10.16.0.</p>
...
<div class="highlight"><pre><span></span><code>$<span class="w"> </span>npm<span class="w"> </span>install<span class="w"> </span>compression
</code></pre></div>
<h2 id="api">API</h2>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">compression</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;compression&#39;</span><span class="p">)</span>
</code></pre></div>
...
<a href="https://nodejs.org/api/zlib.html#zlib_class_brotlioptions">brotli</a> options.</p>
<h5 id="chunksize">chunkSize</h5>
<p>Type: <code>Number</code><br>
Default: <code>zlib.constants.Z_DEFAULT_CHUNK</code>, or <code>16384</code>.</p>
...
<p>Type: <code>Number</code><br>
Default: <code>zlib.constants.Z_DEFAULT_COMPRESSION</code>, or <code>-1</code></p>
...
<ul>
<li><code>-1</code> Default compression level (also <code>zlib.constants.Z_DEFAULT_COMPRESSION</code>).</li>
<li><code>0</code> No compression (also <code>zlib.constants.Z_NO_COMPRESSION</code>).</li>
<li><code>1</code> Fastest compression (also <code>zlib.constants.Z_BEST_SPEED</code>).</li>
<li><code>2</code></li>
<li><code>3</code></li>
<li><code>4</code></li>
<li><code>5</code></li>
<li><code>6</code> (currently what <code>zlib.constants.Z_DEFAULT_COMPRESSION</code> points to).</li>
<li><code>7</code></li>
<li><code>8</code></li>
<li><code>9</code> Best compression (also <code>zlib.constants.Z_BEST_COMPRESSION</code>).</li>
</ul>
<p><strong>Note</strong> in the list above, <code>zlib</code> is from <code>zlib = require('zlib')</code>.</p>
<h5 id="memlevel">memLevel</h5>
<p>Type: <code>Number</code><br>
Default: <code>zlib.constants.Z_DEFAULT_MEMLEVEL</code>, or <code>8</code></p>
...
<p>Type: <code>Number</code><br>
Default: <code>zlib.constants.Z_DEFAULT_STRATEGY</code></p>
<p>This is used to tune the compression algorithm. This value only affects the
compression ratio, not the correctness of the compressed output, even if it
is not set appropriately.</p>
<ul>
<li><code>zlib.constants.Z_DEFAULT_STRATEGY</code> Use for normal data.</li>
<li><code>zlib.constants.Z_FILTERED</code> Use for data produced by a filter (or predictor).
    Filtered data consists mostly of small values with a somewhat random
    distribution. In this case, the compression algorithm is tuned to
    compress them better. The effect is to force more Huffman coding and less
    string matching; it is somewhat intermediate between <code>zlib.constants.Z_DEFAULT_STRATEGY</code>
    and <code>zlib.constants.Z_HUFFMAN_ONLY</code>.</li>
<li><code>zlib.constants.Z_FIXED</code> Use to prevent the use of dynamic Huffman codes, allowing
    for a simpler decoder for special applications.</li>
<li><code>zlib.constants.Z_HUFFMAN_ONLY</code> Use to force Huffman encoding only (no string match).</li>
<li><code>zlib.constants.Z_RLE</code> Use to limit match distances to one (run-length encoding).
    This is designed to be almost as fast as <code>zlib.constants.Z_HUFFMAN_ONLY</code>, but give
    better compression for PNG image data.</li>
</ul>
<p><strong>Note</strong> in the list above, <code>zlib</code> is from <code>zlib = require('zlib')</code>.</p>
<h5 id="threshold">threshold</h5>
<p>Type: <code>Number</code> or <code>String</code><br>
Default: <code>1kb</code></p>
...
accepted by the <a href="https://www.npmjs.com/package/bytes">bytes</a> module.</p>
...
<h5 id="windowbits">windowBits</h5>
<p>Type: <code>Number</code><br>
Default: <code>zlib.constants.Z_DEFAULT_WINDOWBITS</code>, or <code>15</code></p>
<p>See <a href="http://nodejs.org/api/zlib.html#zlib_memory_usage_tuning">Node.js documentation</a>
regarding the usage.</p>
<h5 id="enforceencoding">enforceEncoding</h5>
<p>Type: <code>String</code><br>
Default: <code>identity</code></p>
...
<span class="nx">app</span><span class="p">.</span><span class="nx">use</span><span class="p">(</span><span class="nx">compression</span><span class="p">({</span><span class="w"> </span><span class="nx">filter</span><span class="o">:</span><span class="w"> </span><span class="nx">shouldCompress</span><span class="w"> </span><span class="p">}))</span>

<span class="kd">function</span><span class="w"> </span><span class="nx">shouldCompress</span><span class="w"> </span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="nx">res</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
...
<span class="w">    </span><span class="c1">// don&#39;t compress responses with this request header</span>
<span class="w">    </span><span class="k">return</span><span class="w"> </span><span class="kc">false</span>
<span class="w">  </span><span class="p">}</span>

<span class="w">  </span><span class="c1">// fallback to standard filter function</span>
...
<p>When using this module with express, simply <code>app.use</code> the module as
...
<span class="c1">// add all routes</span>
</code></pre></div>
<h3 id="nodejs-http-server">Node.js HTTP server</h3>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">compression</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;compression&#39;</span><span class="p">)({</span><span class="w"> </span><span class="nx">threshold</span><span class="o">:</span><span class="w"> </span><span class="mf">0</span><span class="w"> </span><span class="p">})</span>
...
<span class="kd">function</span><span class="w"> </span><span class="nx">createServer</span><span class="w"> </span><span class="p">(</span><span class="nx">fn</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
...
<span class="w">    </span><span class="nx">compression</span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="nx">res</span><span class="p">,</span><span class="w"> </span><span class="kd">function</span><span class="w"> </span><span class="p">(</span><span class="nx">err</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
...
<span class="w">      </span><span class="nx">fn</span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="nx">res</span><span class="p">)</span>
<span class="w">    </span><span class="p">})</span>
<span class="w">  </span><span class="p">})</span>
<span class="p">}</span>

<span class="kd">var</span><span class="w"> </span><span class="nx">server</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">createServer</span><span class="p">(</span><span class="kd">function</span><span class="w"> </span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="nx">res</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
...
<span class="w">  </span><span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="s1">&#39;&gt; Listening at http://localhost:3000&#39;</span><span class="p">)</span>
<span class="p">})</span>
</code></pre></div>
...
<span class="c1">// server-sent event stream</span>
<span class="nx">app</span><span class="p">.</span><span class="nx">get</span><span class="p">(</span><span class="s1">&#39;/events&#39;</span><span class="p">,</span><span class="w"> </span><span class="kd">function</span><span class="w"> </span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="nx">res</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="nx">res</span><span class="p">.</span><span class="nx">setHeader</span><span class="p">(</span><span class="s1">&#39;Content-Type&#39;</span><span class="p">,</span><span class="w"> </span><span class="s1">&#39;text/event-stream&#39;</span><span class="p">)</span>
<span class="w">  </span><span class="nx">res</span><span class="p">.</span><span class="nx">setHeader</span><span class="p">(</span><span class="s1">&#39;Cache-Control&#39;</span><span class="p">,</span><span class="w"> </span><span class="s1">&#39;no-cache&#39;</span><span class="p">)</span>

<span class="w">  </span><span class="c1">// send a ping approx every 2 seconds</span>
<span class="w">  </span><span class="kd">var</span><span class="w"> </span><span class="nx">timer</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">setInterval</span><span class="p">(</span><span class="kd">function</span><span class="w"> </span><span class="p">()</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="nx">res</span><span class="p">.</span><span class="nx">write</span><span class="p">(</span><span class="s1">&#39;data: ping\n\n&#39;</span><span class="p">)</span>

<span class="w">    </span><span class="c1">// !!! this is the important part</span>
<span class="w">    </span><span class="nx">res</span><span class="p">.</span><span class="nx">flush</span><span class="p">()</span>
<span class="w">  </span><span class="p">},</span><span class="w"> </span><span class="mf">2000</span><span class="p">)</span>

<span class="w">  </span><span class="nx">res</span><span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="s1">&#39;close&#39;</span><span class="p">,</span><span class="w"> </span><span class="kd">function</span><span class="w"> </span><span class="p">()</span><span class="w"> </span><span class="p">{</span>
