...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/makeerror/readme/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>makeerror Build Status - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="makeerror Build Status - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/makeerror/readme.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/makeerror/readme/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="makeerror Build Status - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/makeerror/readme.png" >
    ...
    <div data-md-component="skip">
        ...
        <a href="#makeerror" class="md-skip">
          Skip to content
        </a>
  ...
  <a href="#basics" class="md-nav__link">
    <span class="md-ellipsis">
      Basics
        ...
        <li class="md-nav__item">
  <a href="#templatized-error-messages" class="md-nav__link">
    <span class="md-ellipsis">
      Templatized Error Messages
        ...
        <li class="md-nav__item">
  <a href="#prototype-hierarchies" class="md-nav__link">
    <span class="md-ellipsis">
...
<h1 id="makeerror">makeerror <a href="http://travis-ci.org/nshah/nodejs-makeerror"><img alt="Build Status" src="https://secure.travis-ci.org/nshah/nodejs-makeerror.png" /></a></h1>
<p>A library to make errors.</p>
<h2 id="basics">Basics</h2>
<p>Makes an Error constructor function with the signature below. All arguments are
optional, and if the first argument is not a <code>String</code>, it will be assumed to be
<code>data</code>:</p>
<div class="highlight"><pre><span></span><code><span class="kd">function</span><span class="p">(</span><span class="nx">message</span><span class="p">,</span><span class="w"> </span><span class="nx">data</span><span class="p">)</span>
</code></pre></div>
<p>You'll typically do something like:</p>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">makeError</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;makeerror&#39;</span><span class="p">)</span>
<span class="kd">var</span><span class="w"> </span><span class="nx">UnknownFileTypeError</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">makeError</span><span class="p">(</span>
<span class="w">  </span><span class="s1">&#39;UnknownFileTypeError&#39;</span><span class="p">,</span>
<span class="w">  </span><span class="s1">&#39;The specified type is not known.&#39;</span>
<span class="p">)</span>
<span class="kd">var</span><span class="w"> </span><span class="nx">er</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">UnknownFileTypeError</span><span class="p">()</span>
</code></pre></div>
<p><code>er</code> will have a prototype chain that ensures:</p>
<div class="highlight"><pre><span></span><code><span class="nx">er</span><span class="w"> </span><span class="ow">instanceof</span><span class="w"> </span><span class="nx">UnknownFileTypeError</span>
<span class="nx">er</span><span class="w"> </span><span class="ow">instanceof</span><span class="w"> </span><span class="ne">Error</span>
</code></pre></div>
<h2 id="templatized-error-messages">Templatized Error Messages</h2>
<p>There is support for simple string substitutions like:</p>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">makeError</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;makeerror&#39;</span><span class="p">)</span>
<span class="kd">var</span><span class="w"> </span><span class="nx">UnknownFileTypeError</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">makeError</span><span class="p">(</span>
<span class="w">  </span><span class="s1">&#39;UnknownFileTypeError&#39;</span><span class="p">,</span>
<span class="w">  </span><span class="s1">&#39;The specified type &quot;{type}&quot; is not known.&#39;</span>
<span class="p">)</span>
<span class="kd">var</span><span class="w"> </span><span class="nx">er</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">UnknownFileTypeError</span><span class="p">({</span><span class="w"> </span><span class="nx">type</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;bmp&#39;</span><span class="w"> </span><span class="p">})</span>
</code></pre></div>
<p>Now <code>er.message</code> or <code>er.toString()</code> will return <code>'The specified type "bmp" is
not known.'</code>.</p>
<h2 id="prototype-hierarchies">Prototype Hierarchies</h2>
<p>You can create simple hierarchies as well using the <code>prototype</code> chain:</p>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">makeError</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;makeerror&#39;</span><span class="p">)</span>
<span class="kd">var</span><span class="w"> </span><span class="nx">ParentError</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">makeError</span><span class="p">(</span><span class="s1">&#39;ParentError&#39;</span><span class="p">)</span>
<span class="kd">var</span><span class="w"> </span><span class="nx">ChildError</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">makeError</span><span class="p">(</span>
<span class="w">  </span><span class="s1">&#39;ChildError&#39;</span><span class="p">,</span>
<span class="w">  </span><span class="s1">&#39;The child error.&#39;</span><span class="p">,</span>
<span class="w">  </span><span class="p">{</span><span class="w"> </span><span class="nx">proto</span><span class="o">:</span><span class="w"> </span><span class="nx">ParentError</span><span class="p">()</span><span class="w"> </span><span class="p">}</span>
<span class="p">)</span>
<span class="kd">var</span><span class="w"> </span><span class="nx">er</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">ChildError</span><span class="p">()</span>
</code></pre></div>
<p><code>er</code> will have a prototype chain that ensures:</p>
<div class="highlight"><pre><span></span><code><span class="nx">er</span><span class="w"> </span><span class="ow">instanceof</span><span class="w"> </span><span class="nx">ChildError</span>
<span class="nx">er</span><span class="w"> </span><span class="ow">instanceof</span><span class="w"> </span><span class="nx">ParentError</span>
<span class="nx">er</span><span class="w"> </span><span class="ow">instanceof</span><span class="w"> </span><span class="ne">Error</span>
</code></pre></div>
