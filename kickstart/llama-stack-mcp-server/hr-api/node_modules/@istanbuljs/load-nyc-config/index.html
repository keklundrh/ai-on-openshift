...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/%40istanbuljs/load-nyc-config/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>@istanbuljs/load-nyc-config - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="@istanbuljs/load-nyc-config - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/@istanbuljs/load-nyc-config/README.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/%40istanbuljs/load-nyc-config/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="@istanbuljs/load-nyc-config - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/@istanbuljs/load-nyc-config/README.png" >
    ...
    <div data-md-component="skip">
        ...
        <a href="#istanbuljsload-nyc-config" class="md-skip">
          Skip to content
        </a>
...
<nav class="md-nav md-nav--secondary" aria-label="Table of contents">
    ...
    <ul class="md-nav__list" data-md-component="toc" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#loadnycconfigoptions" class="md-nav__link">
    <span class="md-ellipsis">
      loadNycConfig([options])
    </span>
  </a>
  
    <nav class="md-nav" aria-label="loadNycConfig([options])">
  ...
  <a href="#optionscwd" class="md-nav__link">
    <span class="md-ellipsis">
      options.cwd
          ...
          <li class="md-nav__item">
  <a href="#optionsnycrcpath" class="md-nav__link">
    <span class="md-ellipsis">
      options.nycrcPath
    </span>
  </a>
  ...
  <a href="#configuration-merging" class="md-nav__link">
    <span class="md-ellipsis">
      Configuration merging
        ...
        <li class="md-nav__item">
  <a href="#isloading" class="md-nav__link">
    <span class="md-ellipsis">
      isLoading
    </span>
  </a>
        ...
        <li class="md-nav__item">
  <a href="#istanbuljsload-nyc-config-for-enterprise" class="md-nav__link">
    <span class="md-ellipsis">
...
<h1 id="istanbuljsload-nyc-config">@istanbuljs/load-nyc-config</h1>
<p>The utility function which NYC uses to load configuration.
This can be used by outside programs to calculate the configuration.
Command-line arguments are not considered by this function.</p>
<div class="highlight"><pre><span></span><code><span class="kd">const</span><span class="w"> </span><span class="p">{</span><span class="nx">loadNycConfig</span><span class="p">}</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;@istanbuljs/load-nyc-config&#39;</span><span class="p">);</span>

<span class="p">(</span><span class="k">async</span><span class="w"> </span><span class="p">()</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="k">await</span><span class="w"> </span><span class="nx">loadNycConfig</span><span class="p">());</span>
<span class="p">})();</span>
</code></pre></div>
<h2 id="loadnycconfigoptions">loadNycConfig([options])</h2>
<h3 id="optionscwd">options.cwd</h3>
<p>Type: <code>string</code>
Default: <code>cwd</code> from parent nyc process or <code>process.cwd()</code></p>
<h3 id="optionsnycrcpath">options.nycrcPath</h3>
<p>Type: <code>string</code>
Default: <code>undefined</code></p>
<p>Name of the file containing nyc configuration.
This can be a relative or absolute path.
Relative paths can exist at <code>options.cwd</code> or any parent directory.
If an nycrc is specified but cannot be found an exception is thrown.</p>
<p>If no nycrc option is provided the default priority of config files are:</p>
<ul>
<li>.nycrc</li>
<li>.nycrc.json</li>
<li>.nycrc.yml</li>
<li>.nycrc.yaml</li>
<li>nyc.config.js</li>
<li>nyc.config.cjs</li>
<li>nyc.config.mjs</li>
</ul>
<h2 id="configuration-merging">Configuration merging</h2>
<p>Configuration is first loaded from <code>package.json</code> if found, this serves as the package
...
the effective require setting will only include <code>"esm"</code>.</p>
<h2 id="isloading">isLoading</h2>
<div class="highlight"><pre><span></span><code><span class="kd">const</span><span class="w"> </span><span class="p">{</span><span class="nx">isLoading</span><span class="p">}</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;@istanbuljs/load-nyc-config&#39;</span><span class="p">);</span>

<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">isLoading</span><span class="p">());</span>
</code></pre></div>
<p>In some cases source transformation hooks can get installed before the configuration is
loaded.  This allows hooks to ignore source loads that occur during configuration load.</p>
<h2 id="istanbuljsload-nyc-config-for-enterprise"><code>@istanbuljs/load-nyc-config</code> for enterprise</h2>
<p>Available as part of the Tidelift Subscription.</p>
<p>The maintainers of <code>@istanbuljs/load-nyc-config</code> and thousands of other packages are working with Tidelift to deliver commercial support and maintenance for the open source dependencies you use to build your applications. Save time, reduce risk, and improve code health, while paying the maintainers of the exact dependencies you use. <a href="https://tidelift.com/subscription/pkg/npm-istanbuljs-load-nyc-config?utm_source=npm-istanbuljs-load-nyc-config&amp;utm_medium=referral&amp;utm_campaign=enterprise">Learn more.</a></p>
