...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/%40istanbuljs/schema/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>@istanbuljs/schema - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="@istanbuljs/schema - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/@istanbuljs/schema/README.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/%40istanbuljs/schema/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="@istanbuljs/schema - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/@istanbuljs/schema/README.png" >
    ...
    <div data-md-component="skip">
        ...
        <a href="#istanbuljsschema" class="md-skip">
          Skip to content
        </a>
  ...
  <a href="#usage" class="md-nav__link">
    <span class="md-ellipsis">
      Usage
        ...
        <li class="md-nav__item">
  <a href="#istanbuljsschema-for-enterprise" class="md-nav__link">
    <span class="md-ellipsis">
...
<h1 id="istanbuljsschema">@istanbuljs/schema</h1>
<p><a href="https://travis-ci.org/istanbuljs/schema"><img alt="Travis CI" src="https://travis-ci.org/istanbuljs/schema.svg?branch=master" /></a>
<a href="https://npmjs.org/package/@istanbuljs/schema"><img alt="NPM Version" src="https://img.shields.io/npm/v/@istanbuljs/schema.svg" /></a>
<a href="https://npmjs.org/package/@istanbuljs/schema"><img alt="NPM Downloads" src="https://img.shields.io/npm/dm/@istanbuljs/schema.svg" /></a>
<a href="LICENSE"><img alt="MIT" src="https://img.shields.io/npm/l/@istanbuljs/schema.svg" /></a></p>
<p>Schemas describing various structures used by nyc and istanbuljs</p>
<h2 id="usage">Usage</h2>
<div class="highlight"><pre><span></span><code><span class="kd">const</span><span class="w"> </span><span class="p">{</span><span class="nx">nyc</span><span class="p">}</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;@istanbuljs/schema&#39;</span><span class="p">).</span><span class="nx">defaults</span><span class="p">;</span>

<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="sb">`Default exclude list:\n\t* </span><span class="si">${</span><span class="nx">nyc</span><span class="p">.</span><span class="nx">exclude</span><span class="p">.</span><span class="nx">join</span><span class="p">(</span><span class="s1">&#39;\n\t* &#39;</span><span class="p">)</span><span class="si">}</span><span class="sb">`</span><span class="p">);</span>
</code></pre></div>
<h2 id="istanbuljsschema-for-enterprise"><code>@istanbuljs/schema</code> for enterprise</h2>
