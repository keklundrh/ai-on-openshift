...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/%40babel/plugin-syntax-top-level-await/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>@babel/plugin-syntax-top-level-await - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="@babel/plugin-syntax-top-level-await - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/@babel/plugin-syntax-top-level-await/README.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/%40babel/plugin-syntax-top-level-await/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="@babel/plugin-syntax-top-level-await - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/@babel/plugin-syntax-top-level-await/README.png" >
    ...
    <div data-md-component="skip">
        ...
        <a href="#babelplugin-syntax-top-level-await" class="md-skip">
          Skip to content
        </a>
...
<h1 id="babelplugin-syntax-top-level-await">@babel/plugin-syntax-top-level-await</h1>
<blockquote>
<p>Allow parsing of top-level await in modules</p>
</blockquote>
<p>See our website <a href="https://babeljs.io/docs/en/babel-plugin-syntax-top-level-await">@babel/plugin-syntax-top-level-await</a> for more information.</p>
<h2 id="install">Install</h2>
<p>Using npm:</p>
<div class="highlight"><pre><span></span><code>npm<span class="w"> </span>install<span class="w"> </span>--save-dev<span class="w"> </span>@babel/plugin-syntax-top-level-await
</code></pre></div>
<p>or using yarn:</p>
<div class="highlight"><pre><span></span><code>yarn<span class="w"> </span>add<span class="w"> </span>@babel/plugin-syntax-top-level-await<span class="w"> </span>--dev
</code></pre></div>
