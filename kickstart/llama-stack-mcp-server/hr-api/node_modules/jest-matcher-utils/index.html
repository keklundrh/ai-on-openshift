...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/jest-matcher-utils/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>jest-matcher-utils - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="jest-matcher-utils - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/jest-matcher-utils/README.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/jest-matcher-utils/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="jest-matcher-utils - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/jest-matcher-utils/README.png" >
    ...
    <div data-md-component="skip">
        ...
        <a href="#jest-matcher-utils" class="md-skip">
          Skip to content
        </a>
  ...
  <a href="#installation" class="md-nav__link">
    <span class="md-ellipsis">
      Installation
        ...
        <li class="md-nav__item">
  <a href="#exports-srcindexts" class="md-nav__link">
    <span class="md-ellipsis">
      Exports (src/index.ts)
    </span>
  </a>
  
    <nav class="md-nav" aria-label="Exports (src/index.ts)">
...
<h1 id="jest-matcher-utils">jest-matcher-utils</h1>
<p>This package's exports are most notably used by <code>expect</code>'s <a href="https://jestjs.io/docs/expect#thisutils"><code>this.utils</code></a>.</p>
<h2 id="installation">Installation</h2>
<p>To add this package as a dependency of a project, run either of the following commands:</p>
<ul>
<li><code>npm install jest-matcher-utils</code></li>
<li><code>yarn add jest-matcher-utils</code></li>
</ul>
<h2 id="exports-srcindexts">Exports (<a href="https://github.com/jestjs/jest/blob/HEAD/packages/jest-matcher-utils/src/index.ts">src/index.ts</a>)</h2>
<h3 id="functions">Functions</h3>
<p><code>stringify</code> <code>highlightTrailingWhitespace</code> <code>printReceived</code> <code>printExpected</code> <code>printWithType</code> <code>ensureNoExpected</code> <code>ensureActualIsNumber</code> <code>ensureExpectedIsNumber</code> <code>ensureNumbers</code> <code>ensureExpectedIsNonNegativeInteger</code> <code>printDiffOrStringify</code> <code>diff</code> <code>pluralize</code> <code>getLabelPrinter</code> <code>matcherErrorMessage</code> <code>matcherHint</code></p>
<h3 id="types">Types</h3>
<p><code>MatcherHintOptions</code> <code>DiffOptions</code></p>
<h3 id="constants">Constants</h3>
<p><code>EXPECTED_COLOR</code> <code>RECEIVED_COLOR</code> <code>INVERTED_COLOR</code> <code>BOLD_WEIGHT</code> <code>DIM_COLOR</code> <code>SUGGEST_TO_CONTAIN_EQUAL</code></p>
