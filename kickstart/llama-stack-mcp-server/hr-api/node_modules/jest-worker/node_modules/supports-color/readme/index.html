...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/jest-worker/node_modules/supports-color/readme/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>supports-color - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="supports-color - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/jest-worker/node_modules/supports-color/readme.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/jest-worker/node_modules/supports-color/readme/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="supports-color - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/jest-worker/node_modules/supports-color/readme.png" >
    ...
    <div data-md-component="skip">
        ...
        <a href="#supports-color" class="md-skip">
          Skip to content
        </a>
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#requiresupports-colorsupportscolorstream-options" class="md-nav__link">
    <span class="md-ellipsis">
...
<h1 id="supports-color">supports-color</h1>
<blockquote>
<p>Detect whether a terminal supports color</p>
</blockquote>
<h2 id="install">Install</h2>
<div class="highlight"><pre><span></span><code>$ npm install supports-color
</code></pre></div>
<h2 id="usage">Usage</h2>
<div class="highlight"><pre><span></span><code><span class="kd">const</span><span class="w"> </span><span class="nx">supportsColor</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;supports-color&#39;</span><span class="p">);</span>
...
<h3 id="requiresupports-colorsupportscolorstream-options"><code>require('supports-color').supportsColor(stream, options?)</code></h3>
<p>Additionally, <code>supports-color</code> exposes the <code>.supportsColor()</code> function that takes an arbitrary write stream (e.g. <code>process.stdout</code>) and an optional options object to (re-)evaluate color support for an arbitrary stream.</p>
<p>For example, <code>require('supports-color').stdout</code> is the equivalent of <code>require('supports-color').supportsColor(process.stdout)</code>.</p>
<p>The options object supports a single boolean property <code>sniffFlags</code>. By default it is <code>true</code>, which instructs <code>supportsColor()</code> to sniff <code>process.argv</code> for the multitude of <code>--color</code> flags (see <em>Info</em> below). If <code>false</code>, then <code>process.argv</code> is not considered when determining color support.</p>
<h2 id="info">Info</h2>
