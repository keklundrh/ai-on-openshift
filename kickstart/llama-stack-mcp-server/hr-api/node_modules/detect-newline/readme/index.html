...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/detect-newline/readme/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>detect-newline Build Status - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="detect-newline Build Status - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/detect-newline/readme.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/detect-newline/readme/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="detect-newline Build Status - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/detect-newline/readme.png" >
    ...
    <div data-md-component="skip">
        ...
        <a href="#detect-newline" class="md-skip">
          Skip to content
        </a>
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#detectnewlinestring" class="md-nav__link">
    <span class="md-ellipsis">
      detectNewline(string)
          ...
          <li class="md-nav__item">
  <a href="#detectnewlinegracefulunknown" class="md-nav__link">
    <span class="md-ellipsis">
...
<h1 id="detect-newline">detect-newline <a href="https://travis-ci.org/sindresorhus/detect-newline"><img alt="Build Status" src="https://travis-ci.org/sindresorhus/detect-newline.svg?branch=master" /></a></h1>
<blockquote>
<p>Detect the dominant newline character of a string</p>
</blockquote>
<h2 id="install">Install</h2>
<div class="highlight"><pre><span></span><code>$ npm install detect-newline
</code></pre></div>
<h2 id="usage">Usage</h2>
<div class="highlight"><pre><span></span><code><span class="kd">const</span><span class="w"> </span><span class="nx">detectNewline</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;detect-newline&#39;</span><span class="p">);</span>

<span class="nx">detectNewline</span><span class="p">(</span><span class="s1">&#39;foo\nbar\nbaz\r\n&#39;</span><span class="p">);</span>
<span class="c1">//=&gt; &#39;\n&#39;</span>
</code></pre></div>
<h2 id="api">API</h2>
<h3 id="detectnewlinestring">detectNewline(string)</h3>
<p>Returns the detected newline or <code>undefined</code> when no newline character is found.</p>
<h3 id="detectnewlinegracefulunknown">detectNewline.graceful(unknown)</h3>
<p>Returns the detected newline or <code>\n</code> when no newline character is found or the input is not a string.</p>
<h2 id="related">Related</h2>
<ul>
<li><a href="https://github.com/sindresorhus/detect-newline-cli">detect-newline-cli</a> - CLI for this module</li>
