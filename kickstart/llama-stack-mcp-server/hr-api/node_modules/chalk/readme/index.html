...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/chalk/readme/">
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/chalk/readme.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/chalk/readme/" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/chalk/readme.png" >
    ...
    <div data-md-component="skip">
        ...
        <a href="#highlights" class="md-skip">
          Skip to content
        </a>
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#chalkstylestylestring-string" class="md-nav__link">
    <span class="md-ellipsis">
      chalk.&lt;style&gt;[.&lt;style&gt;...](string, [string...])
          ...
          <li class="md-nav__item">
  <a href="#chalklevel" class="md-nav__link">
    <span class="md-ellipsis">
      chalk.level
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#chalksupportscolor" class="md-nav__link">
    <span class="md-ellipsis">
      chalk.supportsColor
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#chalkstderr-and-chalkstderrsupportscolor" class="md-nav__link">
    <span class="md-ellipsis">
  ...
  <a href="#background-colors" class="md-nav__link">
    <span class="md-ellipsis">
      Background colors
        ...
        <li class="md-nav__item">
  <a href="#tagged-template-literal" class="md-nav__link">
    <span class="md-ellipsis">
      Tagged template literal
        ...
        <li class="md-nav__item">
  <a href="#256-and-truecolor-color-support" class="md-nav__link">
    <span class="md-ellipsis">
  ...
  <a href="#origin-story" class="md-nav__link">
    <span class="md-ellipsis">
      Origin story
        ...
        <li class="md-nav__item">
  <a href="#chalk-for-enterprise" class="md-nav__link">
    <span class="md-ellipsis">
...
<div class="highlight"><pre><span></span><code><span class="gp">$ </span>npm<span class="w"> </span>install<span class="w"> </span>chalk
</code></pre></div>
<h2 id="usage">Usage</h2>
<div class="highlight"><pre><span></span><code><span class="kd">const</span><span class="w"> </span><span class="nx">chalk</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;chalk&#39;</span><span class="p">);</span>
...
<div class="highlight"><pre><span></span><code><span class="kd">const</span><span class="w"> </span><span class="nx">name</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="s1">&#39;Sindre&#39;</span><span class="p">;</span>
...
<div class="highlight"><pre><span></span><code><span class="kd">const</span><span class="w"> </span><span class="nx">ctx</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="ow">new</span><span class="w"> </span><span class="nx">chalk</span><span class="p">.</span><span class="nx">Instance</span><span class="p">({</span><span class="nx">level</span><span class="o">:</span><span class="w"> </span><span class="mf">0</span><span class="p">});</span>
</code></pre></div>
<table>
<thead>
<tr>
...
<div class="highlight"><pre><span></span><code><span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">chalk</span><span class="p">.</span><span class="nx">bold</span><span class="p">.</span><span class="nx">rgb</span><span class="p">(</span><span class="mf">10</span><span class="p">,</span><span class="w"> </span><span class="mf">100</span><span class="p">,</span><span class="w"> </span><span class="mf">200</span><span class="p">)(</span><span class="s1">&#39;Hello!&#39;</span><span class="p">));</span>
