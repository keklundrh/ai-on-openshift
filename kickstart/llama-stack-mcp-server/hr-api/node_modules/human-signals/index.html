...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/human-signals/">
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/human-signals/README.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/human-signals/" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/human-signals/README.png" >
...
<p><a href="https://codecov.io/gh/ehmicky/human-signals"><img alt="Codecov" src="https://img.shields.io/codecov/c/github/ehmicky/human-signals.svg?label=tested&amp;logo=codecov" /></a>
<a href="https://travis-ci.org/ehmicky/human-signals"><img alt="Travis" src="https://img.shields.io/badge/cross-platform-4cc61e.svg?logo=travis" /></a>
<a href="https://www.npmjs.com/package/human-signals"><img alt="Node" src="https://img.shields.io/node/v/human-signals.svg?logo=node.js" /></a>
<a href="https://gitter.im/ehmicky/human-signals"><img alt="Gitter" src="https://img.shields.io/gitter/room/ehmicky/human-signals.svg?logo=gitter" /></a>
<a href="https://twitter.com/intent/follow?screen_name=ehmicky"><img alt="Twitter" src="https://img.shields.io/badge/%E2%80%8B-twitter-4cc61e.svg?logo=twitter" /></a>
<a href="https://medium.com/@ehmicky"><img alt="Medium" src="https://img.shields.io/badge/%E2%80%8B-medium-4cc61e.svg?logo=medium" /></a></p>
<p>Human-friendly process signals.</p>
<p>This is a map of known process signals with some information about each signal.</p>
<p>Unlike
<a href="https://nodejs.org/api/os.html#os_signal_constants"><code>os.constants.signals</code></a>
this includes:</p>
<ul>
<li>human-friendly <a href="#description">descriptions</a></li>
<li><a href="#action">default actions</a>, including whether they <a href="#forced">can be prevented</a></li>
<li>whether the signal is <a href="#supported">supported</a> by the current OS</li>
</ul>
<h1 id="example">Example</h1>
<div class="highlight"><pre><span></span><code><span class="kd">const</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">signalsByName</span><span class="p">,</span><span class="w"> </span><span class="nx">signalsByNumber</span><span class="w"> </span><span class="p">}</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;human-signals&#39;</span><span class="p">)</span>

<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">signalsByName</span><span class="p">.</span><span class="nx">SIGINT</span><span class="p">)</span>
<span class="c1">// {</span>
<span class="c1">//   name: &#39;SIGINT&#39;,</span>
<span class="c1">//   number: 2,</span>
<span class="c1">//   description: &#39;User interruption with CTRL-C&#39;,</span>
<span class="c1">//   supported: true,</span>
<span class="c1">//   action: &#39;terminate&#39;,</span>
<span class="c1">//   forced: false,</span>
<span class="c1">//   standard: &#39;ansi&#39;</span>
<span class="c1">// }</span>

<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">signalsByNumber</span><span class="p">[</span><span class="mf">8</span><span class="p">])</span>
<span class="c1">// {</span>
<span class="c1">//   name: &#39;SIGFPE&#39;,</span>
<span class="c1">//   number: 8,</span>
<span class="c1">//   description: &#39;Floating point arithmetic error&#39;,</span>
<span class="c1">//   supported: true,</span>
<span class="c1">//   action: &#39;core&#39;,</span>
<span class="c1">//   forced: false,</span>
<span class="c1">//   standard: &#39;ansi&#39;</span>
<span class="c1">// }</span>
</code></pre></div>
<h1 id="install">Install</h1>
<div class="highlight"><pre><span></span><code>npm<span class="w"> </span>install<span class="w"> </span>human-signals
</code></pre></div>
<h1 id="usage">Usage</h1>
<h2 id="signalsbyname">signalsByName</h2>
<p><em>Type</em>: <code>object</code></p>
<p>Object whose keys are signal <a href="#name">names</a> and values are
<a href="#signal">signal objects</a>.</p>
<h2 id="signalsbynumber">signalsByNumber</h2>
<p><em>Type</em>: <code>object</code></p>
<p>Object whose keys are signal <a href="#number">numbers</a> and values are
<a href="#signal">signal objects</a>.</p>
<h2 id="signal">signal</h2>
<p><em>Type</em>: <code>object</code></p>
<p>Signal object with the following properties.</p>
<h3 id="name">name</h3>
<p><em>Type</em>: <code>string</code></p>
<p>Standard name of the signal, for example <code>'SIGINT'</code>.</p>
<h3 id="number">number</h3>
<p><em>Type</em>: <code>number</code></p>
<p>Code number of the signal, for example <code>2</code>. While most <code>number</code> are
cross-platform, some are different between different OS.</p>
<h3 id="description">description</h3>
<p><em>Type</em>: <code>string</code></p>
<p>Human-friendly description for the signal, for example
<code>'User interruption with CTRL-C'</code>.</p>
<h3 id="supported">supported</h3>
<p><em>Type</em>: <code>boolean</code></p>
<p>Whether the current OS can handle this signal in Node.js using
<a href="https://nodejs.org/api/process.html#process_signal_events"><code>process.on(name, handler)</code></a>.</p>
<p>The list of supported signals
<a href="https://github.com/ehmicky/cross-platform-node-guide/blob/master/docs/6_networking_ipc/signals.md#cross-platform-signals">is OS-specific</a>.</p>
<h3 id="action">action</h3>
<p><em>Type</em>: <code>string</code>\
<em>Enum</em>: <code>'terminate'</code>, <code>'core'</code>, <code>'ignore'</code>, <code>'pause'</code>, <code>'unpause'</code></p>
<p>What is the default action for this signal when it is not handled.</p>
<h3 id="forced">forced</h3>
<p><em>Type</em>: <code>boolean</code></p>
<p>Whether the signal's default action cannot be prevented. This is <code>true</code> for
<code>SIGTERM</code>, <code>SIGKILL</code> and <code>SIGSTOP</code>.</p>
<h3 id="standard">standard</h3>
<p><em>Type</em>: <code>string</code>\
<em>Enum</em>: <code>'ansi'</code>, <code>'posix'</code>, <code>'bsd'</code>, <code>'systemv'</code>, <code>'other'</code></p>
<p>Which standard defined that signal.</p>
<h1 id="support">Support</h1>
<p>If you found a bug or would like a new feature, <em>don't hesitate</em> to
<a href="../../issues">submit an issue on GitHub</a>.</p>
<p>For other questions, feel free to
<a href="https://gitter.im/ehmicky/human-signals">chat with us on Gitter</a>.</p>
<p>Everyone is welcome regardless of personal background. We enforce a
<a href="CODE_OF_CONDUCT.md">Code of conduct</a> in order to promote a positive and
inclusive environment.</p>
<h1 id="contributing">Contributing</h1>
<p>This project was made with ❤️. The simplest way to give back is by starring and
sharing it online.</p>
<p>If the documentation is unclear or has a typo, please click on the page's <code>Edit</code>
button (pencil icon) and suggest a correction.</p>
<p>If you would like to help us fix a bug or add a new feature, please check our
<a href="CONTRIBUTING.md">guidelines</a>. Pull requests are welcome!</p>
<p>Thanks go to our wonderful contributors:</p>
