...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/parse-json/readme/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>parse-json - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="parse-json - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/parse-json/readme.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/parse-json/readme/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="parse-json - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/parse-json/readme.png" >
    ...
    <div data-md-component="skip">
        ...
        <a href="#parse-json" class="md-skip">
          Skip to content
        </a>
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#parsejsonstring-reviver-filename" class="md-nav__link">
    <span class="md-ellipsis">
      parseJson(string, reviver?, filename?)
    </span>
  </a>
  
    <nav class="md-nav" aria-label="parseJson(string, reviver?, filename?)">
      <ul class="md-nav__list">
  ...
  <a href="#filename" class="md-nav__link">
    <span class="md-ellipsis">
      filename
          ...
          <li class="md-nav__item">
  <a href="#parsejsonjsonerror" class="md-nav__link">
    <span class="md-ellipsis">
      parseJson.JSONError
    </span>
  </a>
  
    <nav class="md-nav" aria-label="parseJson.JSONError">
      <ul class="md-nav__list">
        
          <li class="md-nav__item">
  <a href="#filename_1" class="md-nav__link">
    <span class="md-ellipsis">
      fileName
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#codeframe" class="md-nav__link">
    <span class="md-ellipsis">
      codeFrame
    </span>
  </a>
...
<h1 id="parse-json">parse-json</h1>
<blockquote>
<p>Parse JSON with more helpful errors</p>
</blockquote>
<h2 id="install">Install</h2>
<div class="highlight"><pre><span></span><code>$ npm install parse-json
</code></pre></div>
<h2 id="usage">Usage</h2>
<div class="highlight"><pre><span></span><code><span class="kd">const</span><span class="w"> </span><span class="nx">parseJson</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;parse-json&#39;</span><span class="p">);</span>
...
<h2 id="api">API</h2>
<h3 id="parsejsonstring-reviver-filename">parseJson(string, reviver?, filename?)</h3>
...
<h3 id="parsejsonjsonerror">parseJson.JSONError</h3>
<p>Exposed for <code>instanceof</code> checking.</p>
<h4 id="filename_1">fileName</h4>
<p>Type: <code>string</code></p>
<p>The filename displayed in the error message.</p>
<h4 id="codeframe">codeFrame</h4>
<p>Type: <code>string</code></p>
