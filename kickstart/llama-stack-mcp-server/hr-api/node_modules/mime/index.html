...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/mime/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>mime - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="mime - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/mime/README.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/mime/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="mime - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/mime/README.png" >
...
<pre class="codehilite"><code>npm install mime
</code></pre>

<h2 id="contributing-testing">Contributing / Testing</h2>
<pre class="codehilite"><code>npm run test
</code></pre>

<h2 id="command-line">Command Line</h2>
<pre class="codehilite"><code>mime [path_string]
</code></pre>
...
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">mime</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;mime&#39;</span><span class="p">);</span>
...
<h3 id="mimedefault_type">mime.default_type</h3>
...
<div class="highlight"><pre><span></span><code><span class="nx">mime</span><span class="p">.</span><span class="nx">extension</span><span class="p">(</span><span class="s1">&#39;text/html&#39;</span><span class="p">);</span><span class="w">                 </span><span class="c1">// =&gt; &#39;html&#39;</span>
...
<h3 id="mimecharsetslookup">mime.charsets.lookup()</h3>
<p>Map mime-type to charset</p>
<div class="highlight"><pre><span></span><code><span class="nx">mime</span><span class="p">.</span><span class="nx">charsets</span><span class="p">.</span><span class="nx">lookup</span><span class="p">(</span><span class="s1">&#39;text/plain&#39;</span><span class="p">);</span><span class="w">        </span><span class="c1">// =&gt; &#39;UTF-8&#39;</span>
</code></pre></div>
<p>(The logic for charset lookups is pretty rudimentary.  Feel free to suggest improvements.)</p>
<h2 id="api-defining-custom-types">API - Defining Custom Types</h2>
<p>Custom type mappings can be added on a per-project basis via the following APIs.</p>
<h3 id="mimedefine">mime.define()</h3>
<p>Add custom mime/extension mappings</p>
<div class="highlight"><pre><span></span><code><span class="nx">mime</span><span class="p">.</span><span class="nx">define</span><span class="p">({</span>
...
<div class="highlight"><pre><span></span><code><span class="nx">mime</span><span class="p">.</span><span class="nx">extension</span><span class="p">(</span><span class="s1">&#39;text/x-some-format&#39;</span><span class="p">);</span><span class="w"> </span><span class="c1">// =&gt; &#39;x-sf&#39;</span>
</code></pre></div>
<h3 id="mimeloadfilepath">mime.load(filepath)</h3>
<p>Load mappings from an Apache ".types" format file</p>
<p><div class="highlight"><pre><span></span><code><span class="nx">mime</span><span class="p">.</span><span class="nx">load</span><span class="p">(</span><span class="s1">&#39;./my_project.types&#39;</span><span class="p">);</span>
</code></pre></div>
