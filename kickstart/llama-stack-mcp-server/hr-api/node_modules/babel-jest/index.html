...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/babel-jest/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>babel-jest - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="babel-jest - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/babel-jest/README.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/babel-jest/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="babel-jest - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/babel-jest/README.png" >
    ...
    <div data-md-component="skip">
        ...
        <a href="#babel-jest" class="md-skip">
          Skip to content
        </a>
...
<h1 id="babel-jest">babel-jest</h1>
<p><a href="https://github.com/babel/babel">Babel</a> <a href="https://github.com/jestjs/jest">jest</a> plugin</p>
<h2 id="usage">Usage</h2>
<p>If you are already using <code>jest-cli</code>, add <code>babel-jest</code> and it will automatically compile JavaScript code using Babel.</p>
<div class="highlight"><pre><span></span><code>yarn<span class="w"> </span>add<span class="w"> </span>--dev<span class="w"> </span>babel-jest<span class="w"> </span>@babel/core
</code></pre></div>
<p>If you would like to write your own preprocessor, uninstall and delete babel-jest and set the <a href="https://jestjs.io/docs/configuration#transform-object-string-string">config.transform</a> option to your preprocessor.</p>
<h2 id="setup">Setup</h2>
<p><em>Note: this step is only required if you are using <code>babel-jest</code> with additional code preprocessors.</em></p>
<p>To explicitly define <code>babel-jest</code> as a transformer for your JavaScript code, map <em>.js</em> files to the <code>babel-jest</code> module. Typescript files are also supported.</p>
<div class="highlight"><pre><span></span><code><span class="nt">&quot;transform&quot;</span><span class="p">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="nt">&quot;\\.[jt]sx?$&quot;</span><span class="p">:</span><span class="w"> </span><span class="s2">&quot;babel-jest&quot;</span>
<span class="p">},</span>
</code></pre></div>
