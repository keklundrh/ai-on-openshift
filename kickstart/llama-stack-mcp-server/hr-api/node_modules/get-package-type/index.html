...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/get-package-type/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>get-package-type NPM Version - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="get-package-type NPM Version - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/get-package-type/README.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/get-package-type/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="get-package-type NPM Version - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/get-package-type/README.png" >
    ...
    <div data-md-component="skip">
        ...
        <a href="#get-package-type" class="md-skip">
          Skip to content
        </a>
...
<h1 id="get-package-type">get-package-type <a href="https://npmjs.org/package/get-package-type"><img alt="NPM Version" src="https://img.shields.io/npm/v/get-package-type.svg" /></a></h1>
<p>Determine the <code>package.json#type</code> which applies to a location.</p>
<h2 id="usage">Usage</h2>
<div class="highlight"><pre><span></span><code><span class="kd">const</span><span class="w"> </span><span class="nx">getPackageType</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;get-package-type&#39;</span><span class="p">);</span>
...
<span class="w">  </span><span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="k">await</span><span class="w"> </span><span class="nx">getPackageType</span><span class="p">(</span><span class="s1">&#39;file.js&#39;</span><span class="p">));</span>
<span class="w">  </span><span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">getPackageType</span><span class="p">.</span><span class="nx">sync</span><span class="p">(</span><span class="s1">&#39;file.js&#39;</span><span class="p">));</span>
<span class="p">})();</span>
</code></pre></div>
<p>This function does not validate the value found in <code>package.json#type</code>.  Any truthy value
found will be returned.  Non-truthy values will be reported as <code>commonjs</code>.</p>
<p>The argument must be a filename.
<div class="highlight"><pre><span></span><code><span class="c1">// This never looks at `dir1/`, first attempts to load `./package.json`.</span>
<span class="kd">const</span><span class="w"> </span><span class="nx">type1</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="k">await</span><span class="w"> </span><span class="nx">getPackageType</span><span class="p">(</span><span class="s1">&#39;dir1/&#39;</span><span class="p">);</span>

<span class="c1">// This attempts to load `dir1/package.json`.</span>
<span class="kd">const</span><span class="w"> </span><span class="nx">type2</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="k">await</span><span class="w"> </span><span class="nx">getPackageType</span><span class="p">(</span><span class="s1">&#39;dir1/index.cjs&#39;</span><span class="p">);</span>
</code></pre></div></p>
<p>The extension of the filename does not effect the result.  The primary use case for this
module is to determine if <code>myapp.config.js</code> should be loaded with <code>require</code> or <code>import</code>.</p>
