...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/resolve-cwd/readme/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>resolve-cwd Build Status - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="resolve-cwd Build Status - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/resolve-cwd/readme.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/resolve-cwd/readme/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="resolve-cwd Build Status - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/resolve-cwd/readme.png" >
    ...
    <div data-md-component="skip">
        ...
        <a href="#resolve-cwd" class="md-skip">
          Skip to content
        </a>
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#resolvecwdmoduleid" class="md-nav__link">
    <span class="md-ellipsis">
      resolveCwd(moduleId)
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#resolvecwdsilentmoduleid" class="md-nav__link">
    <span class="md-ellipsis">
      resolveCwd.silent(moduleId)
    </span>
  </a>
  
    <nav class="md-nav" aria-label="resolveCwd.silent(moduleId)">
      <ul class="md-nav__list">
...
<h1 id="resolve-cwd">resolve-cwd <a href="https://travis-ci.org/sindresorhus/resolve-cwd"><img alt="Build Status" src="https://travis-ci.org/sindresorhus/resolve-cwd.svg?branch=master" /></a></h1>
<blockquote>
<p>Resolve the path of a module like <a href="https://nodejs.org/api/globals.html#globals_require_resolve"><code>require.resolve()</code></a> but from the current working directory</p>
</blockquote>
<h2 id="install">Install</h2>
<div class="highlight"><pre><span></span><code>$ npm install resolve-cwd
</code></pre></div>
<h2 id="usage">Usage</h2>
<div class="highlight"><pre><span></span><code><span class="kd">const</span><span class="w"> </span><span class="nx">resolveCwd</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;resolve-cwd&#39;</span><span class="p">);</span>
...
<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">resolveCwd</span><span class="p">(</span><span class="s1">&#39;./foo&#39;</span><span class="p">));</span>
<span class="c1">//=&gt; &#39;/Users/sindresorhus/unicorn/foo.js&#39;</span>
</code></pre></div>
<h2 id="api">API</h2>
<h3 id="resolvecwdmoduleid">resolveCwd(moduleId)</h3>
<p>Like <code>require()</code>, throws when the module can't be found.</p>
<h3 id="resolvecwdsilentmoduleid">resolveCwd.silent(moduleId)</h3>
