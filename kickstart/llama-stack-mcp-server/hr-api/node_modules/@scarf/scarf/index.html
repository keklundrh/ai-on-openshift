...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/%40scarf/scarf/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>scarf-js - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="scarf-js - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/@scarf/scarf/README.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/%40scarf/scarf/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="scarf-js - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/@scarf/scarf/README.png" >
  ...
  <a href="#configuring" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Configuring">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#full-configuration-example" class="md-nav__link">
    <span class="md-ellipsis">
  ...
  <a href="#faq" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="FAQ">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#what-information-does-scarf-js-provide-me-as-a-package-author" class="md-nav__link">
    <span class="md-ellipsis">
      What information does scarf-js provide me as a package author?
          ...
          <li class="md-nav__item">
  <a href="#as-a-user-of-a-package-using-scarf-js-what-information-does-scarf-js-send-about-me" class="md-nav__link">
    <span class="md-ellipsis">
      As a user of a package using scarf-js, what information does scarf-js send about me?
          ...
          <li class="md-nav__item">
  <a href="#as-a-user-of-a-package-using-scarf-js-how-can-i-opt-out-of-analytics" class="md-nav__link">
    <span class="md-ellipsis">
      As a user of a package using scarf-js, how can I opt out of analytics?
          ...
          <li class="md-nav__item">
  <a href="#i-distribute-a-package-on-npm-and-scarf-js-is-in-our-dependency-tree-can-i-disable-the-analytics-for-my-downstream-dependents" class="md-nav__link">
    <span class="md-ellipsis">
...
<h1 id="scarf-js">scarf-js</h1>
<p><img alt="" src="https://github.com/scarf-sh/scarf-js/workflows/CI/badge.svg" />
<a href="https://badge.fury.io/js/%40scarf%2Fscarf"><img alt="npm version" src="https://badge.fury.io/js/%40scarf%2Fscarf.svg" /></a>
<a href="https://www.npmjs.com/package/@scarf/scarf"><img alt="" src="https://img.shields.io/npm/dw/@scarf/scarf" /></a>
...
<p>Scarf is like Google Analytics for your npm packages. By sending some basic
...
fund their work when it is used commercially.</p>
<p>To read more about why we wrote this library, check out <a href="https://github.com/scarf-sh/scarf-js/blob/master/WHY.org">this post</a> on the topic.</p>
<h3 id="features">Features</h3>
<ul>
<li>No dependencies.</li>
<li>Fully transparent to the user. Scarf will log its behavior to the console
  during installation. It will never silently report analytics for someone that
  hasn't explictly given permission to do so.</li>
<li>Never interrupts your package installation. Reporting is done on a best effort basis.</li>
</ul>
<h3 id="installing">Installing</h3>
<p>You'll first need to create a library entry on <a href="https://scarf.sh">Scarf</a>. Once
created, add a dependency on this library to your own:</p>
<div class="highlight"><pre><span></span><code>npm<span class="w"> </span>i<span class="w"> </span>--save<span class="w"> </span>@scarf/scarf
</code></pre></div>
...
<code>SCARF_ANALYTICS=false</code> environment variable. If you'd like Scarf analytics to
instead be opt-in, you can set this by adding an entry to your <code>package.json</code></p>
<div class="highlight"><pre><span></span><code><span class="c1">// your-package/package.json</span>

<span class="p">{</span>
<span class="w">  </span><span class="c1">// ...</span>
<span class="w">  </span><span class="nv">&quot;scarfSettings&quot;</span><span class="p">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="nv">&quot;defaultOptIn&quot;</span><span class="p">:</span><span class="w"> </span><span class="k">false</span>
...
<span class="w">  </span><span class="c1">// ...</span>
<span class="w">  </span><span class="nv">&quot;scarfSettings&quot;</span><span class="p">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="nv">&quot;allowTopLevel&quot;</span><span class="p">:</span><span class="w"> </span><span class="k">true</span>
<span class="w">  </span><span class="p">}</span>
<span class="w">  </span><span class="c1">// ...</span>
<span class="p">}</span>
</code></pre></div>
<h4 id="full-configuration-example">Full Configuration Example</h4>
<div class="highlight"><pre><span></span><code><span class="c1">// your-package/package.json</span>

<span class="p">{</span>
<span class="w">  </span><span class="c1">// ...</span>
<span class="w">  </span><span class="nv">&quot;scarfSettings&quot;</span><span class="p">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="c1">// Toggles whether Scarf is enabled for this package</span>
<span class="w">    </span><span class="nv">&quot;enabled&quot;</span><span class="p">:</span><span class="w"> </span><span class="k">true</span><span class="p">,</span>
<span class="w">    </span><span class="c1">// Enables Scarf when users run npm install directly in your repository</span>
<span class="w">    </span><span class="c1">// Scarf will try to report the Git commit SHA of your repository if it can</span>
<span class="w">    </span><span class="c1">// be obtained.</span>
<span class="w">    </span><span class="nv">&quot;allowTopLevel&quot;</span><span class="p">:</span><span class="w"> </span><span class="k">true</span><span class="p">,</span>
<span class="w">    </span><span class="c1">// Users will be opted into analytics by default</span>
<span class="w">    </span><span class="nv">&quot;defaultOptIn&quot;</span><span class="p">:</span><span class="w"> </span><span class="k">true</span><span class="p">,</span>
<span class="w">    </span><span class="c1">// By default, Scarf searches for its own location in your build&#39;s dependency</span>
<span class="w">    </span><span class="c1">// graph to ensure reporting can be done for all packages using Scarf.</span>
<span class="w">    </span><span class="c1">// For large projects with lots of dependencies, generating that dependency</span>
<span class="w">    </span><span class="c1">// graph takes more time than Scarf allots for its entire process, so Scarf</span>
<span class="w">    </span><span class="c1">// will always time out. `skipTraversal` is an optional flag for large</span>
<span class="w">    </span><span class="c1">// applications to skip that traversal entirely. Use this flag with caution and</span>
<span class="w">    </span><span class="c1">// care, as it will break Scarf analytics for all other packages you depend</span>
<span class="w">    </span><span class="c1">// on in your build.</span>
<span class="w">    </span><span class="nv">&quot;skipTraversal&quot;</span><span class="p">:</span><span class="w"> </span><span class="k">false</span>
<span class="w">  </span><span class="p">}</span>
<span class="w">  </span><span class="c1">// ...</span>
<span class="p">}</span>
</code></pre></div>
...
<h4 id="as-a-user-of-a-package-using-scarf-js-what-information-does-scarf-js-send-about-me">As a user of a package using scarf-js, what information does scarf-js send about me?</h4>
<p><em>Scarf does not store personally identifying information.</em> Scarf aims to collect information that is helpful for:
- Open Source package maintainence
- Open Source commercialization</p>
...
This allows Scarf to provide information for maintainers about which public packages are using their own, without exposing identifying details of non-public packages.</li>
</ul>
<p>You can have scarf-js print the exact JSON payload it sends by setting <code>SCARF_VERBOSE=true</code> in your environment.</p>
...
<span class="w">  </span><span class="c1">// ...</span>
<span class="w">  </span><span class="nv">&quot;scarfSettings&quot;</span><span class="p">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="nv">&quot;enabled&quot;</span><span class="p">:</span><span class="w"> </span><span class="k">false</span>
<span class="w">  </span><span class="p">}</span>
<span class="w">  </span><span class="c1">// ...</span>
<span class="p">}</span>
</code></pre></div>
<p>Alternatively, you can set this variable in your environment:</p>
<div class="highlight"><pre><span></span><code><span class="nb">export</span><span class="w"> </span><span class="nv">SCARF_ANALYTICS</span><span class="o">=</span><span class="nb">false</span>
</code></pre></div>
<p>You can also set this variable in accordance to the <a href="https://consoledonottrack.com/">Console Do Not Track</a> standard: 
<div class="highlight"><pre><span></span><code><span class="nb">export</span><span class="w"> </span><span class="nv">DO_NOT_TRACK</span><span class="o">=</span><span class="m">1</span>
</code></pre></div></p>
...
<p>Future releases of scarf-js will provide a module of utility functions to
collect usage analytics in addition to the current installation analytics.</p>
<h3 id="community">Community</h3>
<p>Join the <a href="https://tinyurl.com/scarf-community-slack">Scarf-Community workspace</a> on Slack and find us in the #scarf-js channel. We'll keep an eye out for your questions and concerns. </p>
