...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/is-stream/readme/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>is-stream - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="is-stream - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/is-stream/readme.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/is-stream/readme/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="is-stream - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/is-stream/readme.png" >
    ...
    <div data-md-component="skip">
        ...
        <a href="#is-stream" class="md-skip">
          Skip to content
        </a>
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#isstreamstream" class="md-nav__link">
    <span class="md-ellipsis">
      isStream(stream)
    </span>
  </a>
  
    <nav class="md-nav" aria-label="isStream(stream)">
      <ul class="md-nav__list">
        
          <li class="md-nav__item">
  <a href="#isstreamwritablestream" class="md-nav__link">
    <span class="md-ellipsis">
      isStream.writable(stream)
          ...
          <li class="md-nav__item">
  <a href="#isstreamreadablestream" class="md-nav__link">
    <span class="md-ellipsis">
      isStream.readable(stream)
          ...
          <li class="md-nav__item">
  <a href="#isstreamduplexstream" class="md-nav__link">
    <span class="md-ellipsis">
      isStream.duplex(stream)
          ...
          <li class="md-nav__item">
  <a href="#isstreamtransformstream" class="md-nav__link">
    <span class="md-ellipsis">
...
<h1 id="is-stream">is-stream</h1>
<blockquote>
<p>Check if something is a <a href="https://nodejs.org/api/stream.html">Node.js stream</a></p>
</blockquote>
<h2 id="install">Install</h2>
<div class="highlight"><pre><span></span><code>$ npm install is-stream
</code></pre></div>
...
<span class="kd">const</span><span class="w"> </span><span class="nx">isStream</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;is-stream&#39;</span><span class="p">);</span>
...
<h2 id="api">API</h2>
<h3 id="isstreamstream">isStream(stream)</h3>
<p>Returns a <code>boolean</code> for whether it's a <a href="https://nodejs.org/api/stream.html#stream_stream"><code>Stream</code></a>.</p>
<h4 id="isstreamwritablestream">isStream.writable(stream)</h4>
<p>Returns a <code>boolean</code> for whether it's a <a href="https://nodejs.org/api/stream.html#stream_class_stream_writable"><code>stream.Writable</code></a>.</p>
<h4 id="isstreamreadablestream">isStream.readable(stream)</h4>
<p>Returns a <code>boolean</code> for whether it's a <a href="https://nodejs.org/api/stream.html#stream_class_stream_readable"><code>stream.Readable</code></a>.</p>
<h4 id="isstreamduplexstream">isStream.duplex(stream)</h4>
<p>Returns a <code>boolean</code> for whether it's a <a href="https://nodejs.org/api/stream.html#stream_class_stream_duplex"><code>stream.Duplex</code></a>.</p>
<h4 id="isstreamtransformstream">isStream.transform(stream)</h4>
<p>Returns a <code>boolean</code> for whether it's a <a href="https://nodejs.org/api/stream.html#stream_class_stream_transform"><code>stream.Transform</code></a>.</p>
<h2 id="related">Related</h2>
<ul>
<li><a href="https://github.com/jamestalmage/is-file-stream">is-file-stream</a> - Detect if a stream is a file stream</li>
</ul>
<hr />
<div align="center">
    <b>
