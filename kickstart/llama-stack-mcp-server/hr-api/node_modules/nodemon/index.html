...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/nodemon/">
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/nodemon/README.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/nodemon/" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/nodemon/README.png" >
...
<p><a href="https://npmjs.org/package/nodemon"><img alt="NPM version" src="https://badge.fury.io/js/nodemon.svg" /></a>
<a href="#backers"><img alt="Backers on Open Collective" src="https://opencollective.com/nodemon/backers/badge.svg" /></a> <a href="#sponsors"><img alt="Sponsors on Open Collective" src="https://opencollective.com/nodemon/sponsors/badge.svg" /></a></p>
<h1 id="installation">Installation</h1>
<p>Either through cloning with git or by using <a href="http://npmjs.org">npm</a> (the recommended way):</p>
<div class="highlight"><pre><span></span><code>npm<span class="w"> </span>install<span class="w"> </span>-g<span class="w"> </span>nodemon<span class="w"> </span><span class="c1"># or using yarn: yarn global add nodemon</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code>npm<span class="w"> </span>install<span class="w"> </span>--save-dev<span class="w"> </span>nodemon<span class="w"> </span><span class="c1"># or using yarn: yarn add nodemon -D</span>
</code></pre></div>
<p>With a local installation, nodemon will not be available in your system path or you can't use it directly from the command line. Instead, the local installation of nodemon can be run by calling it from within an npm script (such as <code>npm start</code>) or using <code>npx nodemon</code>.</p>
<h1 id="usage">Usage</h1>
<p>nodemon wraps your application, so you can pass all the arguments you would normally pass to your app:</p>
<div class="highlight"><pre><span></span><code>nodemon<span class="w"> </span><span class="o">[</span>your<span class="w"> </span>node<span class="w"> </span>app<span class="o">]</span>
</code></pre></div>
<p>For CLI options, use the <code>-h</code> (or <code>--help</code>) argument:</p>
<div class="highlight"><pre><span></span><code>nodemon<span class="w"> </span>-h
</code></pre></div>
<p>Using nodemon is simple, if my application accepted a host and port as the arguments, I would start it as so:</p>
<div class="highlight"><pre><span></span><code>nodemon<span class="w"> </span>./server.js<span class="w"> </span>localhost<span class="w"> </span><span class="m">8080</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code>nodemon<span class="w"> </span>--inspect<span class="w"> </span>./server.js<span class="w"> </span><span class="m">80</span>
</code></pre></div>
<p>If you have a <code>package.json</code> file for your app, you can omit the main script entirely and nodemon will read the <code>package.json</code> for the <code>main</code> property and use that value as the app (<a href="https://github.com/remy/nodemon/issues/14">ref</a>).</p>
...
<h2 id="automatic-re-running">Automatic re-running</h2>
...
<h2 id="manual-restarting">Manual restarting</h2>
<p>Whilst nodemon is running, if you need to manually restart your application, instead of stopping and restart nodemon, you can type <code>rs</code> with a carriage return, and nodemon will restart your process.</p>
...
<span class="w">  </span><span class="nt">&quot;ignore&quot;</span><span class="p">:</span><span class="w"> </span><span class="p">[</span><span class="s2">&quot;*.test.js&quot;</span><span class="p">,</span><span class="w"> </span><span class="s2">&quot;**/fixtures/**&quot;</span><span class="p">],</span>
<span class="w">  </span><span class="nt">&quot;execMap&quot;</span><span class="p">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="nt">&quot;rb&quot;</span><span class="p">:</span><span class="w"> </span><span class="s2">&quot;ruby&quot;</span><span class="p">,</span>
<span class="w">    </span><span class="nt">&quot;pde&quot;</span><span class="p">:</span><span class="w"> </span><span class="s2">&quot;processing --sketch={{pwd}} --run&quot;</span>
<span class="w">  </span><span class="p">}</span>
<span class="p">}</span>
</code></pre></div>
<p>The above <code>nodemon.json</code> file might be my global config so that I have support for ruby files and processing files, and I can run <code>nodemon demo.pde</code> and nodemon will automatically know how to run the script even though out of the box support for processing scripts.</p>
...
<div class="highlight"><pre><span></span><code><span class="p">{</span>
<span class="w">  </span><span class="nt">&quot;name&quot;</span><span class="p">:</span><span class="w"> </span><span class="s2">&quot;nodemon&quot;</span><span class="p">,</span>
<span class="w">  </span><span class="nt">&quot;homepage&quot;</span><span class="p">:</span><span class="w"> </span><span class="s2">&quot;http://nodemon.io&quot;</span><span class="p">,</span>
<span class="w">  </span><span class="nt">&quot;...&quot;</span><span class="p">:</span><span class="w"> </span><span class="s2">&quot;... other standard package.json values&quot;</span><span class="p">,</span>
<span class="w">  </span><span class="nt">&quot;nodemonConfig&quot;</span><span class="p">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="nt">&quot;ignore&quot;</span><span class="p">:</span><span class="w"> </span><span class="p">[</span><span class="s2">&quot;**/test/**&quot;</span><span class="p">,</span><span class="w"> </span><span class="s2">&quot;**/docs/**&quot;</span><span class="p">],</span>
<span class="w">    </span><span class="nt">&quot;delay&quot;</span><span class="p">:</span><span class="w"> </span><span class="mi">2500</span>
<span class="w">  </span><span class="p">}</span>
<span class="p">}</span>
</code></pre></div>
...
<h2 id="using-nodemon-as-a-module">Using nodemon as a module</h2>
<p>Please see <a href="doc/requireable.md">doc/requireable.md</a></p>
<h2 id="using-nodemon-as-child-process">Using nodemon as child process</h2>
<p>Please see <a href="doc/events.md#Using_nodemon_as_child_process">doc/events.md</a></p>
<h2 id="running-non-node-scripts">Running non-node scripts</h2>
<p>nodemon can also be used to execute and monitor other programs. nodemon will read the file extension of the script being run and monitor that extension instead of <code>.js</code> if there's no <code>nodemon.json</code>:</p>
<div class="highlight"><pre><span></span><code>nodemon<span class="w"> </span>--exec<span class="w"> </span><span class="s2">&quot;python -v&quot;</span><span class="w"> </span>./app.py
</code></pre></div>
...
<h3 id="default-executables">Default executables</h3>
...
<p>To add support for nodemon to know about the <code>.pl</code> extension (for Perl), the <code>nodemon.json</code> file would add:</p>
<div class="highlight"><pre><span></span><code><span class="p">{</span>
<span class="w">  </span><span class="nt">&quot;execMap&quot;</span><span class="p">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="nt">&quot;pl&quot;</span><span class="p">:</span><span class="w"> </span><span class="s2">&quot;perl&quot;</span>
<span class="w">  </span><span class="p">}</span>
<span class="p">}</span>
</code></pre></div>
<p>Now running the following, nodemon will know to use <code>perl</code> as the executable:</p>
<div class="highlight"><pre><span></span><code>nodemon<span class="w"> </span>script.pl
</code></pre></div>
...
<h2 id="monitoring-multiple-directories">Monitoring multiple directories</h2>
...
<div class="highlight"><pre><span></span><code>nodemon<span class="w"> </span>--watch<span class="w"> </span>app<span class="w"> </span>--watch<span class="w"> </span>libs<span class="w"> </span>app/server.js
</code></pre></div>
...
<div class="highlight"><pre><span></span><code>nodemon<span class="w"> </span>-e<span class="w"> </span>js,pug
</code></pre></div>
<p>Now nodemon will restart on any changes to files in the directory (or subdirectories) with the extensions <code>.js</code>, <code>.pug</code>.</p>
...
<div class="highlight"><pre><span></span><code>nodemon<span class="w"> </span>--ignore<span class="w"> </span>lib/<span class="w"> </span>--ignore<span class="w"> </span>tests/
</code></pre></div>
<p>Or specific files can be ignored:</p>
<div class="highlight"><pre><span></span><code>nodemon<span class="w"> </span>--ignore<span class="w"> </span>lib/app.js
</code></pre></div>
<p>Patterns can also be ignored (but be sure to quote the arguments):</p>
<div class="highlight"><pre><span></span><code>nodemon<span class="w"> </span>--ignore<span class="w"> </span><span class="s1">&#39;lib/*.js&#39;</span>
</code></pre></div>
<p><strong>Important</strong> the ignore rules are patterns matched to the full absolute path, and this determines how many files are monitored. If using a wild card glob pattern, it needs to be used as <code>**</code> or omitted entirely. For example, <code>nodemon --ignore '**/test/**'</code> will work, whereas <code>--ignore '*/test/*'</code> will not.</p>
...
<h2 id="application-isnt-restarting">Application isn't restarting</h2>
...
<div class="highlight"><pre><span></span><code>nodemon<span class="w"> </span>-L
</code></pre></div>
<p>Though this should be a last resort as it will poll every file it can find.</p>
<h2 id="delaying-restarting">Delaying restarting</h2>
...
<div class="highlight"><pre><span></span><code>nodemon<span class="w"> </span>--delay<span class="w"> </span><span class="m">10</span><span class="w"> </span>server.js
</code></pre></div>
<p>For more precision, milliseconds can be specified.  Either as a float:</p>
<div class="highlight"><pre><span></span><code>nodemon<span class="w"> </span>--delay<span class="w"> </span><span class="m">2</span>.5<span class="w"> </span>server.js
</code></pre></div>
<p>Or using the time specifier (ms):</p>
<div class="highlight"><pre><span></span><code>nodemon<span class="w"> </span>--delay<span class="w"> </span>2500ms<span class="w"> </span>server.js
</code></pre></div>
...
<p>If you are setting this value in <code>nodemon.json</code>, the value will always be interpreted in milliseconds. E.g., the following are equivalent:</p>
<div class="highlight"><pre><span></span><code>nodemon<span class="w"> </span>--delay<span class="w"> </span><span class="m">2</span>.5

<span class="o">{</span>
<span class="w">  </span><span class="s2">&quot;delay&quot;</span>:<span class="w"> </span><span class="m">2500</span>
<span class="o">}</span>
</code></pre></div>
<h2 id="gracefully-reloading-down-your-script">Gracefully reloading down your script</h2>
<p>It is possible to have nodemon send any signal that you specify to your application.</p>
<div class="highlight"><pre><span></span><code>nodemon<span class="w"> </span>--signal<span class="w"> </span>SIGHUP<span class="w"> </span>server.js
</code></pre></div>
<p>Your application can handle the signal as follows.</p>
<div class="highlight"><pre><span></span><code><span class="nx">process</span><span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="s2">&quot;SIGHUP&quot;</span><span class="p">,</span><span class="w"> </span><span class="kd">function</span><span class="w"> </span><span class="p">()</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="nx">reloadSomeConfiguration</span><span class="p">();</span>
<span class="w">  </span><span class="nx">process</span><span class="p">.</span><span class="nx">kill</span><span class="p">(</span><span class="nx">process</span><span class="p">.</span><span class="nx">pid</span><span class="p">,</span><span class="w"> </span><span class="s2">&quot;SIGTERM&quot;</span><span class="p">);</span>
<span class="p">})</span>
</code></pre></div>
<p>Please note that nodemon will send this signal to every process in the process tree.</p>
<p>If you are using <code>cluster</code>, then each workers (as well as the master) will receive the signal. If you wish to terminate all workers on receiving a <code>SIGHUP</code>, a common pattern is to catch the <code>SIGHUP</code> in the master, and forward <code>SIGTERM</code> to all workers, while ensuring that all workers ignore <code>SIGHUP</code>.</p>
<div class="highlight"><pre><span></span><code><span class="k">if</span><span class="w"> </span><span class="p">(</span><span class="nx">cluster</span><span class="p">.</span><span class="nx">isMaster</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="nx">process</span><span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="s2">&quot;SIGHUP&quot;</span><span class="p">,</span><span class="w"> </span><span class="kd">function</span><span class="w"> </span><span class="p">()</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="k">for</span><span class="w"> </span><span class="p">(</span><span class="kd">const</span><span class="w"> </span><span class="nx">worker</span><span class="w"> </span><span class="k">of</span><span class="w"> </span><span class="nb">Object</span><span class="p">.</span><span class="nx">values</span><span class="p">(</span><span class="nx">cluster</span><span class="p">.</span><span class="nx">workers</span><span class="p">))</span><span class="w"> </span><span class="p">{</span>
<span class="w">      </span><span class="nx">worker</span><span class="p">.</span><span class="nx">process</span><span class="p">.</span><span class="nx">kill</span><span class="p">(</span><span class="s2">&quot;SIGTERM&quot;</span><span class="p">);</span>
<span class="w">    </span><span class="p">}</span>
<span class="w">  </span><span class="p">});</span>
<span class="p">}</span><span class="w"> </span><span class="k">else</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="nx">process</span><span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="s2">&quot;SIGHUP&quot;</span><span class="p">,</span><span class="w"> </span><span class="kd">function</span><span class="p">()</span><span class="w"> </span><span class="p">{})</span>
<span class="p">}</span>
</code></pre></div>
<h2 id="controlling-shutdown-of-your-script">Controlling shutdown of your script</h2>
...
<div class="highlight"><pre><span></span><code><span class="c1">// important to use `on` and not `once` as nodemon can re-send the kill signal</span>
<span class="nx">process</span><span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="s1">&#39;SIGUSR2&#39;</span><span class="p">,</span><span class="w"> </span><span class="kd">function</span><span class="w"> </span><span class="p">()</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="nx">gracefulShutdown</span><span class="p">(</span><span class="kd">function</span><span class="w"> </span><span class="p">()</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="nx">process</span><span class="p">.</span><span class="nx">kill</span><span class="p">(</span><span class="nx">process</span><span class="p">.</span><span class="nx">pid</span><span class="p">,</span><span class="w"> </span><span class="s1">&#39;SIGTERM&#39;</span><span class="p">);</span>
<span class="w">  </span><span class="p">});</span>
<span class="p">});</span>
</code></pre></div>
...
<h2 id="triggering-events-when-nodemon-state-changes">Triggering events when nodemon state changes</h2>
<p>If you want growl like notifications when nodemon restarts or to trigger an action when an event happens, then you can either <code>require</code> nodemon or add event actions to your <code>nodemon.json</code> file.</p>
...
<span class="w">    </span><span class="nt">&quot;restart&quot;</span><span class="p">:</span><span class="w"> </span><span class="s2">&quot;osascript -e &#39;display notification \&quot;app restarted\&quot; with title \&quot;nodemon\&quot;&#39;&quot;</span>
<span class="w">  </span><span class="p">}</span>
<span class="p">}</span>
</code></pre></div>
...
<h2 id="pipe-output-to-somewhere-else">Pipe output to somewhere else</h2>
<div class="highlight"><pre><span></span><code><span class="nx">nodemon</span><span class="p">({</span>
<span class="w">  </span><span class="nx">script</span><span class="o">:</span><span class="w"> </span><span class="p">...,</span>
<span class="w">  </span><span class="nx">stdout</span><span class="o">:</span><span class="w"> </span><span class="kc">false</span><span class="w"> </span><span class="c1">// important: this tells nodemon not to output to console</span>
<span class="p">}).</span><span class="nx">on</span><span class="p">(</span><span class="s1">&#39;readable&#39;</span><span class="p">,</span><span class="w"> </span><span class="kd">function</span><span class="p">()</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="c1">// the `readable` event indicates that data is ready to pick up</span>
<span class="w">  </span><span class="k">this</span><span class="p">.</span><span class="nx">stdout</span><span class="p">.</span><span class="nx">pipe</span><span class="p">(</span><span class="nx">fs</span><span class="p">.</span><span class="nx">createWriteStream</span><span class="p">(</span><span class="s1">&#39;output.txt&#39;</span><span class="p">));</span>
<span class="w">  </span><span class="k">this</span><span class="p">.</span><span class="nx">stderr</span><span class="p">.</span><span class="nx">pipe</span><span class="p">(</span><span class="nx">fs</span><span class="p">.</span><span class="nx">createWriteStream</span><span class="p">(</span><span class="s1">&#39;err.txt&#39;</span><span class="p">));</span>
<span class="p">});</span>
</code></pre></div>
<h2 id="using-nodemon-in-your-gulp-workflow">Using nodemon in your gulp workflow</h2>
...
<h2 id="using-nodemon-in-your-grunt-workflow">Using nodemon in your Grunt workflow</h2>
...
<p><a href="https://opencollective.com/nodemon#backers"><img alt="nodemon backers" src="https://opencollective.com/nodemon/backers.svg?width=890" /></a></p>
...
<p>Please note that links to the sponsors above are not direct endorsements nor affiliated with any of contributors of the nodemon project.</p>
