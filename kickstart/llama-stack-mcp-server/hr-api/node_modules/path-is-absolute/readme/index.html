...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/path-is-absolute/readme/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>path-is-absolute Build Status - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="path-is-absolute Build Status - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/path-is-absolute/readme.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/path-is-absolute/readme/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="path-is-absolute Build Status - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/path-is-absolute/readme.png" >
    ...
    <div data-md-component="skip">
        ...
        <a href="#path-is-absolute" class="md-skip">
          Skip to content
        </a>
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#pathisabsolutepath" class="md-nav__link">
    <span class="md-ellipsis">
      pathIsAbsolute(path)
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#pathisabsoluteposixpath" class="md-nav__link">
    <span class="md-ellipsis">
      pathIsAbsolute.posix(path)
          ...
          <li class="md-nav__item">
  <a href="#pathisabsolutewin32path" class="md-nav__link">
    <span class="md-ellipsis">
...
<h1 id="path-is-absolute">path-is-absolute <a href="https://travis-ci.org/sindresorhus/path-is-absolute"><img alt="Build Status" src="https://travis-ci.org/sindresorhus/path-is-absolute.svg?branch=master" /></a></h1>
<blockquote>
...
<div class="highlight"><pre><span></span><code>$ npm install --save path-is-absolute
</code></pre></div>
<h2 id="usage">Usage</h2>
<div class="highlight"><pre><span></span><code><span class="kd">const</span><span class="w"> </span><span class="nx">pathIsAbsolute</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;path-is-absolute&#39;</span><span class="p">);</span>
...
<h3 id="pathisabsoluteposixpath">pathIsAbsolute.posix(path)</h3>
<p>POSIX specific version.</p>
<h3 id="pathisabsolutewin32path">pathIsAbsolute.win32(path)</h3>
