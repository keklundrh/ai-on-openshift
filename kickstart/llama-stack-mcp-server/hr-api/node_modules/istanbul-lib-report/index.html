...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/istanbul-lib-report/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>istanbul-lib-report - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="istanbul-lib-report - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/istanbul-lib-report/README.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/istanbul-lib-report/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="istanbul-lib-report - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/istanbul-lib-report/README.png" >
    ...
    <div data-md-component="skip">
        ...
        <a href="#istanbul-lib-report" class="md-skip">
          Skip to content
        </a>
...
<h1 id="istanbul-lib-report">istanbul-lib-report</h1>
<p><a href="https://greenkeeper.io/"><img alt="Greenkeeper badge" src="https://badges.greenkeeper.io/istanbuljs/istanbul-lib-report.svg" /></a>
<a href="https://travis-ci.org/istanbuljs/istanbul-lib-report"><img alt="Build Status" src="https://travis-ci.org/istanbuljs/istanbul-lib-report.svg?branch=master" /></a></p>
<p>Core reporting utilities for istanbul.</p>
<h2 id="example-usage">Example usage</h2>
<div class="highlight"><pre><span></span><code><span class="kd">const</span><span class="w"> </span><span class="nx">libReport</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;istanbul-lib-report&#39;</span><span class="p">);</span>
<span class="kd">const</span><span class="w"> </span><span class="nx">reports</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;istanbul-reports&#39;</span><span class="p">);</span>

<span class="c1">// coverageMap, for instance, obtained from istanbul-lib-coverage</span>
<span class="kd">const</span><span class="w"> </span><span class="nx">coverageMap</span><span class="p">;</span>

<span class="kd">const</span><span class="w"> </span><span class="nx">configWatermarks</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="nx">statements</span><span class="o">:</span><span class="w"> </span><span class="p">[</span><span class="mf">50</span><span class="p">,</span><span class="w"> </span><span class="mf">80</span><span class="p">],</span>
<span class="w">  </span><span class="nx">functions</span><span class="o">:</span><span class="w"> </span><span class="p">[</span><span class="mf">50</span><span class="p">,</span><span class="w"> </span><span class="mf">80</span><span class="p">],</span>
<span class="w">  </span><span class="nx">branches</span><span class="o">:</span><span class="w"> </span><span class="p">[</span><span class="mf">50</span><span class="p">,</span><span class="w"> </span><span class="mf">80</span><span class="p">],</span>
<span class="w">  </span><span class="nx">lines</span><span class="o">:</span><span class="w"> </span><span class="p">[</span><span class="mf">50</span><span class="p">,</span><span class="w"> </span><span class="mf">80</span><span class="p">]</span>
<span class="p">};</span>

<span class="c1">// create a context for report generation</span>
<span class="kd">const</span><span class="w"> </span><span class="nx">context</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">libReport</span><span class="p">.</span><span class="nx">createContext</span><span class="p">({</span>
<span class="w">  </span><span class="nx">dir</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;report/output/dir&#39;</span><span class="p">,</span>
<span class="w">  </span><span class="c1">// The summarizer to default to (may be overridden by some reports)</span>
<span class="w">  </span><span class="c1">// values can be nested/flat/pkg. Defaults to &#39;pkg&#39;</span>
<span class="w">  </span><span class="nx">defaultSummarizer</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;nested&#39;</span><span class="p">,</span>
<span class="w">  </span><span class="nx">watermarks</span><span class="o">:</span><span class="w"> </span><span class="nx">configWatermarks</span><span class="p">,</span>
<span class="w">  </span><span class="nx">coverageMap</span><span class="p">,</span>
<span class="p">})</span>

<span class="c1">// create an instance of the relevant report class, passing the</span>
<span class="c1">// report name e.g. json/html/html-spa/text</span>
<span class="kd">const</span><span class="w"> </span><span class="nx">report</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">reports</span><span class="p">.</span><span class="nx">create</span><span class="p">(</span><span class="s1">&#39;json&#39;</span><span class="p">,</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="nx">skipEmpty</span><span class="o">:</span><span class="w"> </span><span class="nx">configSkipEmpty</span><span class="p">,</span>
<span class="w">  </span><span class="nx">skipFull</span><span class="o">:</span><span class="w"> </span><span class="nx">configSkipFull</span>
<span class="p">})</span>

<span class="c1">// call execute to synchronously create and write the report to disk</span>
<span class="nx">report</span><span class="p">.</span><span class="nx">execute</span><span class="p">(</span><span class="nx">context</span><span class="p">)</span>
</code></pre></div>
