...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/lodash.mergewith/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>lodash.mergewith v4.6.2 - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="lodash.mergewith v4.6.2 - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/lodash.mergewith/README.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/lodash.mergewith/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="lodash.mergewith v4.6.2 - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/lodash.mergewith/README.png" >
    ...
    <div data-md-component="skip">
        ...
        <a href="#lodashmergewith-v462" class="md-skip">
          Skip to content
        </a>
...
<h1 id="lodashmergewith-v462">lodash.mergewith v4.6.2</h1>
<p>The <a href="https://lodash.com/">Lodash</a> method <code>_.mergeWith</code> exported as a <a href="https://nodejs.org/">Node.js</a> module.</p>
<h2 id="installation">Installation</h2>
<p>Using npm:
<div class="highlight"><pre><span></span><code>$<span class="w"> </span><span class="o">{</span>sudo<span class="w"> </span>-H<span class="o">}</span><span class="w"> </span>npm<span class="w"> </span>i<span class="w"> </span>-g<span class="w"> </span>npm
$<span class="w"> </span>npm<span class="w"> </span>i<span class="w"> </span>--save<span class="w"> </span>lodash.mergewith
</code></pre></div></p>
<p>In Node.js:
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">mergeWith</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;lodash.mergewith&#39;</span><span class="p">);</span>
</code></pre></div></p>
<p>See the <a href="https://lodash.com/docs#mergeWith">documentation</a> or <a href="https://github.com/lodash/lodash/blob/4.6.2-npm-packages/lodash.mergewith">package source</a> for more details.</p>
