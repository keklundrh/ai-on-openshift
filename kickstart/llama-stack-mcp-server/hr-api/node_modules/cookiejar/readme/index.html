...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/cookiejar/readme/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>CookieJar - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="CookieJar - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/cookiejar/readme.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/cookiejar/readme/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="CookieJar - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/cookiejar/readme.png" >
    ...
    <div data-md-component="skip">
        ...
        <a href="#cookiejar" class="md-skip">
          Skip to content
        </a>
...
<nav class="md-nav md-nav--secondary" aria-label="Table of contents">
  ...
  <a href="#exports" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Exports">
      <ul class="md-nav__list">
        
          <li class="md-nav__item">
  <a href="#cookieaccessinfodomainpathsecurescript" class="md-nav__link">
    <span class="md-ellipsis">
      CookieAccessInfo(domain,path,secure,script)
    </span>
  </a>
  
    <nav class="md-nav" aria-label="CookieAccessInfo(domain,path,secure,script)">
      <ul class="md-nav__list">
  ...
  <a href="#properties" class="md-nav__link">
    <span class="md-ellipsis">
      Properties
          ...
          <li class="md-nav__item">
  <a href="#cookiecookiestr_or_cookie-request_domain-request_path" class="md-nav__link">
    <span class="md-ellipsis">
      Cookie(cookiestr_or_cookie, request_domain, request_path)
    </span>
  </a>
  
    <nav class="md-nav" aria-label="Cookie(cookiestr_or_cookie, request_domain, request_path)">
      <ul class="md-nav__list">
  ...
  <a href="#methods" class="md-nav__link">
    <span class="md-ellipsis">
      Methods
          ...
          <li class="md-nav__item">
  <a href="#cookiejar_1" class="md-nav__link">
    <span class="md-ellipsis">
      CookieJar()
    </span>
  </a>
  
    <nav class="md-nav" aria-label="CookieJar()">
      <ul class="md-nav__list">
...
<p><a href="https://www.npmjs.org/package/cookiejar"><img alt="NPM version" src="http://img.shields.io/npm/v/cookiejar.svg" /></a>
<a href="https://david-dm.org/bmeck/node-cookiejar?type=dev"><img alt="devDependency Status" src="https://david-dm.org/bmeck/node-cookiejar/dev-status.svg" /></a></p>
<p>Simple robust cookie library</p>
<h2 id="exports">Exports</h2>
<h3 id="cookieaccessinfodomainpathsecurescript">CookieAccessInfo(domain,path,secure,script)</h3>
<p>class to determine matching qualities of a cookie</p>
...
<h3 id="cookiecookiestr_or_cookie-request_domain-request_path">Cookie(cookiestr_or_cookie, request_domain, request_path)</h3>
<p>It turns input into a Cookie (singleton if given a Cookie),
the <code>request_domain</code> argument is used to default the domain if it is not explicit in the cookie string,
the <code>request_path</code> argument is used to set the path if it is not explicit in a cookie String.</p>
<p>Explicit domains/paths will cascade, implied domains/paths must <em>exactly</em> match (see http://en.wikipedia.org/wiki/HTTP_cookie#Domain_and_Pat).</p>
...
<ul>
<li><code>String toString()</code> - the <strong>set-cookie:</strong> string for this cookie</li>
<li><code>String toValueString()</code> - the <strong>cookie:</strong> string for this cookie</li>
<li><code>Cookie parse(cookiestr, request_domain, request_path)</code> - parses the string onto this cookie or a new one if called directly</li>
<li><code>Boolean matches(access_info)</code> - returns true if the access_info allows retrieval of this cookie</li>
<li><code>Boolean collidesWith(cookie)</code> - returns true if the cookies cannot exist in the same space (domain and path match)</li>
</ul>
<h3 id="cookiejar_1">CookieJar()</h3>
<p>class to hold numerous cookies from multiple domains correctly</p>
<h5 id="methods_1">Methods</h5>
<ul>
<li><code>Cookie setCookie(cookie, request_domain, request_path)</code> - modify (or add if not already-existing) a cookie to the jar</li>
<li><code>Cookie[] setCookies(cookiestr_or_list, request_domain, request_path)</code> - modify (or add if not already-existing) a large number of cookies to the jar</li>
<li><code>Cookie getCookie(cookie_name,access_info)</code> - get a cookie with the name and access_info matching</li>
<li><code>Cookie[] getCookies(access_info)</code> - grab all cookies matching this access_info</li>
</ul>
