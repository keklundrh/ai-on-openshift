...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/babel-preset-current-node-syntax/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>babel-preset-current-node-syntax - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="babel-preset-current-node-syntax - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/babel-preset-current-node-syntax/README.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/babel-preset-current-node-syntax/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="babel-preset-current-node-syntax - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/babel-preset-current-node-syntax/README.png" >
    ...
    <div data-md-component="skip">
        ...
        <a href="#babel-preset-current-node-syntax" class="md-skip">
          Skip to content
        </a>
...
<h1 id="babel-preset-current-node-syntax"><code>babel-preset-current-node-syntax</code></h1>
<blockquote>
<p>A Babel preset that enables parsing of proposals supported by the current Node.js version.</p>
</blockquote>
<h2 id="installation">Installation</h2>
<p>If you are using yarn:
<div class="highlight"><pre><span></span><code>yarn add --dev babel-preset-current-node-syntax
</code></pre></div></p>
<p>If you are using npm:
<div class="highlight"><pre><span></span><code>npm install --save-dev babel-preset-current-node-syntax
</code></pre></div></p>
<h2 id="contributing">Contributing</h2>
<p>PRs are welcome! The codebase is so small that I didn't setup a linter, but try
to match the style of the existing code.</p>
<p>You can run tests with the following command:
<div class="highlight"><pre><span></span><code>yarn node test/index.js
</code></pre></div></p>
<p>The <code>test/fixtures.json</code> file contains a bunch of syntax tests, alongside with
...
All the tests are run using <code>@babel/parser@7.0.0</code>.</p>
