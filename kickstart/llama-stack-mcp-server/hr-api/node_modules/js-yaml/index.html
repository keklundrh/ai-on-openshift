...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/js-yaml/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>JS-YAML - YAML 1.2 parser / writer for JavaScript - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="JS-YAML - YAML 1.2 parser / writer for JavaScript - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/js-yaml/README.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/js-yaml/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="JS-YAML - YAML 1.2 parser / writer for JavaScript - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/js-yaml/README.png" >
    ...
    <div data-md-component="skip">
        ...
        <a href="#js-yaml-yaml-12-parser-writer-for-javascript" class="md-skip">
          Skip to content
        </a>
  ...
  <a href="#installation" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Installation">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#yaml-module-for-nodejs" class="md-nav__link">
    <span class="md-ellipsis">
      YAML module for node.js
          ...
          <li class="md-nav__item">
  <a href="#cli-executable" class="md-nav__link">
    <span class="md-ellipsis">
      CLI executable
    </span>
  </a>
  
    <nav class="md-nav" aria-label="CLI executable">
      <ul class="md-nav__list">
  ...
  <a href="#usage" class="md-nav__link">
    <span class="md-ellipsis">
      Usage
          ...
          <li class="md-nav__item">
  <a href="#bundled-yaml-library-for-browsers" class="md-nav__link">
    <span class="md-ellipsis">
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#safeload-string-options" class="md-nav__link">
    <span class="md-ellipsis">
      safeLoad (string [ , options ])
          ...
          <li class="md-nav__item">
  <a href="#load-string-options" class="md-nav__link">
    <span class="md-ellipsis">
      load (string [ , options ])
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#safeloadall-string-iterator-options" class="md-nav__link">
    <span class="md-ellipsis">
      safeLoadAll (string [, iterator] [, options ])
          ...
          <li class="md-nav__item">
  <a href="#loadall-string-iterator-options" class="md-nav__link">
    <span class="md-ellipsis">
      loadAll (string [, iterator] [ , options ])
          ...
          <li class="md-nav__item">
  <a href="#safedump-object-options" class="md-nav__link">
    <span class="md-ellipsis">
      safeDump (object [ , options ])
          ...
          <li class="md-nav__item">
  <a href="#dump-object-options" class="md-nav__link">
    <span class="md-ellipsis">
      dump (object [ , options ])
    </span>
  </a>
        ...
        <li class="md-nav__item">
  <a href="#supported-yaml-types" class="md-nav__link">
    <span class="md-ellipsis">
  ...
  <a href="#caveats" class="md-nav__link">
    <span class="md-ellipsis">
      Caveats
        ...
        <li class="md-nav__item">
  <a href="#js-yaml-for-enterprise" class="md-nav__link">
    <span class="md-ellipsis">
...
<p><a href="https://travis-ci.org/nodeca/js-yaml"><img alt="Build Status" src="https://travis-ci.org/nodeca/js-yaml.svg?branch=master" /></a>
...
<div class="highlight"><pre><span></span><code>npm install js-yaml
</code></pre></div>
<h3 id="cli-executable">CLI executable</h3>
<p>If you want to inspect your YAML files from CLI, install js-yaml globally:</p>
<div class="highlight"><pre><span></span><code>npm install -g js-yaml
</code></pre></div>
<h4 id="usage">Usage</h4>
<div class="highlight"><pre><span></span><code>usage: js-yaml [-h] [-v] [-c] [-t] file
...
<div class="highlight"><pre><span></span><code><span class="cm">&lt;!-- esprima required only for !!js/function --&gt;</span>
<span class="p">&lt;</span><span class="nt">script</span> <span class="na">src</span><span class="o">=</span><span class="s">&quot;esprima.js&quot;</span><span class="p">&gt;&lt;/</span><span class="nt">script</span><span class="p">&gt;</span>
<span class="p">&lt;</span><span class="nt">script</span> <span class="na">src</span><span class="o">=</span><span class="s">&quot;js-yaml.min.js&quot;</span><span class="p">&gt;&lt;/</span><span class="nt">script</span><span class="p">&gt;</span>
<span class="p">&lt;</span><span class="nt">script</span> <span class="na">type</span><span class="o">=</span><span class="s">&quot;text/javascript&quot;</span><span class="p">&gt;</span>
<span class="kd">var</span><span class="w"> </span><span class="nx">doc</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">jsyaml</span><span class="p">.</span><span class="nx">load</span><span class="p">(</span><span class="s1">&#39;greeting: hello\nname: world&#39;</span><span class="p">);</span>
...
info.</p>
<div class="highlight"><pre><span></span><code><span class="kd">const</span><span class="w"> </span><span class="nx">yaml</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;js-yaml&#39;</span><span class="p">);</span>
...
<span class="w">  </span><span class="kd">const</span><span class="w"> </span><span class="nx">doc</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">yaml</span><span class="p">.</span><span class="nx">safeLoad</span><span class="p">(</span><span class="nx">fs</span><span class="p">.</span><span class="nx">readFileSync</span><span class="p">(</span><span class="s1">&#39;/home/ixti/example.yml&#39;</span><span class="p">,</span><span class="w"> </span><span class="s1">&#39;utf8&#39;</span><span class="p">));</span>
...
<h3 id="safeload-string-options">safeLoad (string [ , options ])</h3>
<p><strong>Recommended loading way.</strong> Parses <code>string</code> as single YAML document. Returns either a
plain object, a string or <code>undefined</code>, or throws <code>YAMLException</code> on error. By default, does
not support regexps, functions and undefined. This method is safe for untrusted data.</p>
<p>options:</p>
<ul>
...
<div class="highlight"><pre><span></span><code><span class="kd">const</span><span class="w"> </span><span class="nx">untrusted_code</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="s1">&#39;&quot;toString&quot;: !&lt;tag:yaml.org,2002:js/function&gt; &quot;function (){very_evil_thing();}&quot;&#39;</span><span class="p">;</span>

<span class="c1">// I&#39;m just converting that string, what could possibly go wrong?</span>
<span class="nx">require</span><span class="p">(</span><span class="s1">&#39;js-yaml&#39;</span><span class="p">).</span><span class="nx">load</span><span class="p">(</span><span class="nx">untrusted_code</span><span class="p">)</span><span class="w"> </span><span class="o">+</span><span class="w"> </span><span class="s1">&#39;&#39;</span>
</code></pre></div>
<h3 id="safeloadall-string-iterator-options">safeLoadAll (string [, iterator] [, options ])</h3>
...
<span class="nx">yaml</span><span class="p">.</span><span class="nx">safeLoadAll</span><span class="p">(</span><span class="nx">data</span><span class="p">,</span><span class="w"> </span><span class="kd">function</span><span class="w"> </span><span class="p">(</span><span class="nx">doc</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">doc</span><span class="p">);</span>
<span class="p">});</span>
</code></pre></div>
...
<p>Example:</p>
<div class="highlight"><pre><span></span><code><span class="nx">safeDump</span><span class="w"> </span><span class="p">(</span><span class="nx">object</span><span class="p">,</span><span class="w"> </span><span class="p">{</span>
...
<div class="highlight"><pre><span></span><code>!!js/regexp /pattern/gim            # RegExp
...
<div class="highlight"><pre><span></span><code><span class="p">{</span><span class="w"> </span><span class="s2">&quot;foo,bar&quot;</span><span class="o">:</span><span class="w"> </span><span class="p">[</span><span class="s2">&quot;baz&quot;</span><span class="p">],</span><span class="w"> </span><span class="s2">&quot;[object Object]&quot;</span><span class="o">:</span><span class="w"> </span><span class="p">[</span><span class="s2">&quot;baz&quot;</span><span class="p">,</span><span class="w"> </span><span class="s2">&quot;baz&quot;</span><span class="p">]</span><span class="w"> </span><span class="p">}</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="nt">&amp;anchor foo</span><span class="p">:</span>
...
<p>The maintainers of js-yaml and thousands of other packages are working with Tidelift to deliver commercial support and maintenance for the open source dependencies you use to build your applications. Save time, reduce risk, and improve code health, while paying the maintainers of the exact dependencies you use. <a href="https://tidelift.com/subscription/pkg/npm-js-yaml?utm_source=npm-js-yaml&amp;utm_medium=referral&amp;utm_campaign=enterprise&amp;utm_term=repo">Learn more.</a></p>
