...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/dedent/">
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/dedent/README.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/dedent/" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/dedent/README.png" >
  ...
  <a href="#options" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Options">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#escapespecialcharacters" class="md-nav__link">
    <span class="md-ellipsis">
      escapeSpecialCharacters
          ...
          <li class="md-nav__item">
  <a href="#trimwhitespace" class="md-nav__link">
    <span class="md-ellipsis">
      trimWhitespace
    </span>
  </a>
...
<div class="highlight"><pre><span></span><code>npm<span class="w"> </span>i<span class="w"> </span>dedent
</code></pre></div>
<div class="highlight"><pre><span></span><code><span class="k">import</span><span class="w"> </span><span class="nx">dedent</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s2">&quot;dedent&quot;</span><span class="p">;</span>

<span class="kd">function</span><span class="w"> </span><span class="nx">usageExample</span><span class="p">()</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="kd">const</span><span class="w"> </span><span class="nx">first</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">dedent</span><span class="sb">`A string that gets so long you need to break it over</span>
<span class="sb">                       multiple lines. Luckily dedent is here to keep it</span>
<span class="sb">                       readable without lots of spaces ending up in the string</span>
<span class="sb">                       itself.`</span><span class="p">;</span>

<span class="w">    </span><span class="kd">const</span><span class="w"> </span><span class="nx">second</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">dedent</span><span class="sb">`</span>
<span class="sb">    Leading and trailing lines will be trimmed, so you can write something like</span>
<span class="sb">    this and have it work as you expect:</span>

<span class="sb">      * how convenient it is</span>
<span class="sb">      * that I can use an indented list</span>
<span class="sb">         - and still have it do the right thing</span>

<span class="sb">    That&#39;s all.</span>
<span class="sb">  `</span><span class="p">;</span>

<span class="w">    </span><span class="kd">const</span><span class="w"> </span><span class="nx">third</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">dedent</span><span class="p">(</span><span class="sb">`</span>
<span class="sb">    Wait! I lied. Dedent can also be used as a function.</span>
<span class="sb">  `</span><span class="p">);</span>

<span class="w">    </span><span class="k">return</span><span class="w"> </span><span class="nx">first</span><span class="w"> </span><span class="o">+</span><span class="w"> </span><span class="s2">&quot;\n\n&quot;</span><span class="w"> </span><span class="o">+</span><span class="w"> </span><span class="nx">second</span><span class="w"> </span><span class="o">+</span><span class="w"> </span><span class="s2">&quot;\n\n&quot;</span><span class="w"> </span><span class="o">+</span><span class="w"> </span><span class="nx">third</span><span class="p">;</span>
<span class="p">}</span>

<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">usageExample</span><span class="p">());</span>
</code></pre></div>
<div class="highlight"><pre><span></span><code>A string that gets so long you need to break it over
...
<p>You can customize the options <code>dedent</code> runs with by calling its <code>withOptions</code> method with an object:</p>
<!-- prettier-ignore -->
<div class="highlight"><pre><span></span><code><span class="k">import</span><span class="w"> </span><span class="nx">dedent</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s1">&#39;dedent&#39;</span><span class="p">;</span>

<span class="nx">dedent</span><span class="p">.</span><span class="nx">withOptions</span><span class="p">({</span><span class="w"> </span><span class="cm">/* ... */</span><span class="w"> </span><span class="p">})</span><span class="sb">`input`</span><span class="p">;</span>
<span class="nx">dedent</span><span class="p">.</span><span class="nx">withOptions</span><span class="p">({</span><span class="w"> </span><span class="cm">/* ... */</span><span class="w"> </span><span class="p">})(</span><span class="sb">`input`</span><span class="p">);</span>
</code></pre></div>
<p><code>options</code> returns a new <code>dedent</code> function, so if you'd like to reuse the same options, you can create a dedicated <code>dedent</code> function:</p>
<!-- prettier-ignore -->
<div class="highlight"><pre><span></span><code><span class="k">import</span><span class="w"> </span><span class="nx">dedent</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s1">&#39;dedent&#39;</span><span class="p">;</span>

<span class="kd">const</span><span class="w"> </span><span class="nx">dedenter</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">dedent</span><span class="p">.</span><span class="nx">withOptions</span><span class="p">({</span><span class="w"> </span><span class="cm">/* ... */</span><span class="w"> </span><span class="p">});</span>

<span class="nx">dedenter</span><span class="sb">`input`</span><span class="p">;</span>
<span class="nx">dedenter</span><span class="p">(</span><span class="sb">`input`</span><span class="p">);</span>
</code></pre></div>
<h3 id="escapespecialcharacters"><code>escapeSpecialCharacters</code></h3>
<p>JavaScript string tags by default add an extra <code>\</code> escape in front of some special characters such as <code>$</code> dollar signs.
<code>dedent</code> will escape those special characters when called as a string tag.</p>
<p>If you'd like to change the behavior, an <code>escapeSpecialCharacters</code> option is available.
It defaults to:</p>
<ul>
<li><code>false</code>: when <code>dedent</code> is called as a function</li>
<li><code>true</code>: when <code>dedent</code> is called as a string tag</li>
</ul>
<div class="highlight"><pre><span></span><code><span class="k">import</span><span class="w"> </span><span class="nx">dedent</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s2">&quot;dedent&quot;</span><span class="p">;</span>

<span class="c1">// &quot;$hello!&quot;</span>
<span class="nx">dedent</span><span class="sb">`</span>
<span class="sb">  $hello!</span>
<span class="sb">`</span><span class="p">;</span>

<span class="c1">// &quot;\$hello!&quot;</span>
<span class="nx">dedent</span><span class="p">.</span><span class="nx">withOptions</span><span class="p">({</span><span class="w"> </span><span class="nx">escapeSpecialCharacters</span><span class="o">:</span><span class="w"> </span><span class="kc">false</span><span class="w"> </span><span class="p">})</span><span class="sb">`</span>
<span class="sb">  $hello!</span>
<span class="sb">`</span><span class="p">;</span>

<span class="c1">// &quot;$hello!&quot;</span>
<span class="nx">dedent</span><span class="p">.</span><span class="nx">withOptions</span><span class="p">({</span><span class="w"> </span><span class="nx">escapeSpecialCharacters</span><span class="o">:</span><span class="w"> </span><span class="kc">true</span><span class="w"> </span><span class="p">})</span><span class="sb">`</span>
<span class="sb">  $hello!</span>
<span class="sb">`</span><span class="p">;</span>
</code></pre></div>
<p>For more context, see <a href="https://github.com/dmnd/dedent/issues/63">🚀 Feature: Add an option to disable special character escaping</a>.</p>
<h3 id="trimwhitespace"><code>trimWhitespace</code></h3>
<p>By default, dedent will trim leading and trailing whitespace from the overall string.</p>
<p>This can be disabled by setting <code>trimWhitespace: false</code>.</p>
<div class="highlight"><pre><span></span><code><span class="k">import</span><span class="w"> </span><span class="nx">dedent</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s2">&quot;dedent&quot;</span><span class="p">;</span>
...
<span class="c1">// &quot;\nhello! \n&quot;</span>
<span class="nx">dedent</span><span class="p">.</span><span class="nx">withOptions</span><span class="p">({</span><span class="w"> </span><span class="nx">trimWhitespace</span><span class="o">:</span><span class="w"> </span><span class="kc">false</span><span class="w"> </span><span class="p">})</span><span class="sb">`</span>
<span class="sb">  hello! </span>
<span class="sb">`</span><span class="p">;</span>

<span class="c1">// &quot;hello!&quot;</span>
<span class="nx">dedent</span><span class="p">.</span><span class="nx">withOptions</span><span class="p">({</span><span class="w"> </span><span class="nx">trimWhitespace</span><span class="o">:</span><span class="w"> </span><span class="kc">true</span><span class="w"> </span><span class="p">})</span><span class="sb">`</span>
<span class="sb">  hello! </span>
<span class="sb">`</span><span class="p">;</span>
</code></pre></div>
...
<blockquote>
<p>💙 This package was templated with <a href="https://github.com/JoshuaKGoldberg/create-typescript-app">create-typescript-app</a>.</p>
</blockquote>
