...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/component-emitter/Readme/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>Emitter Build Status - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="Emitter Build Status - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/component-emitter/Readme.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/component-emitter/Readme/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="Emitter Build Status - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/component-emitter/Readme.png" >
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#emitterobj" class="md-nav__link">
    <span class="md-ellipsis">
      Emitter(obj)
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#emitteronevent-fn" class="md-nav__link">
    <span class="md-ellipsis">
      Emitter#on(event, fn)
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#emitteronceevent-fn" class="md-nav__link">
    <span class="md-ellipsis">
      Emitter#once(event, fn)
          ...
          <li class="md-nav__item">
  <a href="#emitteroffevent-fn" class="md-nav__link">
    <span class="md-ellipsis">
      Emitter#off(event, fn)
          ...
          <li class="md-nav__item">
  <a href="#emitteremitevent" class="md-nav__link">
    <span class="md-ellipsis">
      Emitter#emit(event, ...)
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#emitterlistenersevent" class="md-nav__link">
    <span class="md-ellipsis">
      Emitter#listeners(event)
          ...
          <li class="md-nav__item">
  <a href="#emitterhaslistenersevent" class="md-nav__link">
    <span class="md-ellipsis">
...
<h1 id="emitter">Emitter <a href="https://travis-ci.org/component/emitter"><img alt="Build Status" src="https://travis-ci.org/component/emitter.png" /></a></h1>
<p>Event emitter component.</p>
<h2 id="installation">Installation</h2>
<div class="highlight"><pre><span></span><code>$ component install component/emitter
</code></pre></div>
<h2 id="api">API</h2>
...
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">Emitter</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;emitter&#39;</span><span class="p">);</span>
...
<h3 id="emitteronevent-fn">Emitter#on(event, fn)</h3>
<p>Register an <code>event</code> handler <code>fn</code>.</p>
<h3 id="emitteronceevent-fn">Emitter#once(event, fn)</h3>
<p>Register a single-shot <code>event</code> handler <code>fn</code>,
  removed immediately after it is invoked the
  first time.</p>
<h3 id="emitteroffevent-fn">Emitter#off(event, fn)</h3>
<ul>
...
<h3 id="emitteremitevent">Emitter#emit(event, ...)</h3>
<p>Emit an <code>event</code> with variable option args.</p>
<h3 id="emitterlistenersevent">Emitter#listeners(event)</h3>
<p>Return an array of callbacks, or an empty array.</p>
<h3 id="emitterhaslistenersevent">Emitter#hasListeners(event)</h3>
