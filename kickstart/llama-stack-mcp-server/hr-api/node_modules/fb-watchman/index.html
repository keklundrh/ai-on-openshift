...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/fb-watchman/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>fb-watchman - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="fb-watchman - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/fb-watchman/README.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/fb-watchman/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="fb-watchman - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/fb-watchman/README.png" >
    ...
    <div data-md-component="skip">
        ...
        <a href="#fb-watchman" class="md-skip">
          Skip to content
        </a>
...
<h1 id="fb-watchman">fb-watchman</h1>
<p><code>fb-watchman</code> is a filesystem watcher that uses the
<a href="https://facebook.github.io/watchman/">Watchman</a> file watching service from
Facebook.</p>
<p>Watchman provides file change notification services using very
efficient recursive watches and also allows more advanced change matching and
filesystem tree querying operations using
<a href="https://facebook.github.io/watchman/docs/file-query.html#expressions">a powerful expression syntax</a>.</p>
<h2 id="install">Install</h2>
<p>You should <a href="https://facebook.github.io/watchman/docs/install.html">install Watchman</a> to make the most of this
module.</p>
<p>Then simply:</p>
<div class="highlight"><pre><span></span><code>$ npm install fb-watchman
</code></pre></div>
<h2 id="key-concepts">Key Concepts</h2>
<ul>
<li>Watchman recursively watches directories.</li>
<li>Each watched directory is called a <code>root</code>.</li>
<li>You must initiate a <code>watch</code> on a <code>root</code> using the <code>watch-project</code> command prior to subscribing to changes</li>
<li>Rather than separately watching many sibling directories, <code>watch-project</code> consolidates and re-uses existing watches relative to a project root (the location of your <code>.watchmanconfig</code> or source control repository root)</li>
<li>change notifications are relative to the project root</li>
</ul>
<h2 id="how-do-i-use-it">How do I use it?</h2>
<p><a href="https://facebook.github.io/watchman/docs/nodejs.html">Read the NodeJS watchman documentation</a></p>
