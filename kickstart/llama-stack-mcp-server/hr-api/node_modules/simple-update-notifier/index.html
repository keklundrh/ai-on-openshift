...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/simple-update-notifier/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>simple-update-notifier GitHub stars - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="simple-update-notifier GitHub stars - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/simple-update-notifier/README.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/simple-update-notifier/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="simple-update-notifier GitHub stars - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/simple-update-notifier/README.png" >
    ...
    <div data-md-component="skip">
        ...
        <a href="#simple-update-notifier" class="md-skip">
          Skip to content
        </a>
...
<nav class="md-nav md-nav--secondary" aria-label="Table of contents">
  ...
  <a href="#pkg" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="pkg">
      <ul class="md-nav__list">
  ...
  <a href="#version" class="md-nav__link">
    <span class="md-ellipsis">
      version
          ...
          <li class="md-nav__item">
  <a href="#updatecheckinterval" class="md-nav__link">
    <span class="md-ellipsis">
      updateCheckInterval
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#shouldnotifyinnpmscript" class="md-nav__link">
    <span class="md-ellipsis">
  ...
  <a href="#disttag" class="md-nav__link">
    <span class="md-ellipsis">
      distTag
          ...
          <li class="md-nav__item">
  <a href="#alwaysrun" class="md-nav__link">
    <span class="md-ellipsis">
      alwaysRun
    </span>
  </a>
...
<h1 id="simple-update-notifier">simple-update-notifier <a href="https://github.com/alexbrazier/simple-update-notifier/stargazers"><img alt="GitHub stars" src="https://img.shields.io/github/stars/alexbrazier/simple-update-notifier?label=Star%20Project&amp;style=social" /></a></h1>
<p><a href="https://github.com/alexbrazier/simple-update-notifier/actions"><img alt="CI" src="https://github.com/alexbrazier/simple-update-notifier/workflows/Build%20and%20Deploy/badge.svg" /></a>
<a href="https://www.npmjs.com/package/simple-update-notifier?activeTab=dependencies"><img alt="Dependencies" src="https://img.shields.io/librariesio/release/npm/simple-update-notifier" /></a>
<a href="https://www.npmjs.com/package/simple-update-notifier"><img alt="npm" src="https://img.shields.io/npm/v/simple-update-notifier" /></a>
<a href="https://bundlephobia.com/result?p=simple-update-notifier"><img alt="npm bundle size" src="https://img.shields.io/bundlephobia/min/simple-update-notifier" /></a>
<a href="https://www.npmjs.com/package/simple-update-notifier"><img alt="npm downloads" src="https://img.shields.io/npm/dw/simple-update-notifier" /></a>
<a href="LICENSE"><img alt="License" src="https://img.shields.io/npm/l/simple-update-notifier" /></a></p>
<p>Simple update notifier to check for npm updates for cli applications.</p>
<p><img src="./.github/demo.png" alt="Demo in terminal showing an update is required"></p>
<p>Checks for updates for an npm module and outputs to the command line if there is one available. The result is cached for the specified time so it doesn't check every time the app runs.</p>
<h2 id="install">Install</h2>
<div class="highlight"><pre><span></span><code>npm<span class="w"> </span>install<span class="w"> </span>simple-update-notifier
OR
yarn<span class="w"> </span>add<span class="w"> </span>simple-update-notifier
</code></pre></div>
<h2 id="usage">Usage</h2>
<div class="highlight"><pre><span></span><code><span class="k">import</span><span class="w"> </span><span class="nx">updateNotifier</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s1">&#39;simple-update-notifier&#39;</span><span class="p">;</span>
<span class="k">import</span><span class="w"> </span><span class="nx">packageJson</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s1">&#39;./package.json&#39;</span><span class="w"> </span><span class="nx">assert</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">type</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;json&#39;</span><span class="w"> </span><span class="p">};</span>

<span class="nx">updateNotifier</span><span class="p">({</span><span class="w"> </span><span class="nx">pkg</span><span class="o">:</span><span class="w"> </span><span class="nx">packageJson</span><span class="w"> </span><span class="p">});</span>
</code></pre></div>
...
<p><em>Required</em>\
Type: <code>string</code></p>
<h4 id="updatecheckinterval">updateCheckInterval</h4>
<p>Type: <code>number</code>\
Default: <code>1000 * 60 * 60 * 24</code> <em>(1 day)</em></p>
<p>How often to check for updates.</p>
<h4 id="shouldnotifyinnpmscript">shouldNotifyInNpmScript</h4>
<p>Type: <code>boolean</code>\
Default: <code>false</code></p>
<p>Allows notification to be shown when running as an npm script.</p>
<h4 id="disttag">distTag</h4>
<p>Type: <code>string</code>\
Default: <code>'latest'</code></p>
<p>Which <a href="https://docs.npmjs.com/adding-dist-tags-to-packages">dist-tag</a> to use to find the latest version.</p>
<h4 id="alwaysrun">alwaysRun</h4>
<p>Type: <code>boolean</code>\
Default: <code>false</code></p>
<p>When set, <code>updateCheckInterval</code> will not be respected and a check for an update will always be performed.</p>
<h4 id="debug">debug</h4>
<p>Type: <code>boolean</code>\
Default: <code>false</code></p>
<p>When set, logs explaining the decision will be output to <code>stderr</code> whenever the module opts to not print an update notification</p>
