...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/jest-changed-files/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>jest-changed-files - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="jest-changed-files - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/jest-changed-files/README.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/jest-changed-files/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="jest-changed-files - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/jest-changed-files/README.png" >
    ...
    <div data-md-component="skip">
        ...
        <a href="#jest-changed-files" class="md-skip">
          Skip to content
        </a>
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#getchangedfilesforrootsroots-arraystring-options-options-promisechangedfiles" class="md-nav__link">
    <span class="md-ellipsis">
      getChangedFilesForRoots(roots: Array&lt;string&gt;, options: Options): Promise&lt;ChangedFiles&gt;
    </span>
  </a>
  
    <nav class="md-nav" aria-label="getChangedFilesForRoots(roots: Array<string>, options: Options): Promise<ChangedFiles>">
      <ul class="md-nav__list">
  ...
  <a href="#returns" class="md-nav__link">
    <span class="md-ellipsis">
      Returns
          ...
          <li class="md-nav__item">
  <a href="#findreposroots-array-promise" class="md-nav__link">
    <span class="md-ellipsis">
      findRepos(roots: Array): Promise
    </span>
  </a>
  
    <nav class="md-nav" aria-label="findRepos(roots: Array): Promise">
      <ul class="md-nav__list">
...
<h1 id="jest-changed-files">jest-changed-files</h1>
<p>A module used internally by Jest to check which files have changed since you last committed in git or hg.</p>
<h2 id="install">Install</h2>
<div class="highlight"><pre><span></span><code>$<span class="w"> </span>npm<span class="w"> </span>install<span class="w"> </span>--save<span class="w"> </span>jest-changed-files
</code></pre></div>
<h2 id="api">API</h2>
<h3 id="getchangedfilesforrootsroots-arraystring-options-options-promisechangedfiles"><code>getChangedFilesForRoots(roots: Array&lt;string&gt;, options: Options): Promise&lt;ChangedFiles&gt;</code></h3>
<p>Get the list of files and repos that have changed since the last commit.</p>
<h4 id="parameters">Parameters</h4>
<p>roots: Array of string paths gathered from <a href="https://jestjs.io/docs/configuration#roots-arraystring">jest roots</a>.</p>
<p>options: Object literal with keys</p>
<ul>
<li>lastCommit: boolean</li>
<li>withAncestor: boolean</li>
<li>changedSince: string</li>
</ul>
<h3 id="returns">Returns</h3>
<p>A Promise of Object literal with keys</p>
<ul>
<li>changedFiles: Set\<string></li>
<li>repos:</li>
<li>git: Set\<string></li>
<li>hg: Set\<string></li>
</ul>
<h3 id="findreposroots-array-promise">findRepos(roots: Array<string>): Promise<Repos></h3>
<p>Get a set of git and hg repositories.</p>
...
<div class="highlight"><pre><span></span><code><span class="k">import</span><span class="w"> </span><span class="p">{</span><span class="nx">getChangedFilesForRoots</span><span class="p">}</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s1">&#39;jest-changed-files&#39;</span><span class="p">;</span>

<span class="nx">getChangedFilesForRoots</span><span class="p">([</span><span class="s1">&#39;/path/to/test&#39;</span><span class="p">],</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="nx">lastCommit</span><span class="o">:</span><span class="w"> </span><span class="kc">true</span><span class="p">,</span>
<span class="w">  </span><span class="nx">withAncestor</span><span class="o">:</span><span class="w"> </span><span class="kc">true</span><span class="p">,</span>
<span class="p">}).</span><span class="nx">then</span><span class="p">(</span><span class="nx">files</span><span class="w"> </span><span class="p">=&gt;</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="cm">/*</span>
<span class="cm">  {</span>
<span class="cm">    repos: [],</span>
<span class="cm">    changedFiles: []</span>
<span class="cm">  }</span>
<span class="cm">  */</span>
<span class="p">});</span>
</code></pre></div>
...
<span class="nx">getChangedFilesForRoots</span><span class="p">([</span><span class="s1">&#39;/path/to/test&#39;</span><span class="p">],</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="nx">changedSince</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;main&#39;</span><span class="p">,</span>
<span class="p">}).</span><span class="nx">then</span><span class="p">(</span><span class="nx">files</span><span class="w"> </span><span class="p">=&gt;</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="cm">/*</span>
<span class="cm">  {</span>
<span class="cm">    repos: [],</span>
...
<div class="highlight"><pre><span></span><code><span class="k">import</span><span class="w"> </span><span class="p">{</span><span class="nx">findRepos</span><span class="p">}</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s1">&#39;jest-changed-files&#39;</span><span class="p">;</span>

<span class="nx">findRepos</span><span class="p">([</span><span class="s1">&#39;/path/to/test&#39;</span><span class="p">]).</span><span class="nx">then</span><span class="p">(</span><span class="nx">repos</span><span class="w"> </span><span class="p">=&gt;</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="cm">/*</span>
<span class="cm">  {</span>
<span class="cm">    git: Set&lt;Path&gt;,</span>
<span class="cm">    hg: Set&lt;Path&gt;</span>
<span class="cm">  }</span>
<span class="cm">  */</span>
<span class="p">});</span>
</code></pre></div>
