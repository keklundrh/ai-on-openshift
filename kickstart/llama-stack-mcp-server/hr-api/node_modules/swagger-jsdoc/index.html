...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/swagger-jsdoc/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>swagger-jsdoc - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="swagger-jsdoc - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/swagger-jsdoc/README.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/swagger-jsdoc/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="swagger-jsdoc - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/swagger-jsdoc/README.png" >
    ...
    <div data-md-component="skip">
        ...
        <a href="#swagger-jsdoc" class="md-skip">
          Skip to content
        </a>
  ...
  <a href="#installation" class="md-nav__link">
    <span class="md-ellipsis">
      Installation
        ...
        <li class="md-nav__item">
  <a href="#supported-specifications" class="md-nav__link">
    <span class="md-ellipsis">
      Supported specifications
        ...
        <li class="md-nav__item">
  <a href="#validation-of-swagger-docs" class="md-nav__link">
    <span class="md-ellipsis">
...
<h1 id="swagger-jsdoc">swagger-jsdoc</h1>
<p>This library reads your <a href="https://jsdoc.app/">JSDoc</a>-annotated source code and generates an <a href="https://swagger.io/specification/">OpenAPI (Swagger) specification</a>.</p>
<p><a href="https://www.npmjs.com/package/swagger-jsdoc"><img alt="npm Downloads" src="https://img.shields.io/npm/dm/swagger-jsdoc.svg" /></a>
<img alt="CI" src="https://github.com/Surnet/swagger-jsdoc/workflows/CI/badge.svg" /></p>
<h2 id="getting-started">Getting started</h2>
<p>Imagine having API files like these:</p>
<div class="highlight"><pre><span></span><code><span class="cm">/**</span>
<span class="cm"> * @openapi</span>
<span class="cm"> * /:</span>
<span class="cm"> *   get:</span>
<span class="cm"> *     description: Welcome to swagger-jsdoc!</span>
<span class="cm"> *     responses:</span>
<span class="cm"> *       200:</span>
<span class="cm"> *         description: Returns a mysterious string.</span>
<span class="cm"> */</span>
...
<p>The library will take the contents of <code>@openapi</code> (or <code>@swagger</code>) with the following configuration:</p>
...
<span class="w">  </span><span class="nx">definition</span><span class="o">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="nx">openapi</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;3.0.0&#39;</span><span class="p">,</span>
...
<span class="w">  </span><span class="p">},</span>
<span class="w">  </span><span class="nx">apis</span><span class="o">:</span><span class="w"> </span><span class="p">[</span><span class="s1">&#39;./src/routes*.js&#39;</span><span class="p">],</span><span class="w"> </span><span class="c1">// files containing annotations as above</span>
<span class="p">};</span>

<span class="kd">const</span><span class="w"> </span><span class="nx">openapiSpecification</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">swaggerJsdoc</span><span class="p">(</span><span class="nx">options</span><span class="p">);</span>
</code></pre></div>
<p>The resulting <code>openapiSpecification</code> will be a <a href="https://swagger.io/tools/">swagger tools</a>-compatible (and validated) specification.</p>
<p><img alt="swagger-jsdoc example screenshot" src="./docs/screenshot.png" /></p>
<h2 id="system-requirements">System requirements</h2>
<ul>
<li>Node.js 12.x or higher</li>
</ul>
<p>You are viewing <code>swagger-jsdoc</code> v6 which is published in CommonJS module system.</p>
<h2 id="installation">Installation</h2>
<div class="highlight"><pre><span></span><code>npm<span class="w"> </span>install<span class="w"> </span>swagger-jsdoc<span class="w"> </span>--save
</code></pre></div>
<p>Or</p>
<div class="highlight"><pre><span></span><code>yarn<span class="w"> </span>add<span class="w"> </span>swagger-jsdoc
</code></pre></div>
...
<h2 id="validation-of-swagger-docs">Validation of swagger docs</h2>
<p>By default <code>swagger-jsdoc</code> tries to parse all docs to it's best capabilities. If you'd like to you can instruct an Error to be thrown instead if validation failed by setting the options flag <code>failOnErrors</code> to <code>true</code>. This is for instance useful if you want to verify that your swagger docs validate using a unit test.</p>
<div class="highlight"><pre><span></span><code><span class="kd">const</span><span class="w"> </span><span class="nx">swaggerJsdoc</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;swagger-jsdoc&#39;</span><span class="p">);</span>

<span class="kd">const</span><span class="w"> </span><span class="nx">options</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="nx">failOnErrors</span><span class="o">:</span><span class="w"> </span><span class="kc">true</span><span class="p">,</span><span class="w"> </span><span class="c1">// Whether or not to throw when parsing errors. Defaults to false.</span>
<span class="w">  </span><span class="nx">definition</span><span class="o">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="nx">openapi</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;3.0.0&#39;</span><span class="p">,</span>
<span class="w">    </span><span class="nx">info</span><span class="o">:</span><span class="w"> </span><span class="p">{</span>
<span class="w">      </span><span class="nx">title</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;Hello World&#39;</span><span class="p">,</span>
...
<span class="w">    </span><span class="p">},</span>
<span class="w">  </span><span class="p">},</span>
<span class="w">  </span><span class="nx">apis</span><span class="o">:</span><span class="w"> </span><span class="p">[</span><span class="s1">&#39;./src/routes*.js&#39;</span><span class="p">],</span>
<span class="p">};</span>

<span class="kd">const</span><span class="w"> </span><span class="nx">openapiSpecification</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">swaggerJsdoc</span><span class="p">(</span><span class="nx">options</span><span class="p">);</span>
</code></pre></div>
<h2 id="documentation">Documentation</h2>
<p>Click on the version you are using for further details:</p>
<ul>
<li><a href="https://github.com/Surnet/swagger-jsdoc/tree/v7/docs">7.x</a></li>
<li><a href="https://github.com/Surnet/swagger-jsdoc/tree/v6/docs">6.x</a></li>
<li><a href="https://github.com/Surnet/swagger-jsdoc/tree/v5">5.x</a></li>
</ul>
