...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/swagger-jsdoc/node_modules/glob/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>Glob - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="Glob - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/swagger-jsdoc/node_modules/glob/README.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/swagger-jsdoc/node_modules/glob/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="Glob - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/swagger-jsdoc/node_modules/glob/README.png" >
  ...
  <a href="#see-also" class="md-nav__link">
    <span class="md-ellipsis">
      See Also:
        ...
        <li class="md-nav__item">
  <a href="#globhasmagicpattern-options" class="md-nav__link">
    <span class="md-ellipsis">
      glob.hasMagic(pattern, [options])
        ...
        <li class="md-nav__item">
  <a href="#globpattern-options-cb" class="md-nav__link">
    <span class="md-ellipsis">
      glob(pattern, [options], cb)
        ...
        <li class="md-nav__item">
  <a href="#globsyncpattern-options" class="md-nav__link">
    <span class="md-ellipsis">
      glob.sync(pattern, [options])
        ...
        <li class="md-nav__item">
  <a href="#class-globglob" class="md-nav__link">
    <span class="md-ellipsis">
      Class: glob.Glob
    </span>
  </a>
  
    <nav class="md-nav" aria-label="Class: glob.Glob">
      <ul class="md-nav__list">
        
          <li class="md-nav__item">
  <a href="#new-globglobpattern-options-cb" class="md-nav__link">
    <span class="md-ellipsis">
...
<p><a href="https://travis-ci.org/isaacs/node-glob/"><img alt="Build Status" src="https://travis-ci.org/isaacs/node-glob.svg?branch=master" /></a> <a href="https://ci.appveyor.com/project/isaacs/node-glob"><img alt="Build Status" src="https://ci.appveyor.com/api/projects/status/kd7f3yftf7unxlsx?svg=true" /></a> <a href="https://coveralls.io/github/isaacs/node-glob?branch=master"><img alt="Coverage Status" src="https://coveralls.io/repos/isaacs/node-glob/badge.svg?branch=master&amp;service=github" /></a></p>
<p>This is a glob implementation in JavaScript.  It uses the <code>minimatch</code>
library to do its matching.</p>
<p><img alt="" src="logo/glob.png" /></p>
<h2 id="usage">Usage</h2>
<p>Install with npm</p>
<div class="highlight"><pre><span></span><code>npm i glob
</code></pre></div>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">glob</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s2">&quot;glob&quot;</span><span class="p">)</span>
...
example:</p>
<pre class="codehilite"><code>$ echo a*s*d*f
a*s*d*f
</code></pre>
...
<h2 id="globhasmagicpattern-options">glob.hasMagic(pattern, [options])</h2>
...
<h2 id="globsyncpattern-options">glob.sync(pattern, [options])</h2>
<ul>
<li><code>pattern</code> <code>{String}</code> Pattern to be matched</li>
<li><code>options</code> <code>{Object}</code></li>
...
<h2 id="class-globglob">Class: glob.Glob</h2>
<p>Create a Glob object by instantiating the <code>glob.Glob</code> class.</p>
<div class="highlight"><pre><span></span><code><span class="kd">var</span><span class="w"> </span><span class="nx">Glob</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s2">&quot;glob&quot;</span><span class="p">).</span><span class="nx">Glob</span>
...
immediately.</p>
<h3 id="new-globglobpattern-options-cb">new glob.Glob(pattern, [options], [cb])</h3>
<ul>
<li><code>pattern</code> <code>{String}</code> pattern to search for</li>
<li><code>options</code> <code>{Object}</code></li>
<li><code>cb</code> <code>{Function}</code> Called when an error occurs, or matches are found</li>
<li><code>err</code> <code>{Error | null}</code></li>
<li><code>matches</code> <code>{Array&lt;String&gt;}</code> filenames found matching the pattern</li>
</ul>
...
<div class="highlight"><pre><span></span><code># to run tests
npm test
...
<p><img alt="" src="oh-my-glob.gif" /></p>
