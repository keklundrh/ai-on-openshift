...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/swagger-jsdoc/docusaurus/versioned_docs/version-6.x/Quick%20Start/cli/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>CLI - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="CLI - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/swagger-jsdoc/docusaurus/versioned_docs/version-6.x/Quick Start/cli.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/swagger-jsdoc/docusaurus/versioned_docs/version-6.x/Quick%20Start/cli/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="CLI - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/swagger-jsdoc/docusaurus/versioned_docs/version-6.x/Quick Start/cli.png" >
  ...
  <a href="#input-files" class="md-nav__link">
    <span class="md-ellipsis">
      Input files
          ...
          <li class="md-nav__item">
  <a href="#output-file-optional" class="md-nav__link">
    <span class="md-ellipsis">
...
<p>The CLI is a thin wrapper around the library Node API. It's available with the same name of the package when installed globally:</p>
<div class="highlight"><pre><span></span><code>swagger-jsdoc
</code></pre></div>
<p>Or through the standard ways provided by your package manager:</p>
<div class="highlight"><pre><span></span><code>yarn<span class="w"> </span>swagger-jsdoc
</code></pre></div>
<h2 id="usage">Usage</h2>
<p>Print the help menu:</p>
<div class="highlight"><pre><span></span><code>swagger-jsdoc<span class="w"> </span>-h
</code></pre></div>
<h3 id="definition-file">Definition file</h3>
<p>Set with <code>--definition</code> (or <code>-d</code>) flag:</p>
<div class="highlight"><pre><span></span><code>swagger-jsdoc<span class="w"> </span>-d<span class="w"> </span>swaggerDefinition.js
</code></pre></div>
<p>Acceptable file extensions: <code>.cjs</code>, <code>.json</code>, <code>.yml</code>, <code>.yaml</code>.</p>
<h3 id="input-files">Input files</h3>
<p>Set through arguments.</p>
<p>One by one:</p>
<div class="highlight"><pre><span></span><code>swagger-jsdoc<span class="w"> </span>-d<span class="w"> </span>swaggerDefinition.cjs<span class="w"> </span>route1.js<span class="w"> </span>route2.js<span class="w"> </span>component1.yaml<span class="w"> </span>component2.yaml
</code></pre></div>
<p>Multiple with a pattern:</p>
<div class="highlight"><pre><span></span><code>swagger-jsdoc<span class="w"> </span>-d<span class="w"> </span>swaggerDefinition.cjs<span class="w"> </span>route*.js<span class="w"> </span>component*.yaml
</code></pre></div>
<p><a href="https://github.com/isaacs/node-glob">Glob patterns</a> are acceptable to match multiple files with same extension <code>*.js</code>, <code>*.php</code>, etc. or patterns selecting files in nested folders as <code>**/*.js</code>, <code>**/*.php</code>, etc.</p>
<p>Paths are relative to the current working directory.</p>
<h3 id="output-file-optional">Output file (optional)</h3>
<p>The output is <code>swagger.json</code> by default, but can be changed:</p>
<div class="highlight"><pre><span></span><code>swagger-jsdoc<span class="w"> </span>-d<span class="w"> </span>swaggerDefinition.cjs<span class="w"> </span>route1.js<span class="w"> </span>-o<span class="w"> </span>my_spec.json
</code></pre></div>
<p>When output file extension is <code>.yaml</code> or <code>.yml</code>, the specification will be parsed and saved in YAML format.</p>
