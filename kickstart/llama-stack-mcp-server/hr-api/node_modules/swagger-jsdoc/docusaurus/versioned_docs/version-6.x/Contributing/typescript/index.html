...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/swagger-jsdoc/docusaurus/versioned_docs/version-6.x/Contributing/typescript/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>Typescript - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="Typescript - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/swagger-jsdoc/docusaurus/versioned_docs/version-6.x/Contributing/typescript.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/swagger-jsdoc/docusaurus/versioned_docs/version-6.x/Contributing/typescript/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="Typescript - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/swagger-jsdoc/docusaurus/versioned_docs/version-6.x/Contributing/typescript.png" >
  ...
  <a href="#the-library" class="md-nav__link">
    <span class="md-ellipsis">
      The library
        ...
        <li class="md-nav__item">
  <a href="#re-using-interfaces-from-source-code" class="md-nav__link">
    <span class="md-ellipsis">
...
<p>Please see <a href="https://www.npmjs.com/package/@types/swagger-jsdoc"><code>@types/swagger-jsdoc</code></a>. The package has been created and maintained by one of the original creators of <code>swagger-jsdoc</code> <a href="https://github.com/drGrove">drGrove</a>.</p>
<h2 id="the-library">The library</h2>
<p>It's currently written in Vanilla JavaScript compatible with Node.js 12 or higher. There are no compilation, transpilation or bundling steps. JSDoc comments and annotations have been maintained and published for intelligent editors.</p>
<p>No types definitions are managed or published from this repository.</p>
<h2 id="re-using-interfaces-from-source-code">Re-using interfaces from source code</h2>
<p><code>swagger-jsdoc</code> is only taking into account JSDoc comments and pure YAML files. The library does not work with source code at all: no reading, no parsing, no modifications.</p>
<p>For scenarios in which you want the source code to be taken into account in your specification, use an alternative such as <a href="https://github.com/lukeautry/tsoa"><code>tsoa</code></a>.</p>
