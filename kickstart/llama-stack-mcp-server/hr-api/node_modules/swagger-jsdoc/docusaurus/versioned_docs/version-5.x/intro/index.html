...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/swagger-jsdoc/docusaurus/versioned_docs/version-5.x/intro/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>Overview - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="Overview - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/swagger-jsdoc/docusaurus/versioned_docs/version-5.x/intro.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/swagger-jsdoc/docusaurus/versioned_docs/version-5.x/intro/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="Overview - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/swagger-jsdoc/docusaurus/versioned_docs/version-5.x/intro.png" >
  ...
  <a href="#goals" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Goals">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#webpack-integration" class="md-nav__link">
    <span class="md-ellipsis">
      Webpack integration
    </span>
  </a>
...
<p>Document your code and keep a live and reusable OpenAPI (Swagger) specification. This specification can be the core of your API-driven project: generate
documentation, servers, clients, tests and much more based on the rich <a href="http://swagger.io/">OpenAPI ecosystem of tools</a>.</p>
...
<p><strong>swagger-jsdoc</strong> enables you to integrate <a href="http://swagger.io">Swagger</a>
using <a href="https://jsdoc.app/"><code>JSDoc</code></a> comments in your code. Just add <code>@swagger</code> (or <code>@openapi</code>) on top of your DocBlock and declare the meaning of your code in YAML complying to the OpenAPI specification. If you prefer to keep some parts of your specification aside your code in order to keep it lighter/cleaner, you can also pass these parts as separate input YAML files.</p>
<p><code>swagger-jsdoc</code> will parse the above-mentioned and output an OpenAPI specification. You can use it to integrate any server and client technology as long as both sides comply with the specification.</p>
<p>Thus, the <code>swagger-jsdoc</code> project assumes that you want document your existing/living/working code in a way to "give life" to it, generating a specification which can then be fed into other Swagger tools, and not the vice-versa.</p>
<p>If you prefer to write the OpenAPI specification first and separately, you might check other projects facilitating this, such as</p>
<ul>
<li><a href="http://swagger.io/swagger-editor/">swagger-editor</a></li>
<li><a href="https://github.com/swagger-api/swagger-node">swagger-node</a></li>
</ul>
<h3 id="webpack-integration">Webpack integration</h3>
<p>You can use this package with a webpack plugin to keep your swagger documentation up-to-date when building your app:</p>
<ul>
<li><a href="https://github.com/patsimm/swagger-jsdoc-webpack-plugin">swagger-jsdoc-webpack-plugin</a> - Rebuild the swagger definition based on a predefined list of files on each webpack build.</li>
<li><a href="https://github.com/gautier-lefebvre/swagger-jsdoc-sync-webpack-plugin">swagger-jsdoc-sync-webpack-plugin</a> - Rebuild the swagger definition based on the files imported in your app on each webpack build.</li>
</ul>
...
<p>To make sure your end specification is valid, do read the most up-to date official <a href="https://github.com/OAI/OpenAPI-Specification">OpenAPI specification</a>.</p>
