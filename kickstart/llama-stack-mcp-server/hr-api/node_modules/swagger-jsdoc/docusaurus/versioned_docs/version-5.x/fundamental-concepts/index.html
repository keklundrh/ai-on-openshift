...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/swagger-jsdoc/docusaurus/versioned_docs/version-5.x/fundamental-concepts/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>Fundamental Concepts - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="Fundamental Concepts - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/swagger-jsdoc/docusaurus/versioned_docs/version-5.x/fundamental-concepts.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/swagger-jsdoc/docusaurus/versioned_docs/version-5.x/fundamental-concepts/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="Fundamental Concepts - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/swagger-jsdoc/docusaurus/versioned_docs/version-5.x/fundamental-concepts.png" >
    ...
    <div data-md-component="skip">
        ...
        <a href="#fundamental-concepts" class="md-skip">
          Skip to content
        </a>
...
<p>Before you start writing your specification and/or documentation, please keep in mind that there are two fundamental concepts you need to wrap your head around when working with <code>swagger-jsdoc</code> - definition object and input APIs.</p>
<p>Definition object maps to <a href="https://swagger.io/specification/#oasObject">OpenAPI object</a>. This is where you would add information about your API and any root-level properties. Definition object is a required parameter.</p>
<p>Input APIs are any files which you pass as arguments to the program in order to extract information about your API. For instance, these could be <code>.js</code> files with JSDoc comments or <code>.yaml</code> files directly. This parameter is also required.</p>
<p>There are a few ways by which you can pass these 2 required arguments:</p>
<p>When using the CLI:</p>
<ul>
<li>Through <code>apis</code> property in your definition object.</li>
<li>Through arguments</li>
</ul>
<p>When using the Node API:</p>
<ul>
<li>Through <code>apis</code> in your <code>options</code> object.</li>
</ul>
<p>For example, given the following module export for a definition object:</p>
<div class="highlight"><pre><span></span><code><span class="c1">// Taken from example/v2/swaggerDef.js</span>
...
<span class="w">    </span><span class="c1">// API informations (required)</span>
<span class="w">    </span><span class="nx">title</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;Hello World&#39;</span><span class="p">,</span><span class="w"> </span><span class="c1">// Title (required)</span>
<span class="w">    </span><span class="nx">version</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;1.0.0&#39;</span><span class="p">,</span><span class="w"> </span><span class="c1">// Version (required)</span>
<span class="w">    </span><span class="nx">description</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;A sample API&#39;</span><span class="p">,</span><span class="w"> </span><span class="c1">// Description (optional)</span>
<span class="w">  </span><span class="p">},</span>
<span class="w">  </span><span class="nx">host</span><span class="p">,</span><span class="w"> </span><span class="c1">// Host (optional)</span>
<span class="w">  </span><span class="nx">basePath</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;/&#39;</span><span class="p">,</span><span class="w"> </span><span class="c1">// Base path (optional)</span>
<span class="p">};</span>
</code></pre></div>
<p>One way you can make use of this definition is by using the CLI as following:</p>
<div class="highlight"><pre><span></span><code>$<span class="w"> </span>swagger-jsdoc<span class="w"> </span>-d<span class="w"> </span>example/v2/swaggerDef.js<span class="w"> </span>example/v2/route*.js
</code></pre></div>
<p>If you, however, want to skip the arguments and still use the CLI, you will need to update the definition object as following:</p>
<div class="highlight"><pre><span></span><code><span class="c1">// Taken from example/v2/swaggerDef.js</span>

<span class="nx">module</span><span class="p">.</span><span class="nx">exports</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="p">...</span>
<span class="w">  </span><span class="nx">apis</span><span class="o">:</span><span class="w"> </span><span class="p">[</span><span class="s1">&#39;example/v2/route*.js&#39;</span><span class="p">]</span><span class="w"> </span><span class="c1">// &lt;-- We add this property:</span>
<span class="w">  </span><span class="nx">basePath</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;/&#39;</span><span class="p">,</span><span class="w"> </span><span class="c1">// Base path (optional)</span>
<span class="p">};</span>
</code></pre></div>
<p>And then you will be able to use the CLI as following:</p>
<div class="highlight"><pre><span></span><code>$<span class="w"> </span>swagger-jsdoc<span class="w"> </span>-d<span class="w"> </span>example/v2/swaggerDef.js
</code></pre></div>
<p>When using the Node API, input APIs come in in the following way:</p>
<div class="highlight"><pre><span></span><code><span class="kd">const</span><span class="w"> </span><span class="nx">swaggerJSDoc</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;swagger-jsdoc&#39;</span><span class="p">);</span>

<span class="kd">const</span><span class="w"> </span><span class="nx">swaggerDefinition</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="p">...</span>
<span class="w">  </span><span class="nx">basePath</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;/&#39;</span><span class="p">,</span><span class="w"> </span><span class="c1">// Base path (optional)</span>
<span class="p">};</span>
...
<span class="w">  </span><span class="nx">swaggerDefinition</span><span class="p">,</span>
<span class="w">  </span><span class="nx">apis</span><span class="o">:</span><span class="w"> </span><span class="p">[</span><span class="s1">&#39;./example/v2/routes*.js&#39;</span><span class="p">],</span><span class="w"> </span><span class="c1">// &lt;-- not in the definition, but in the options</span>
<span class="p">};</span>
