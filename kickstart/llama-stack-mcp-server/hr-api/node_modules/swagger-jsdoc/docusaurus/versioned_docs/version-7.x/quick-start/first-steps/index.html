...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/swagger-jsdoc/docusaurus/versioned_docs/version-7.x/quick-start/first-steps/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>First Steps - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="First Steps - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/swagger-jsdoc/docusaurus/versioned_docs/version-7.x/quick-start/first-steps.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/swagger-jsdoc/docusaurus/versioned_docs/version-7.x/quick-start/first-steps/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="First Steps - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/swagger-jsdoc/docusaurus/versioned_docs/version-7.x/quick-start/first-steps.png" >
    ...
    <div data-md-component="skip">
        ...
        <a href="#specification-version" class="md-skip">
          Skip to content
        </a>
...
<nav class="md-nav md-nav--secondary" aria-label="Table of contents">
    ...
    <ul class="md-nav__list" data-md-component="toc" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#specification-version" class="md-nav__link">
    <span class="md-ellipsis">
      Specification version
        ...
        <li class="md-nav__item">
  <a href="#annotating-source-code" class="md-nav__link">
    <span class="md-ellipsis">
...
<h2 id="specification-version">Specification version</h2>
<p><code>swagger-jsdoc</code> was created in 2015. The OpenAPI as a concept did not exist, and thus the naming of the package itself.</p>
<p>The default target specification is 2.0. This provides backwards compatibility for many APIs written in the last couple of years.</p>
<p>In order to create a specification compatibile with 3.0 or higher, i.e. the so called OpenAPI, set this information in the <code>swaggerDefinition</code>:</p>
<div class="highlight"><pre><span></span><code>import swaggerJsdoc from &#39;swagger-jsdoc&#39;;

const options = {
<span class="w"> </span> definition: {
<span class="gi">+   openapi: &#39;3.0.0&#39;,</span>
<span class="w"> </span>   info: {
<span class="w"> </span>     title: &#39;Hello World&#39;,
<span class="w"> </span>     version: &#39;1.0.0&#39;,
<span class="w"> </span>   },
<span class="w"> </span> },
<span class="w"> </span> apis: [&#39;./src/routes*.js&#39;],
};

const openapiSpecification = await swaggerJsdoc(options);
</code></pre></div>
<h2 id="annotating-source-code">Annotating source code</h2>
<p>Place <code>@swagger</code> or <code>@openapi</code> on top of YAML-formatted specification parts:</p>
...
<span class="cm"> *         in: formData</span>
<span class="cm"> *         required: true</span>
<span class="cm"> *         type: string</span>
<span class="cm"> *       - name: password</span>
<span class="cm"> *         in: formData</span>
<span class="cm"> *         required: true</span>
<span class="cm"> *         type: string</span>
<span class="cm"> */</span>
...
<span class="w">  </span><span class="c1">// Your implementation comes here ...</span>
<span class="p">});</span>
</code></pre></div>
<h2 id="using-yaml">Using YAML</h2>
<p>It's possible to source parts of your specification through YAML files.</p>
<p>Imagine having a file <code>x-amazon-apigateway-integrations.yaml</code> with the following contents:</p>
<div class="highlight"><pre><span></span><code><span class="nt">x-amazon-apigateway-integrations</span><span class="p">:</span>
<span class="w">  </span><span class="nt">default-integration</span><span class="p">:</span><span class="w"> </span><span class="nl">&amp;default-integration</span>
...
<span class="w">    </span><span class="nt">x-amazon-apigateway-integration</span><span class="p">:</span>
...
<span class="w">      </span><span class="nt">passthroughBehavior</span><span class="p">:</span><span class="w"> </span><span class="l l-Scalar l-Scalar-Plain">when_no_match</span>
...
<span class="w">      </span><span class="nt">uri</span><span class="p">:</span><span class="w"> </span><span class="s">&#39;arn:aws:apigateway:us-east-1:lambda:path/2015-03-31/functions/arn:aws:lambda:us-east-1:123456789:function:helloworldlambda/invocations&#39;</span>
</code></pre></div>
<p>The following is an acceptable reference to information from <code>x-amazon-apigateway-integrations.yaml</code> when it's defined within the <code>apis</code> input array.</p>
<div class="highlight"><pre><span></span><code><span class="w">  </span><span class="cm">/**</span>
<span class="cm">   * @swagger</span>
<span class="cm">   * /aws:</span>
<span class="cm">   *   get:</span>
<span class="cm">   *     description: contains a reference outside this file</span>
<span class="cm">   *     x-amazon-apigateway-integration: *default-integration</span>
<span class="cm">   */</span>
<span class="w">  </span><span class="nx">app</span><span class="p">.</span><span class="nx">get</span><span class="p">(</span><span class="s1">&#39;/aws&#39;</span><span class="p">,</span><span class="w"> </span><span class="p">(</span><span class="nx">req</span><span class="p">,</span><span class="w"> </span><span class="nx">res</span><span class="p">)</span><span class="w"> </span><span class="p">=&gt;</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="c1">// Your implementation comes here ...</span>
<span class="w">  </span><span class="p">});</span>
<span class="p">};</span>
</code></pre></div>
<h2 id="further-resources">Further resources</h2>
<p>Additional materials to inspire you:</p>
<ul>
<li><a href="https://medium.com/geekculture/de-duping-the-duplication-in-services-featuring-swagger-openapi-and-ajv-abd22c8c764e">De-duping the Duplication in Services Featuring: Swagger/OpenAPI and AJV</a> - 09/03/2021</li>
<li><a href="https://js.plainenglish.io/how-to-implement-and-use-swagger-in-nodejs-d0b95e765245">How to implement and use Swagger in Node.js</a> - 24/02/2021</li>
<li><a href="https://dev.to/paulasantamaria/document-your-javascript-code-with-jsdoc-2fbf">Document your Javascript code with JSDoc</a> - 20/08/2019</li>
<li><a href="https://www.acuriousanimal.com/blog/2018/10/20/express-swagger-doc">Express API with autogenerated OpenAPI doc through Swagger</a> - 20/10/2018</li>
<li><a href="http://imaginativethinking.ca/swaggerize-your-api-documentation/">Swaggerize your API Documentation</a> - 01/06/2018</li>
<li><a href="https://mherman.org/blog/swagger-and-nodejs/">Swagger and NodeJS</a> 20/11/2017</li>
<li><a href="https://kalinchernev.github.io/agile-documentation-api-driven-project">Agile documentation for your API-driven project</a> - 21/01/2017</li>
</ul>
<p>Suggestions for extending this helpful list are welcome! <a href="https://github.com/Surnet/swagger-jsdoc/issues/new">Submit your article</a></p>
<h2 id="examples">Examples</h2>
<p>Here's a list of example public open-source usages of the package:</p>
<ul>
<li><a href="https://github.com/godaddy/gasket">godaddy/gasket</a></li>
<li><a href="https://github.com/godaddy/warehouse.ai-status-api">godaddy/warehouse.ai-status-api</a></li>
<li><a href="https://github.com/SAP-samples/hana-developer-cli-tool-example">hana-developer-cli-tool-example</a></li>
<li><a href="https://github.com/studiohyperdrive/api-docs">studiohyperdrive/api-docs</a></li>
<li><a href="https://github.com/Surnet/swagger-jsdoc/tree/v7/examples">More Examples</a></li>
</ul>
<h2 id="related-projects">Related projects</h2>
<ul>
<li><a href="https://github.com/godaddy/swagger-jsdoc-deref">godaddy/swagger-jsdoc-deref</a></li>
<li><a href="https://github.com/slanatech/swagger-stats">slanatech/swagger-stats</a></li>
<li><a href="https://github.com/weseek/growi">weseek/growi</a></li>
<li><a href="https://github.com/linagora/openpaas-esn">linagora/openpaas-esn</a></li>
<li><a href="https://github.com/Tiemma/sonic-express">Tiemma/sonic-express</a></li>
<li><a href="https://github.com/kevoj/nodetomic-api-swagger">kevoj/nodetomic-api-swagger</a></li>
<li><a href="https://github.com/hagopj13/node-express-mongoose-boilerplate">node-express-mongoose-boilerplate</a></li>
</ul>
