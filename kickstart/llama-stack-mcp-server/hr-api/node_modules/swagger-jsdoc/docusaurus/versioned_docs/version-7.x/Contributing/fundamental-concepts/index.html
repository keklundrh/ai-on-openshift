...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/swagger-jsdoc/docusaurus/versioned_docs/version-7.x/Contributing/fundamental-concepts/">
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/swagger-jsdoc/docusaurus/versioned_docs/version-7.x/Contributing/fundamental-concepts.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/swagger-jsdoc/docusaurus/versioned_docs/version-7.x/Contributing/fundamental-concepts/" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/swagger-jsdoc/docusaurus/versioned_docs/version-7.x/Contributing/fundamental-concepts.png" >
...
<nav class="md-nav md-nav--secondary" aria-label="Table of contents">
    ...
    <ul class="md-nav__list" data-md-component="toc" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#definition-and-apis" class="md-nav__link">
    <span class="md-ellipsis">
      Definition and apis
    </span>
  </a>
        ...
        <li class="md-nav__item">
  <a href="#file-selection-patterns" class="md-nav__link">
    <span class="md-ellipsis">
...
<p>Please pay attention to the following shared information as it's based on recurring questions from the issue queue. Reading the following paragraphs carefully will save your time for the fun part: creating your API.</p>
<h2 id="definition-and-apis">Definition and <code>apis</code></h2>
<p>There are two fundamental concepts in <code>swagger-jsdoc</code> - definition object and input APIs.</p>
<p>The definition object maps to <a href="https://swagger.io/specification/#oasObject">OpenAPI object</a> and the input APIs are split source code parts which form the end specification.</p>
<p>Parts of the specification can be placed in annotated JSDoc comments in non-compiled logical files. These specification parts stand close to their implementation.</p>
<p>Other parts of the specification can be directly written in YAML files. These are usually parts containing static definitions which are referenced from jsDoc comments parameters, components, anchors, etc. which are not so relevant to the API implementation.</p>
<p>Given the following definition <code>swaggerDefinition.cjs</code>:</p>
...
<span class="w">    </span><span class="nx">description</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;A sample API&#39;</span><span class="p">,</span>
<span class="w">  </span><span class="p">},</span>
<span class="p">};</span>
</code></pre></div>
<p>The end <code>swaggerSpecification</code> will be a result of following:</p>
...
<span class="kd">const</span><span class="w"> </span><span class="nx">swaggerDefinition</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;./swaggerDefinition&#39;</span><span class="p">);</span>
...
<span class="kd">const</span><span class="w"> </span><span class="nx">swaggerSpecification</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">swaggerJsdoc</span><span class="p">(</span><span class="nx">options</span><span class="p">);</span>
</code></pre></div>
<h2 id="file-selection-patterns">File selection patterns</h2>
<p><code>swagger-jsdoc</code> uses <a href="https://github.com/isaacs/node-glob">node glob</a> for discovering your input files. You can use patterns such as <code>*.js</code> to select all javascript files or <code>**/*.js</code> to select all javascript files in sub-folders recursively.</p>
<p>Paths are relative to the current working directory.</p>
<p><a href="https://github.com/Surnet/swagger-jsdoc/tree/v6/test">Tests</a></p>
