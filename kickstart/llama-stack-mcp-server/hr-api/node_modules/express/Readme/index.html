...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/express/Readme/">
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/express/Readme.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/express/Readme/" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/express/Readme.png" >
...
<div class="highlight"><pre><span></span><code><span class="gp">$ </span>npm<span class="w"> </span>install<span class="w"> </span>express
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="gp">$ </span>npm<span class="w"> </span>install<span class="w"> </span>-g<span class="w"> </span>express-generator@4
</code></pre></div>
<p>Create the app:</p>
<div class="highlight"><pre><span></span><code><span class="gp">$ </span>express<span class="w"> </span>/tmp/foo<span class="w"> </span><span class="o">&amp;&amp;</span><span class="w"> </span><span class="nb">cd</span><span class="w"> </span>/tmp/foo
</code></pre></div>
<p>Install dependencies:</p>
<div class="highlight"><pre><span></span><code><span class="gp">$ </span>npm<span class="w"> </span>install
</code></pre></div>
<p>Start the server:</p>
<div class="highlight"><pre><span></span><code><span class="gp">$ </span>npm<span class="w"> </span>start
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="gp">$ </span>git<span class="w"> </span>clone<span class="w"> </span>https://github.com/expressjs/express.git<span class="w"> </span>--depth<span class="w"> </span><span class="m">1</span>
<span class="gp">$ </span><span class="nb">cd</span><span class="w"> </span>express
<span class="gp">$ </span>npm<span class="w"> </span>install
</code></pre></div>
<p>Then run whichever example you want:</p>
<div class="highlight"><pre><span></span><code><span class="gp">$ </span>node<span class="w"> </span>examples/content-negotiation
</code></pre></div>
...
<h3 id="tc-technical-committee">TC (Technical Committee)</h3>
<ul>
