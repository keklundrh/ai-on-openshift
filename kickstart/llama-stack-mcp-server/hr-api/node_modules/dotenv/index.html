...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/dotenv/">
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/dotenv/README.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/dotenv/" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/dotenv/README.png" >
...
<nav class="md-nav md-nav--secondary" aria-label="Table of contents">
  ...
  <a href="#usage" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="🏗️ Usage">
  ...
  <a href="#deploying" class="md-nav__link">
    <span class="md-ellipsis">
      Deploying
        ...
        <li class="md-nav__item">
  <a href="#manage-multiple-environments" class="md-nav__link">
    <span class="md-ellipsis">
      🌴 Manage Multiple Environments
        ...
        <li class="md-nav__item">
  <a href="#deploying_1" class="md-nav__link">
    <span class="md-ellipsis">
      🚀 Deploying
    </span>
  </a>
  ...
  <a href="#override" class="md-nav__link">
    <span class="md-ellipsis">
      override
          ...
          <li class="md-nav__item">
  <a href="#processenv" class="md-nav__link">
    <span class="md-ellipsis">
      processEnv
    </span>
  </a>
  ...
  <a href="#options_1" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Options">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#debug_1" class="md-nav__link">
    <span class="md-ellipsis">
      debug
    </span>
  </a>
  ...
  <a href="#populate" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="Populate">
      <ul class="md-nav__list">
  ...
  <a href="#options_2" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="options">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#debug_2" class="md-nav__link">
    <span class="md-ellipsis">
      Debug
    </span>
  </a>
          ...
          <li class="md-nav__item">
  <a href="#override_1" class="md-nav__link">
    <span class="md-ellipsis">
      override
    </span>
  </a>
  ...
  <a href="#faq" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="❓ FAQ">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#why-is-the-env-file-not-loading-my-environment-variables-successfully" class="md-nav__link">
    <span class="md-ellipsis">
      Why is the .env file not loading my environment variables successfully?
          ...
          <li class="md-nav__item">
  <a href="#should-i-commit-my-env-file" class="md-nav__link">
    <span class="md-ellipsis">
      Should I commit my .env file?
          ...
          <li class="md-nav__item">
  <a href="#should-i-have-multiple-env-files" class="md-nav__link">
    <span class="md-ellipsis">
      Should I have multiple .env files?
          ...
          <li class="md-nav__item">
  <a href="#what-rules-does-the-parsing-engine-follow" class="md-nav__link">
    <span class="md-ellipsis">
      What rules does the parsing engine follow?
          ...
          <li class="md-nav__item">
  <a href="#what-happens-to-environment-variables-that-were-already-set" class="md-nav__link">
    <span class="md-ellipsis">
      What happens to environment variables that were already set?
          ...
          <li class="md-nav__item">
  <a href="#how-come-my-environment-variables-are-not-showing-up-for-react" class="md-nav__link">
    <span class="md-ellipsis">
      How come my environment variables are not showing up for React?
          ...
          <li class="md-nav__item">
  <a href="#can-i-customizewrite-plugins-for-dotenv" class="md-nav__link">
    <span class="md-ellipsis">
      Can I customize/write plugins for dotenv?
          ...
          <li class="md-nav__item">
  <a href="#how-do-i-use-dotenv-with-import" class="md-nav__link">
    <span class="md-ellipsis">
      How do I use dotenv with import?
          ...
          <li class="md-nav__item">
  <a href="#why-am-i-getting-the-error-module-not-found-error-cant-resolve-cryptoospath" class="md-nav__link">
    <span class="md-ellipsis">
      Why am I getting the error Module not found: Error: Can't resolve 'crypto|os|path'?
          ...
          <li class="md-nav__item">
  <a href="#what-about-variable-expansion" class="md-nav__link">
    <span class="md-ellipsis">
      What about variable expansion?
          ...
          <li class="md-nav__item">
  <a href="#what-about-syncing-and-securing-env-files" class="md-nav__link">
    <span class="md-ellipsis">
      What about syncing and securing .env files?
          ...
          <li class="md-nav__item">
  <a href="#what-if-i-accidentally-commit-my-env-file-to-code" class="md-nav__link">
    <span class="md-ellipsis">
      What if I accidentally commit my .env file to code?
          ...
          <li class="md-nav__item">
  <a href="#how-can-i-prevent-committing-my-env-file-to-a-docker-build" class="md-nav__link">
    <span class="md-ellipsis">
  ...
  <a href="#changelog" class="md-nav__link">
    <span class="md-ellipsis">
      CHANGELOG
        ...
        <li class="md-nav__item">
  <a href="#whos-using-dotenv" class="md-nav__link">
    <span class="md-ellipsis">
      Who's using dotenv?
    </span>
  </a>
...
<a href="LICENSE"><img alt="LICENSE" src="https://img.shields.io/github/license/motdotla/dotenv.svg" /></a>
<a href="https://codecov.io/gh/motdotla/dotenv-expand"><img alt="codecov" src="https://codecov.io/gh/motdotla/dotenv-expand/graph/badge.svg?token=pawWEyaMfg" /></a></p>
<ul>
<li><a href="#-install">🌱 Install</a></li>
<li><a href="#%EF%B8%8F-usage">🏗️ Usage (.env)</a></li>
<li><a href="#-manage-multiple-environments">🌴 Multiple Environments 🆕</a></li>
<li><a href="#-deploying">🚀 Deploying (encryption) 🆕</a></li>
<li><a href="#-examples">📚 Examples</a></li>
<li><a href="#-documentation">📖 Docs</a></li>
<li><a href="#-faq">❓ FAQ</a></li>
<li><a href="CHANGELOG/">⏱️ Changelog</a></li>
</ul>
<h2 id="install">🌱 Install</h2>
<div class="highlight"><pre><span></span><code>npm<span class="w"> </span>install<span class="w"> </span>dotenv<span class="w"> </span>--save
</code></pre></div>
<p>You can also use an npm-compatible package manager like yarn or bun:</p>
<div class="highlight"><pre><span></span><code>yarn<span class="w"> </span>add<span class="w"> </span>dotenv
<span class="c1"># or</span>
bun<span class="w"> </span>add<span class="w"> </span>dotenv
</code></pre></div>
<h2 id="usage">🏗️ Usage</h2>
<p><a href="https://www.youtube.com/watch?v=YtkZR0NFd1g"></p>
<div align="right">
<img src="https://img.youtube.com/vi/YtkZR0NFd1g/hqdefault.jpg" alt="how to use dotenv video tutorial" align="right" width="330" />
<img src="https://simpleicons.vercel.app/youtube/ff0000" alt="youtube/@dotenvorg" align="right" width="24" />
</div>
<p></a></p>
<p>Create a <code>.env</code> file in the root of your project (if using a monorepo structure like <code>apps/backend/app.js</code>, put it in the root of the folder where your <code>app.js</code> process runs):</p>
...
<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">process</span><span class="p">.</span><span class="nx">env</span><span class="p">)</span><span class="w"> </span><span class="c1">// remove this after you&#39;ve confirmed it is working</span>
</code></pre></div>
<p>.. <a href="#how-do-i-use-dotenv-with-import">or using ES6?</a></p>
<div class="highlight"><pre><span></span><code><span class="k">import</span><span class="w"> </span><span class="s1">&#39;dotenv/config&#39;</span>
</code></pre></div>
<p>That's it. <code>process.env</code> now has the keys and values you defined in your <code>.env</code> file:</p>
<div class="highlight"><pre><span></span><code><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;dotenv&#39;</span><span class="p">).</span><span class="nx">config</span><span class="p">()</span>
<span class="c1">// or import &#39;dotenv/config&#39; if you&#39;re using ES6</span>
...
<span class="kd">const</span><span class="w"> </span><span class="nx">buf</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">Buffer</span><span class="p">.</span><span class="kr">from</span><span class="p">(</span><span class="s1">&#39;BASIC=basic&#39;</span><span class="p">)</span>
<span class="kd">const</span><span class="w"> </span><span class="nx">config</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">dotenv</span><span class="p">.</span><span class="nx">parse</span><span class="p">(</span><span class="nx">buf</span><span class="p">)</span><span class="w"> </span><span class="c1">// will return an object</span>
<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="ow">typeof</span><span class="w"> </span><span class="nx">config</span><span class="p">,</span><span class="w"> </span><span class="nx">config</span><span class="p">)</span><span class="w"> </span><span class="c1">// object { BASIC : &#39;basic&#39; }</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code>$<span class="w"> </span>node<span class="w"> </span>-r<span class="w"> </span>dotenv/config<span class="w"> </span>your_script.js
</code></pre></div>
...
<div class="highlight"><pre><span></span><code>$<span class="w"> </span>DOTENV_CONFIG_&lt;OPTION&gt;<span class="o">=</span>value<span class="w"> </span>node<span class="w"> </span>-r<span class="w"> </span>dotenv/config<span class="w"> </span>your_script.js
</code></pre></div>
...
<p>Use <a href="https://github.com/dotenvx/dotenvx">dotenvx</a> to use command substitution.</p>
<p>Add the output of a command to one of your variables in your .env file.</p>
<p><div class="highlight"><pre><span></span><code><span class="c1"># .env</span>
<span class="na">DATABASE_URL</span><span class="o">=</span><span class="s">&quot;postgres://$(whoami)@localhost/my_database&quot;</span>
</code></pre></div>
<div class="highlight"><pre><span></span><code><span class="c1">// index.js</span>
<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="s1">&#39;DATABASE_URL&#39;</span><span class="p">,</span><span class="w"> </span><span class="nx">process</span><span class="p">.</span><span class="nx">env</span><span class="p">.</span><span class="nx">DATABASE_URL</span><span class="p">)</span>
</code></pre></div>
<div class="highlight"><pre><span></span><code>$<span class="w"> </span>dotenvx<span class="w"> </span>run<span class="w"> </span>--debug<span class="w"> </span>--<span class="w"> </span>node<span class="w"> </span>index.js
<span class="o">[</span>dotenvx@0.14.1<span class="o">]</span><span class="w"> </span>injecting<span class="w"> </span>env<span class="w"> </span><span class="o">(</span><span class="m">1</span><span class="o">)</span><span class="w"> </span>from<span class="w"> </span>.env
DATABASE_URL<span class="w"> </span>postgres://yourusername@localhost/my_database
</code></pre></div></p>
<h3 id="syncing">Syncing</h3>
<p>You need to keep <code>.env</code> files in sync between machines, environments, or team members? Use <a href="https://github.com/dotenvx/dotenvx">dotenvx</a> to encrypt your <code>.env</code> files and safely include them in source control. This still subscribes to the twelve-factor app rules by generating a decryption key separate from code.</p>
<h3 id="multiple-environments">Multiple Environments</h3>
<p>Use <a href="https://github.com/dotenvx/dotenvx">dotenvx</a> to generate <code>.env.ci</code>, <code>.env.production</code> files, and more.</p>
<h3 id="deploying">Deploying</h3>
<p>You need to deploy your secrets in a cloud-agnostic manner? Use <a href="https://github.com/dotenvx/dotenvx">dotenvx</a> to generate a private decryption key that is set on your production server.</p>
<h2 id="manage-multiple-environments">🌴 Manage Multiple Environments</h2>
<p>Use <a href="https://github.com/dotenvx/dotenvx">dotenvx</a></p>
...
<div class="highlight"><pre><span></span><code>$<span class="w"> </span><span class="nb">echo</span><span class="w"> </span><span class="s2">&quot;HELLO=production&quot;</span><span class="w"> </span>&gt;<span class="w"> </span>.env.production
$<span class="w"> </span><span class="nb">echo</span><span class="w"> </span><span class="s2">&quot;console.log(&#39;Hello &#39; + process.env.HELLO)&quot;</span><span class="w"> </span>&gt;<span class="w"> </span>index.js

$<span class="w"> </span>dotenvx<span class="w"> </span>run<span class="w"> </span>--env-file<span class="o">=</span>.env.production<span class="w"> </span>--<span class="w"> </span>node<span class="w"> </span>index.js
Hello<span class="w"> </span>production
&gt;<span class="w"> </span>^^
</code></pre></div>
<p>or with multiple .env files</p>
<div class="highlight"><pre><span></span><code>$<span class="w"> </span><span class="nb">echo</span><span class="w"> </span><span class="s2">&quot;HELLO=local&quot;</span><span class="w"> </span>&gt;<span class="w"> </span>.env.local
$<span class="w"> </span><span class="nb">echo</span><span class="w"> </span><span class="s2">&quot;HELLO=World&quot;</span><span class="w"> </span>&gt;<span class="w"> </span>.env
$<span class="w"> </span><span class="nb">echo</span><span class="w"> </span><span class="s2">&quot;console.log(&#39;Hello &#39; + process.env.HELLO)&quot;</span><span class="w"> </span>&gt;<span class="w"> </span>index.js

$<span class="w"> </span>dotenvx<span class="w"> </span>run<span class="w"> </span>--env-file<span class="o">=</span>.env.local<span class="w"> </span>--env-file<span class="o">=</span>.env<span class="w"> </span>--<span class="w"> </span>node<span class="w"> </span>index.js
Hello<span class="w"> </span><span class="nb">local</span>
</code></pre></div>
<p><a href="https://dotenvx.com/docs/quickstart/environments">more environment examples</a></p>
<h2 id="deploying_1">🚀 Deploying</h2>
<p>Use <a href="https://github.com/dotenvx/dotenvx">dotenvx</a>.</p>
<p>Add encryption to your <code>.env</code> files with a single command. Pass the <code>--encrypt</code> flag.</p>
<div class="highlight"><pre><span></span><code>$ dotenvx set HELLO Production --encrypt -f .env.production
...
and return an Object with a <code>parsed</code> key containing the loaded content or an <code>error</code> key if it failed.</p>
...
<div class="highlight"><pre><span></span><code><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;dotenv&#39;</span><span class="p">).</span><span class="nx">config</span><span class="p">({</span><span class="w"> </span><span class="nx">path</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;/custom/path/to/.env&#39;</span><span class="w"> </span><span class="p">})</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;dotenv&#39;</span><span class="p">).</span><span class="nx">config</span><span class="p">({</span><span class="w"> </span><span class="nx">path</span><span class="o">:</span><span class="w"> </span><span class="p">[</span><span class="s1">&#39;.env.local&#39;</span><span class="p">,</span><span class="w"> </span><span class="s1">&#39;.env&#39;</span><span class="p">]</span><span class="w"> </span><span class="p">})</span>
</code></pre></div>
...
<p>Specify an object to write your environment variables to. Defaults to <code>process.env</code> environment variables.</p>
...
<span class="nx">require</span><span class="p">(</span><span class="s1">&#39;dotenv&#39;</span><span class="p">).</span><span class="nx">config</span><span class="p">({</span><span class="w"> </span><span class="nx">processEnv</span><span class="o">:</span><span class="w"> </span><span class="nx">myObject</span><span class="w"> </span><span class="p">})</span>

<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">myObject</span><span class="p">)</span><span class="w"> </span><span class="c1">// values from .env</span>
<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">process</span><span class="p">.</span><span class="nx">env</span><span class="p">)</span><span class="w"> </span><span class="c1">// this was not changed or written to</span>
</code></pre></div>
...
<h5 id="debug_1">debug</h5>
<p>Default: <code>false</code></p>
<p>Turn on logging to help debug why certain keys or values are not being set as you expect.</p>
<div class="highlight"><pre><span></span><code><span class="kd">const</span><span class="w"> </span><span class="nx">dotenv</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;dotenv&#39;</span><span class="p">)</span>
<span class="kd">const</span><span class="w"> </span><span class="nx">buf</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">Buffer</span><span class="p">.</span><span class="kr">from</span><span class="p">(</span><span class="s1">&#39;hello world&#39;</span><span class="p">)</span>
...
<div class="highlight"><pre><span></span><code><span class="kd">const</span><span class="w"> </span><span class="nx">dotenv</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;dotenv&#39;</span><span class="p">)</span>
<span class="kd">const</span><span class="w"> </span><span class="nx">parsed</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">HELLO</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;world&#39;</span><span class="w"> </span><span class="p">}</span>

<span class="nx">dotenv</span><span class="p">.</span><span class="nx">populate</span><span class="p">(</span><span class="nx">process</span><span class="p">.</span><span class="nx">env</span><span class="p">,</span><span class="w"> </span><span class="nx">parsed</span><span class="p">)</span>

<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">process</span><span class="p">.</span><span class="nx">env</span><span class="p">.</span><span class="nx">HELLO</span><span class="p">)</span><span class="w"> </span><span class="c1">// world</span>
</code></pre></div>
<p>For example, customizing the source AND target:</p>
<div class="highlight"><pre><span></span><code><span class="kd">const</span><span class="w"> </span><span class="nx">dotenv</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;dotenv&#39;</span><span class="p">)</span>
<span class="kd">const</span><span class="w"> </span><span class="nx">parsed</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">HELLO</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;universe&#39;</span><span class="w"> </span><span class="p">}</span>
<span class="kd">const</span><span class="w"> </span><span class="nx">target</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">HELLO</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;world&#39;</span><span class="w"> </span><span class="p">}</span><span class="w"> </span><span class="c1">// empty object</span>

<span class="nx">dotenv</span><span class="p">.</span><span class="nx">populate</span><span class="p">(</span><span class="nx">target</span><span class="p">,</span><span class="w"> </span><span class="nx">parsed</span><span class="p">,</span><span class="w"> </span><span class="p">{</span><span class="w"> </span><span class="nx">override</span><span class="o">:</span><span class="w"> </span><span class="kc">true</span><span class="p">,</span><span class="w"> </span><span class="nx">debug</span><span class="o">:</span><span class="w"> </span><span class="kc">true</span><span class="w"> </span><span class="p">})</span>

<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">target</span><span class="p">)</span><span class="w"> </span><span class="c1">// { HELLO: &#39;universe&#39; }</span>
</code></pre></div>
<h4 id="options_2">options</h4>
<h5 id="debug_2">Debug</h5>
<p>Default: <code>false</code></p>
<p>Turn on logging to help debug why certain keys or values are not being populated as you expect.</p>
<h5 id="override_1">override</h5>
<p>Default: <code>false</code></p>
...
<div class="highlight"><pre><span></span><code>{MULTILINE: &#39;new
line&#39;}
</code></pre></div>
<ul>
...
<span class="kd">const</span><span class="w"> </span><span class="nx">myEnv</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">dotenv</span><span class="p">.</span><span class="nx">config</span><span class="p">()</span>
...
<span class="k">import</span><span class="w"> </span><span class="s1">&#39;dotenv/config&#39;</span><span class="w"> </span><span class="c1">// see https://github.com/motdotla/dotenv#how-do-i-use-dotenv-with-import</span>
...
<p><code>errorReporter.mjs</code>:
<div class="highlight"><pre><span></span><code><span class="kd">class</span><span class="w"> </span><span class="nx">Client</span><span class="w"> </span><span class="p">{</span>
<span class="w">  </span><span class="kr">constructor</span><span class="w"> </span><span class="p">(</span><span class="nx">apiKey</span><span class="p">)</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="s1">&#39;apiKey&#39;</span><span class="p">,</span><span class="w"> </span><span class="nx">apiKey</span><span class="p">)</span>

<span class="w">    </span><span class="k">this</span><span class="p">.</span><span class="nx">apiKey</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">apiKey</span>
<span class="w">  </span><span class="p">}</span>
<span class="p">}</span>

<span class="k">export</span><span class="w"> </span><span class="k">default</span><span class="w"> </span><span class="ow">new</span><span class="w"> </span><span class="nx">Client</span><span class="p">(</span><span class="nx">process</span><span class="p">.</span><span class="nx">env</span><span class="p">.</span><span class="nx">API_KEY</span><span class="p">)</span>
</code></pre></div>
<code>index.mjs</code>:
<div class="highlight"><pre><span></span><code><span class="c1">// Note: this is INCORRECT and will not work</span>
...
<span class="k">import</span><span class="w"> </span><span class="nx">errorReporter</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s1">&#39;./errorReporter.mjs&#39;</span><span class="w"> </span><span class="c1">// process.env.API_KEY will be blank!</span>
</code></pre></div></p>
<p><code>process.env.API_KEY</code> will be blank.</p>
<p>Instead, <code>index.mjs</code> should be written as..</p>
<div class="highlight"><pre><span></span><code><span class="k">import</span><span class="w"> </span><span class="s1">&#39;dotenv/config&#39;</span>

<span class="k">import</span><span class="w"> </span><span class="nx">errorReporter</span><span class="w"> </span><span class="kr">from</span><span class="w"> </span><span class="s1">&#39;./errorReporter.mjs&#39;</span>
</code></pre></div>
...
<div class="highlight"><pre><span></span><code>npm<span class="w"> </span>install<span class="w"> </span>node-polyfill-webpack-plugin
</code></pre></div>
...
<span class="kd">const</span><span class="w"> </span><span class="nx">NodePolyfillPlugin</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;node-polyfill-webpack-plugin&#39;</span><span class="p">)</span>
...
<span class="w">  </span><span class="nx">entry</span><span class="o">:</span><span class="w"> </span><span class="s1">&#39;./src/index.ts&#39;</span><span class="p">,</span>
...
<span class="w">    </span><span class="ow">new</span><span class="w"> </span><span class="nx">NodePolyfillPlugin</span><span class="p">(),</span>
...
<span class="w">        </span><span class="nx">HELLO</span><span class="o">:</span><span class="w"> </span><span class="nb">JSON</span><span class="p">.</span><span class="nx">stringify</span><span class="p">(</span><span class="nx">process</span><span class="p">.</span><span class="nx">env</span><span class="p">.</span><span class="nx">HELLO</span><span class="p">)</span>
<span class="w">      </span><span class="p">}</span>
<span class="w">    </span><span class="p">}),</span>
<span class="w">  </span><span class="p">]</span>
<span class="p">};</span>
...
<div class="highlight"><pre><span></span><code>brew install dotenvx/brew/dotenvx
...
<div class="highlight"><pre><span></span><code><span class="c1"># Dockerfile</span>
...
RUN<span class="w"> </span>curl<span class="w"> </span>-fsS<span class="w"> </span>https://dotenvx.sh/<span class="w"> </span><span class="p">|</span><span class="w"> </span>sh
...
RUN<span class="w"> </span>dotenvx<span class="w"> </span>prebuild
CMD<span class="w"> </span><span class="o">[</span><span class="s2">&quot;dotenvx&quot;</span>,<span class="w"> </span><span class="s2">&quot;run&quot;</span>,<span class="w"> </span><span class="s2">&quot;--&quot;</span>,<span class="w"> </span><span class="s2">&quot;node&quot;</span>,<span class="w"> </span><span class="s2">&quot;index.js&quot;</span><span class="o">]</span>
</code></pre></div>
<h2 id="contributing-guide">Contributing Guide</h2>
<p>See <a href="CONTRIBUTING.md">CONTRIBUTING.md</a></p>
<h2 id="changelog">CHANGELOG</h2>
<p>See <a href="CHANGELOG/">CHANGELOG.md</a></p>
