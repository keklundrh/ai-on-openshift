...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/npm-run-path/readme/">
      ...
      <meta name="generator" content="mkdocs-1.6.1, mkdocs-material-9.5.50">
        ...
        <title>npm-run-path Build Status - AI on OpenShift</title>
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:title"  content="npm-run-path Build Status - AI on OpenShift" >
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/npm-run-path/readme.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/npm-run-path/readme/" >
      
        <meta  name="twitter:card"  content="summary_large_image" >
      
        <meta  name="twitter:title"  content="npm-run-path Build Status - AI on OpenShift" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/npm-run-path/readme.png" >
    ...
    <div data-md-component="skip">
        ...
        <a href="#npm-run-path" class="md-skip">
          Skip to content
        </a>
  ...
  <a href="#api" class="md-nav__link">
    ...
    <nav class="md-nav" aria-label="API">
      <ul class="md-nav__list">
          ...
          <li class="md-nav__item">
  <a href="#npmrunpathoptions" class="md-nav__link">
    <span class="md-ellipsis">
      npmRunPath(options?)
    </span>
  </a>
  
    <nav class="md-nav" aria-label="npmRunPath(options?)">
      <ul class="md-nav__list">
  ...
  <a href="#execpath" class="md-nav__link">
    <span class="md-ellipsis">
      execPath
          ...
          <li class="md-nav__item">
  <a href="#npmrunpathenvoptions" class="md-nav__link">
    <span class="md-ellipsis">
      npmRunPath.env(options?)
    </span>
  </a>
  
    <nav class="md-nav" aria-label="npmRunPath.env(options?)">
      <ul class="md-nav__list">
  ...
  <a href="#env" class="md-nav__link">
    <span class="md-ellipsis">
      env
          ...
          <li class="md-nav__item">
  <a href="#execpath_1" class="md-nav__link">
    <span class="md-ellipsis">
      execPath
    </span>
  </a>
...
<h1 id="npm-run-path">npm-run-path <a href="https://travis-ci.org/sindresorhus/npm-run-path"><img alt="Build Status" src="https://travis-ci.org/sindresorhus/npm-run-path.svg?branch=master" /></a></h1>
<blockquote>
...
<div class="highlight"><pre><span></span><code>$ npm install npm-run-path
</code></pre></div>
<h2 id="usage">Usage</h2>
<div class="highlight"><pre><span></span><code><span class="kd">const</span><span class="w"> </span><span class="nx">childProcess</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;child_process&#39;</span><span class="p">);</span>
<span class="kd">const</span><span class="w"> </span><span class="nx">npmRunPath</span><span class="w"> </span><span class="o">=</span><span class="w"> </span><span class="nx">require</span><span class="p">(</span><span class="s1">&#39;npm-run-path&#39;</span><span class="p">);</span>

<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">process</span><span class="p">.</span><span class="nx">env</span><span class="p">.</span><span class="nx">PATH</span><span class="p">);</span>
<span class="c1">//=&gt; &#39;/usr/local/bin&#39;</span>

<span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="nx">npmRunPath</span><span class="p">());</span>
<span class="c1">//=&gt; &#39;/Users/sindresorhus/dev/foo/node_modules/.bin:/Users/sindresorhus/dev/node_modules/.bin:/Users/sindresorhus/node_modules/.bin:/Users/node_modules/.bin:/node_modules/.bin:/usr/local/bin&#39;</span>

<span class="c1">// `foo` is a locally installed binary</span>
<span class="nx">childProcess</span><span class="p">.</span><span class="nx">execFileSync</span><span class="p">(</span><span class="s1">&#39;foo&#39;</span><span class="p">,</span><span class="w"> </span><span class="p">{</span>
<span class="w">    </span><span class="nx">env</span><span class="o">:</span><span class="w"> </span><span class="nx">npmRunPath</span><span class="p">.</span><span class="nx">env</span><span class="p">()</span>
<span class="p">});</span>
</code></pre></div>
<h2 id="api">API</h2>
<h3 id="npmrunpathoptions">npmRunPath(options?)</h3>
<p>Returns the augmented path string.</p>
...
<h5 id="execpath">execPath</h5>
<p>Type: <code>string</code><br>
Default: <code>process.execPath</code></p>
<p>Path to the current Node.js executable. Its directory is pushed to the front of PATH.</p>
<p>This can be either an absolute path or a path relative to the <a href="#cwd"><code>cwd</code> option</a>.</p>
<h3 id="npmrunpathenvoptions">npmRunPath.env(options?)</h3>
<p>Returns the augmented <a href="https://nodejs.org/api/process.html#process_process_env"><code>process.env</code></a> object.</p>
...
<h5 id="execpath_1">execPath</h5>
<p>Type: <code>string</code><br>
Default: <code>process.execPath</code></p>
<p>Path to the Node.js executable to use in child processes if that is different from the current one. Its directory is pushed to the front of PATH.</p>
<p>This can be either an absolute path or a path relative to the <a href="#cwd"><code>cwd</code> option</a>.</p>
