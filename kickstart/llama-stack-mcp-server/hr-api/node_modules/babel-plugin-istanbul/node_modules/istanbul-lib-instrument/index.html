...
<html lang="en" class="no-js">
  <head>
      ...
      <meta name="viewport" content="width=device-width,initial-scale=1">
        ...
        <link rel="canonical" href="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/babel-plugin-istanbul/node_modules/istanbul-lib-instrument/">
...
<script id="__analytics">function __md_analytics(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config","G-EXFP0W7LTY"),document.addEventListener("DOMContentLoaded",(function(){document.forms.search&&document.forms.search.query.addEventListener("blur",(function(){this.value&&e("event","search",{search_term:this.value})}));document$.subscribe((function(){var t=document.forms.feedback;if(void 0!==t)for(var a of t.querySelectorAll("[type=submit]"))a.addEventListener("click",(function(a){a.preventDefault();var n=document.location.pathname,d=this.getAttribute("data-md-value");e("event","feedback",{page:n,data:d}),t.firstElementChild.disabled=!0;var r=t.querySelector(".md-feedback__note [data-md-value='"+d+"']");r&&(r.hidden=!1)})),t.hidden=!1})),location$.subscribe((function(t){e("config","G-EXFP0W7LTY",{page_path:t.pathname})}))}));var t=document.createElement("script");t.async=!0,t.src="https://www.googletagmanager.com/gtag/js?id=G-EXFP0W7LTY",document.getElementById("__analytics").insertAdjacentElement("afterEnd",t)}</script>
    ...
    <script>if("undefined"!=typeof __md_analytics){var consent=__md_get("__consent");consent&&consent.analytics&&__md_analytics()}</script>
        ...
        <meta  property="og:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/babel-plugin-istanbul/node_modules/istanbul-lib-instrument/README.png" >
        ...
        <meta  property="og:url"  content="https://ai-on-openshift.io/kickstart/llama-stack-mcp-server/hr-api/node_modules/babel-plugin-istanbul/node_modules/istanbul-lib-instrument/" >
        ...
        <meta  name="twitter:image"  content="https://ai-on-openshift.io/assets/images/social/kickstart/llama-stack-mcp-server/hr-api/node_modules/babel-plugin-istanbul/node_modules/istanbul-lib-instrument/README.png" >
    ...
    <div data-md-component="skip">
        ...
        <a href="#istanbul-lib-instrument" class="md-skip">
          Skip to content
        </a>
...
<nav class="md-nav md-nav--secondary" aria-label="Table of contents">
    ...
    <ul class="md-nav__list" data-md-component="toc" data-md-scrollfix>
        ...
        <li class="md-nav__item">
  <a href="#istanbul-lib-instrument" class="md-nav__link">
    <span class="md-ellipsis">
...
<h2 id="istanbul-lib-instrument">istanbul-lib-instrument</h2>
<p><a href="https://travis-ci.org/istanbuljs/istanbul-lib-instrument"><img alt="Build Status" src="https://travis-ci.org/istanbuljs/istanbul-lib-instrument.svg?branch=master" /></a></p>
<p>Istanbul instrumenter library.</p>
<p>Version 1.1.x now implements instrumentation using <code>Babel</code>. The implementation is inspired
by prior art by @dtinth as demonstrated in the <code>__coverage__</code> babel plugin.</p>
<p>It provides 2 "modes" of instrumentation.</p>
<ul>
<li>
<p>The old API that is mostly unchanged (except for incompatibilities noted) and
    performs the instrumentation using babel as a library.</p>
</li>
<li>
<p>A <code>programVisitor</code> function for the Babel AST that can be used by a Babel plugin
    ...
    called <code>babel-plugin-istanbul</code>.</p>
</li>
</ul>
<p>Incompatibilities and changes to instrumentation behavior can be found in
<a href="v0-changes.md">v0-changes.md</a>.</p>
